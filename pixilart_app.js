/*!pixilart-drawing-application - 2024-03-29- Drawing Application - Draw Pixel Art Online at www.Pixilart.com.*/
var pixilapp = function(a) {
    ...
    var b = function(b, c, d, e, f, g, h, i) {
        ...
        this.canvas.name = d,
        this.canvas.id = "canvas_" + d,
        this.blend = "source-over",
        i && this.canvas.classList.add(i),
        f && "Canvas" == this.that.zoom.type && (b *= f,
        c *= f),
        this.canvas.width = b,
        this.canvas.height = c,
        "CSS" != this.that.zoom.type || "force" == f || e || (f && (this.canvas.style.width = "100%",
        this.canvas.style.height = "100%"),
        b *= f,
        c *= f,
        i || (a("#canvas-layers-container").width(b),
        a("#canvas-layers-container").height(c)),
        a("#drawing-canvas-conatiner").addClass("css-zoom")),
        this.setDefault(b, c),
        this.ctx = !1,
        e && a("body").append("<style> #canvas_" + d + " { display: none; }; </style>"),
        g ? document.getElementById("canvas-layers-appened").appendChild(this.canvas) : document.getElementById("drawing-canvas-conatiner").appendChild(this.canvas)
    };
    ...
    b.prototype.setSmoothing = function() {
        this.ctx.imageSmoothingEnabled && (this.ctx.imageSmoothingEnabled = !1),
        this.ctx.mozImageSmoothingEnabled && (this.ctx.mozImageSmoothingEnabled = !1),
        this.ctx.webkitImageSmoothingEnabled && (this.ctx.webkitImageSmoothingEnabled = !1),
        this.ctx.msImageSmoothingEnabled && (this.ctx.msImageSmoothingEnabled = !1)
    }
    ,
    ...
    b.prototype.putSimple = function(a, b, c, d, e) {
        return b = b ? b : 0,
        c = c ? c : 0,
        d ? this.ctx.drawImage(a, b, c, d, e) : void this.ctx.drawImage(a, b, c)
    }
    ,
    b.prototype.putImageData = function(a, b, c, d, e) {
        ...
        if (c && (f = c),
        1 != b && (this.ctx.globalAlpha = b.toString()),
        "CSS" == this.that.zoom.type)
    ...
    b.prototype["default"] = function() {
        this.clear(),
        this.canvas.width = this.defaultData.width,
        this.canvas.height = this.defaultData.height
    }
    ,
    b.prototype.destroy = function() {
        ...
        this.canvas.width = this.defaultData.width,
        this.canvas.height = this.defaultData.height,
        a("#canvas_" + this.name).remove(),
        this.that.canvas[this.name] = !1,
        delete this.that.canvas[this.name],
        delete this.canvas,
        delete this
    }
    ;
    ...
    c.prototype.dropshadowOptions = function(a) {
        var b = a ? a : 0
          , c = a ? parseInt(b) - 1 : 0;
        this.options.filter.dropshadow_x = b,
        this.options.filter.dropshadow_y = b,
        this.options.filter.dropshadow_blur = c,
        this.options.filter.dropshadow_alpha = 1
    }
    ,
    ...
    var d = function() {
        ...
        this.unqid = "",
        this.preview = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAIAAAACCAYAAABytg0kAAAAFUlEQVQYV2NkYGD4z8DAwMAIIkAAAA4fAQLCAeFmAAAAAElFTkSuQmCC",
        this.width = 0,
        this.height = 0
    };
    ...
    f.prototype.getCurrent = function() {
        this.that.canvas.rendering["default"](),
        this.currentImage = this.that.canvas.layer.image(),
        this.load()
    }
    ,
    f.prototype.initClickRender = function(a, b) {
        this.that.layPixel(!1, !1, !1, !1, "rendering"),
        this.that.mirrorDrawing(!1, "rendering"),
        this.initClick = !0
    }
    ,
    f.prototype.active = function(a, b) {
        this.currentImage || this.getCurrent(),
        !this.that.mouse.active || this.initClick || this.that.keyEvent || this.initClickRender();
        var c = this.that.maxHeight
          , d = 0;
        if (this.options.erase.value && this.that.mouse.rightClick)
            return this.that.ToolController.tools.EraserTool.active();
        for (; this.that.mouse.active && this.imageLoaded; ) {
            if (this.that.keyEvent && this.that.keyEvent.ctrlKey) {
                this.that.ToolController.tools.ColorPickerTool.active(),
                this.that.mouse.active = !1;
                break
            }
            if (this.that.mirrorDrawing(!1, "rendering"),
            this.that.renderPixel(),
            this.that.mouse.x_0 > this.that.width || this.that.mouse.x_1 > this.that.width || this.that.mouse.y_1 > this.that.height || this.that.mouse.y_0 > this.that.height)
                break;
            if (this.that.mouse.x_0 == this.that.mouse.x_1 && this.that.mouse.y_0 == this.that.mouse.y_1)
                break;
            if (d++,
            d > c)
                break;
        ...
        (this.that.mouse.active && this.imageLoaded || this.that.mouse.activeForceReady) && (this.that.canvas.layer.clear(),
        this.that.canvas.layer.putSimple(this.currentImage),
        this.that.ToolController.drawToCanvas(this.that.canvas.rendering.canvas, "layer"))
    }
    ,
    f.prototype.cancel = function() {
        this.currentImage && (this.that.canvas.layer.clear(),
        this.that.canvas.layer.putSimple(this.currentImage)),
        this.off()
    }
    ,
    f.prototype.colorPicker = function() {
        this.that.ColorController.color = "#" + this.that.mouse.getPixel(this.that.mouse.x1, this.that.mouse.y1),
        this.that.ColorController.select()
    }
    ,
    f.prototype.off = function(a) {
        this.that.pixelPerfect.set = 0,
        this.that.pixelPerfect.direction = "",
        this.that.pixelPerfect.history = [],
        this.that.pixelPerfect.preHistory = [],
        this.that.ToolController.tools.ColorPickerTool && (this.that.ToolController.tools.ColorPickerTool.flatten = !1),
        this.initClick = !1,
        this.currentImage = !1,
        this.imageLoaded = !1,
        this.that.isApp && this.getCurrent()
    }
    ,
    ...
    g.prototype.checkOptionsShown = function() {
        ...
        a.each(b.options, function(c, d) {
            var e = d.type + "-" + d.name;
            a("#extra-panel-content #" + e + ", #tool-option-appended #" + e).closest(".appened-options").show(),
            d.hideOn && d.hideValues.indexOf(b.options[d.hideOn].value) > -1 && a("#extra-panel-content #" + e + ", #tool-option-appended #" + e).closest(".appened-options").hide()
        })
    }
    ,
    g.prototype.changeFilter = function(a) {
        var b = this.self ? this.self : this;
        b.options.filter.value = a,
        b.checkOptionsShown()
    }
    ,
    ...
    g.prototype.createBrush = function() {
        var a = this
          ...
          , c = 2 * b
          , d = 2 * b;
        this.that.canvas.data.canvas.width = c,
        this.that.canvas.data.canvas.height = d;
        var e = this.that.canvas.data.ctx.createRadialGradient(b, b, b - 1, b, b, b);
        e.addColorStop(0, "black"),
        e.addColorStop(1, "transparent"),
        this.that.canvas.data.ctx.fillStyle = e,
        this.that.canvas.data.ctx.fillRect(0, 0, c, d),
        this.that.canvas.data.image().onload = function() {
            a.brushImage = this
        }
    }
    ,
    ...
    g.prototype.active = function(a) {
        ...
        if (this.that.mouse.active && this.currentImage) {
            var c = 2 * b
              , d = 2 * b;
            this.canvasResize || (this.canvasResize = !0,
            this.that.canvas.rendering.canvas.width = c,
            this.that.canvas.rendering.canvas.height = d,
            this.that.canvas.data.canvas.width = this.that.width,
            this.that.canvas.data.canvas.height = this.that.height);
            var e = this.that.mouse.x1 - b
              , f = this.that.mouse.y1 - b
              , g = 2;
            e < 0 && (g = 1),
            e + c >= this.that.width - 1 && (c = this.that.width - e),
            e > this.that.width - 1 && (e = this.that.width - 1),
            f < 0 && (g = 1),
            f + d >= this.that.height - 1 && (d = this.that.height - f),
            f > this.that.height - 1 && (f = this.that.height - 1),
            c <= 0 && (c = 1),
            d <= 0 && (d = 1),
            this.that.canvas.data.clear(),
            this.that.canvas.data.putSimple(this.currentImage);
            ...
            h.data.set(k),
            this.that.canvas.rendering.clear(),
            this.that.canvas.rendering.ctx.putImageData(h, 0, 0),
            this.that.canvas.rendering.ctx.globalCompositeOperation = "destination-in";
            var l = this.that.canvas.rendering.ctx.createRadialGradient(b, b, 0, b, b, b);
            l.addColorStop(0, "black"),
            l.addColorStop(1, "transparent"),
            this.that.canvas.rendering.ctx.fillStyle = l,
            this.that.canvas.rendering.ctx.fillRect(0, 0, c, d),
            this.that.canvas.rendering.ctx.globalCompositeOperation = "source-over",
            this.that.canvas.layer.putSimple(this.that.canvas.rendering.canvas, e, f)
        }
    }
    ,
    ...
    h.prototype.repeat = function() {
        ...
        this.that.mouse.active && this.imageLoaded && (this.timer = setTimeout(function() {
            for (var c = 0; c < a.options.speed.value; c++) {
                var d = Math.random() * Math.PI * 2
                  , e = Math.random() * a.options.size.value * a.options.size.value
                  , f = Math.round(Math.sqrt(e) * Math.cos(d))
                  , g = Math.round(Math.sqrt(e) * Math.sin(d));
                f += a.that.mouse.x_1,
                g += a.that.mouse.y_1,
                a.options.erase.value ? a.that.clearPixel(String(f), String(g), 1, "layer") : a.that.layPixel(String(f), String(g), !1, b, "rendering", 1)
            }
            a.updateCanvas(),
            a.repeat()
        }, 1))
    ...
    h.prototype.active = function(a) {
        this.currentImage || this.getCurrent(),
        this.that.mouse.active && !this.initClick && (this.optionsSaved = this.options.opacity.value),
        this.that.mouse.active && (this.initClick = !0,
        this.repeat())
    }
    ,
    h.prototype.updateCanvas = function() {
        this.that.mouse.active && this.imageLoaded && (this.options.erase.value || (this.that.canvas.layer.clear(),
        this.that.canvas.layer.putSimple(this.currentImage),
        this.that.canvas.layer.putSimple(this.that.canvas.rendering.canvas)),
        this.that.render())
    }
    ,
    ...
    i.prototype.active = function(b, c, d, e) {
        if (this.that.mouse.active || b) {
            ...
            c = c ? c : this.that.mouse.mousePageX,
            d = d ? d : this.that.mouse.mousePageY,
            this.loaded || (this.loaded = !0,
            this.currentTop = f.scrollTop(),
            this.currentLeft = f.scrollLeft(),
            this.mouseStartX = c,
            this.mouseStartY = d,
            this.posX = g.left,
            this.posY = g.top);
            var i = this.mouseStartX - c
              ...
              , m = this.posX - i
              , n = this.posY - j;
            if (this.that.mouse.pinchStartX = Math.round((f.width() / 2 - g.left) / h),
            this.that.mouse.pinchStartY = Math.round((f.height() / 2 - g.top) / h),
            this.that.ZoomController.previousZoomX = Math.round((f.width() / 2 - g.left) / h),
            this.that.ZoomController.previousZoomY = Math.round((f.height() / 2 - g.top) / h),
            this.that.isApp)
                return this.that.alignPan(m, n, e);
    ...
    i.prototype.off = function(a) {
        this.loaded = !1,
        a || this.that.NavigationController.updateLastClicks()
    }
    ,
    ...
    j.prototype.active = function(a) {
        ...
        for (this.currentImage || this.getCurrent(); this.that.mouse.active && this.currentImage; ) {
            ...
            if (this.options.single.value) {
                if (this.options.single.used.indexOf(d) > -1)
                    break;
                this.options.single.used.push(d)
            }
            if (this.that.clearPixel(),
            this.that.mirrorDrawing(!1, "layer", !0),
            this.that.mouse.x_0 > this.that.width || this.that.mouse.x_1 > this.that.width || this.that.mouse.y_1 > this.that.height || this.that.mouse.y_0 > this.that.height)
                break;
            if (this.that.mouse.x_0 == this.that.mouse.x_1 && this.that.mouse.y_0 == this.that.mouse.y_1)
                break;
    ...
    k.prototype.active = function() {
        this.currentImage || this.getCurrent(),
        this.that.mouse.active && this.currentImage && (this.that.canvas.rendering.clear(),
        this.that.canvas.layer.clear(),
        this.that.canvas.layer.putSimple(this.currentImage));
        var a = this.that.maxWidth
          , b = 0;
        for (this.startX || (this.startX = this.that.mouse.x_0,
        this.startY = this.that.mouse.y_0); this.that.mouse.active && this.currentImage && (this.options.erase.value ? this.that.clearPixel(!1, !1, !1, "layer") : (this.that.layPixel(!1, !1, !1, !1, "layer"),
        this.that.mirrorDrawing(!1, "layer")),
        this.that.mouse.x_0 != this.that.mouse.x_1 || this.that.mouse.y_0 != this.that.mouse.y_1) && (b++,
        !(b > a)); )
            this.that.mouseDistance()
    }
    ,
    k.prototype.shift = function(a) {
        a ? this.that.settings.isoLines = !0 : this.that.settings.isoLines = !1,
        this.that.SettingsController.toggleISOLines()
    }
    ,
    ...
    m.prototype.active = function(a) {
        if (this.currentImage || (this.currentImage = this.that.canvas.layer.image(),
        this.load()),
        this.that.mouse.active && this.imageLoaded) {
            this.that.canvas.rendering.clear(),
            this.that.canvas.layer.clear(),
            this.that.canvas.layer.putSimple(this.currentImage);
        ...
        for (var h = 2 * this.that.maxWidth, i = 0; this.that.mouse.active && this.imageLoaded; ) {
            if (this.render(b, !1),
            this.render(!1, c),
            this.render(f.toString(), !1),
            this.render(!1, g.toString()),
            this.options.fill.value) {
                var j = {
                    w: d,
                    h: e
                };
                this.options.erase.value ? this.that.clearPixel(b, c, !1, "layer", j) : this.that.layPixel(b, c, !1, !1, "layer", !1, !1, j)
            }
            if (this.that.mouse.x_0 == this.that.mouse.x_1 && this.that.mouse.y_0 == this.that.mouse.y_1)
                break;
            if (i++,
    ...
    m.prototype.render = function(a, b) {
        this.options.erase.value ? this.that.clearPixel(a, b, !1, "layer") : this.that.layPixel(a, b, !1, !1, "layer")
    }
    ,
    ...
    var n = function(a) {
        ...
        this.imageLoaded = !1,
        this.clickedColor = !1,
        this.clickedColorRgbaArray = !1,
        this.canRun = !0,
        this.renderImageData = [],
        this.renderImageColors = [],
        this.callStackLimit = 2e4,
        this.called = 0,
        this.hasOptions = !0,
        this.p32 = !1,
        this.options = {
    ...
    n.prototype.active = function(a) {
        (this.that.mouse.active && this.that.mouse.up && this.that.mouse.isTouch || this.that.mouse.active && !this.that.mouse.isTouch || this.that.mouse.active && !this.that.app.fingerToDraw) && (this.canRun = !0,
        this.getCurrent())
    }
    ,
    n.prototype.run = function() {
        ...
        if (this.canRun) {
            ...
            if (this.options.pattern.value && (b = !1),
            this.options.all.value || this.options.pattern.value)
                this.that.bucketCreate(function(b, c, d) {
                    if (!b)
                        return a.that.FrameController.updateFramePreview(),
                        a.finish(),
                        void a.that.render();
                    ...
                    a.options.pattern.value && a.that.stamps.data ? a.that.backgroundImageRepeat("rendering", a.that.stamps.data, function() {
                        ...
                        a.that.canvas.rendering.clear(),
                        a.that.canvas.rendering.ctx.putImageData(b, 0, 0),
                        a.that.canvas.rendering.ctx.globalCompositeOperation = "destination-in",
                        a.that.canvas.rendering.putSimple(a.that.canvas.data.canvas),
                        a.that.canvas.rendering.ctx.globalCompositeOperation = "source-over",
                        a.that.canvas.layer.clear(),
                        a.that.canvas.layer.ctx.putImageData(e, 0, 0),
                        a.that.canvas.layer.putSimple(a.that.canvas.rendering.canvas),
                        a.that.FrameController.updateFramePreview(),
                        a.finish(),
                        a.that.render()
                    }) : (a.that.canvas.layer.ctx.putImageData(c, 0, 0),
                    a.that.FrameController.updateFramePreview(),
                    a.finish(),
                    a.that.render())
                }, a.options.all.value, !0, !1, !1, !1, !1, !1, b, this.options.clear.value, this.options.tolerance.value);
            else {
                var c = this.that.mouse.start_x
                  , d = this.that.mouse.start_y;
                this.imageData = this.that.canvas.layer.ctx.getImageData(0, 0, this.that.width, this.that.height);
                for (var e = this.imageData, f = 0; f < e.data.length; f += 4)
                    this.renderImageColors.push([e.data[f], e.data[f + 1], e.data[f + 2], e.data[f + 3]]);
                if (this.clickedColor = this.that.mouse.getPixel(c, d, !0),
                this.clickedColorRgbaArray = this.that.mouse.getPixel(c, d, !0, !1, !0),
                "#" + this.clickedColor == this.that.ColorController.color + "255" && !this.options.clear.value)
                    return;
                this.doPixel(c, d),
                this.fill(c, d, !0),
                this.loopFill(),
    ...
    n.prototype.doPixel = function(a, b, c) {
        ...
        this.options.clear.value ? this.that.clearPixel(a, b, 1) : this.that.layPixel(a, b, !0, !1, !1, 1)
    }
    ,
    n.prototype.check = function(a, b, c) {
        ...
        if (a <= d - 1 && a >= 0 && b <= e - 1 && b >= 0 && this.inRange(f)) {
            ...
            if (!this.canRun)
                return;
            return this.doPixel(a, b),
            this.filled.push([a, b]),
            this.renderImageColors[f] = [-1, -1, -1, -1],
            this.renderImageData[f] = this.that.ColorController.color,
            !0
        }
        return !1
    }
    ...
    o.prototype.flattenLayers = function() {
        ...
        this.that.LayerController.flatten(b, !1, !1, function(b) {
            a.that.loadImage(b, function(b) {
                a.that.canvas.data.clear(),
                a.that.canvas.data["default"](),
                a.that.canvas.data.putSimple(b),
                a.imageData = a.that.canvas.data.ctx.getImageData(0, 0, a.that.canvas.data.canvas.width, a.that.canvas.data.canvas.height).data,
                a.flatten = !0,
                a.select()
            })
        })
    ...
    o.prototype.select = function() {
        ...
        this.color = this.that.mouse.getPixel(a, b, !1, "data", !1, this.imageData),
        this.that.ColorController.color = "#" + this.color.toLowerCase(),
        this.that.ColorController.select(this.color.toLowerCase())
    }
    ,
    ...
    p.prototype.getCurrent = function(a) {
        this.currentImage = a ? a : this.that.canvas.layer.image(),
        this.load()
    }
    ,
    p.prototype.active = function(a) {
        if (!this.currentImage)
            return this.getCurrent(a);
        if (this.that.mouse.active && this.imageLoaded) {
            var b = this.that.mouse.x1 - this.that.mouse.start_x
              ...
              , d = Math.abs(b)
              , e = Math.abs(c);
            this.that.keys.shift && (d > e ? c = 0 : b = 0),
            this.keyStart = !1,
            this.that.canvas.layer.clear(),
            this.that.canvas.layer.putSimple(this.currentImage, b, c),
            this.repeat(b, c)
        }
    }
    ,
    p.prototype.repeat = function(a, b) {
        if (this.options.parallax.value) {
            ...
            this.that.canvas.layer.putSimple(this.currentImage, c, b),
            this.that.canvas.layer.putSimple(this.currentImage, e, b),
            this.that.canvas.layer.putSimple(this.currentImage, a, d),
            this.that.canvas.layer.putSimple(this.currentImage, a, f),
            this.that.canvas.layer.putSimple(this.currentImage, c, d),
            this.that.canvas.layer.putSimple(this.currentImage, e, f),
            this.that.canvas.layer.putSimple(this.currentImage, c, f),
            this.that.canvas.layer.putSimple(this.currentImage, e, d)
        }
    }
    ,
    p.prototype.key = function(a) {
        if (this.that.LayerController.layers[this.that.LayerController.currentLayer].options.locked)
            return void this.that.showAlert(this.that.messages("layer_locked_alter"));
        if (!this.currentImage)
            return this.getCurrent();
        var b = this;
        switch (this.keyStart || (this.that.mouse.createHistory = !0,
        this.keyX = 0,
        this.keyY = 0),
        this.keyStart = !0,
        a) {
        ...
        this.that.canvas.layer.clear(),
        this.that.canvas.layer.putSimple(this.currentImage, this.keyX, this.keyY),
        this.repeat(this.keyX, this.keyY),
        this.that.render(),
    ...
    p.prototype.completeKey = function() {
        clearTimeout(this.keyTimer),
        this.keyStart && (this.keyStart = !1,
        this.that.mouse.active = !0,
        this.restore(),
        this.currentImage = !1,
        this.that.mouse.finish())
    }
    ,
    ...
    p.prototype.restore = function() {
        this.imageLoaded = !1,
        this.completeKey(),
        this.keyStart || (this.currentImage = !1,
        this.imageLoaded = !1)
    }
    ;
    var q = function(a) {
        ...
        this.that = a,
        this.moving = !1,
        this.activeSelecting = !1,
        this.undo = !1,
        this.selectionActive = !1,
        this.hasOptions = !0,
        this.draggingActive = !1,
        this.that.selectImageData = !1,
        this.that.currentImage = !1,
        this.moved = !1,
        this.rotating = !1,
        this.selectToolOnly = !1,
        this.multi = {
            "default": {
                name: "Select Tool",
        ...
        this.dragColor = "rgba(63, 223, 63, .30)",
        this.selectColor = "rgba(255,255,255,0.3)",
        this.selectColorPrimary = "rgba(0,0,0,0.3)",
    ...
    q.prototype.init = function() {
        this.listeners(),
        this.that.SelectController.hideSelectTools()
    }
    ,
    ...
    q.prototype.destroy = function() {
        var b = ".select-drag";
        a(b).unbind("touchstart"),
        a(b).unbind("touchmove"),
        a(b).unbind("touchend"),
        a(b).unbind("mousedown")
    }
    ,
    ...
    q.prototype.drag = function() {
        this.that.SelectController.hideSelectTools(),
        this.dragging(this.draggingActive)
    }
    ,
    q.prototype.active = function(a) {
        if (this.that.SelectController.currentImage || (this.that.SelectController.currentImage = this.that.canvas.layer.image(),
        this.that.currentImage = this.that.canvas.layer.image()),
        this.draggingActive)
            return this.drag();
        if (this.moving && this.that.app_button_down)
            return this.move(),
            void this.that.renderAfter.push(this.that.canvas.select.canvas);
        if (this.that.mouse.active || this.that.SelectController.active) {
            if (this.selectToolOnly = !1,
            this.that.SelectController.hideSelectTools(),
            this.that.SelectController.status && (this.that.mouse.start_x >= this.that.SelectController.start_x && this.that.mouse.start_x <= this.that.SelectController.start_x + this.that.SelectController.width && this.that.mouse.start_y >= this.that.SelectController.start_y && this.that.mouse.start_y <= this.that.SelectController.start_y + this.that.SelectController.height ? this.move() : this.moveOff()),
            !this.moving) {
                if (this.that.SelectController.usingLasso || this.options.lasso.value)
                    return this.activeSelecting = !1,
                    this.selectCanvasLocation.active = !1,
                    this.that.SelectController.usingLasso || this.that.canvas.select.clear(),
                    this.that.ToolController.tool = this.that.ToolController.tools.LassoTool,
                    this.that.ToolController.tools.LassoTool.active();
                if (this.options.poly.value)
                    return this.activeSelecting = !1,
                    this.selectCanvasLocation.active = !1,
                    this.that.ToolController.tool = this.that.ToolController.tools.PolyTool,
                    this.that.ToolController.tools.PolyTool.active();
                if (this.options.bucket.value || this.options.bucketall.value)
                    return this.activeSelecting = !1,
                    this.selectCanvasLocation.active = !1,
                    this.that.canvas.select.clear(),
                    this.that.ToolController.tool = this.that.ToolController.tools.WandTool,
                    this.that.ToolController.tools.WandTool.active(this.options.bucketall.value);
                this.selectToolOnly = !0,
                this.selecting()
            }
        } else
            this.that.SelectController.showSelectTools(),
            this.that.SelectController.addSelectToolsReady();
        this.that.renderAfter.push(this.that.canvas.select.canvas)
    }
    ,
    q.prototype.selecting = function() {
        this.doHistory(),
        this.that.SelectController.transform = !1,
        this.that.SelectController.cutImageData = !1,
        this.that.SelectController.currentSelectImage = !1;
        var a = this.that.mouse.x1
          , b = this.that.mouse.y1;
        this.that.mouse.start_x < a && a++,
        this.that.mouse.start_y < b && b++,
        this.that.mouse.start_x == a && this.that.mouse.start_y == b || (this.activeSelecting = !0,
        this.selectCanvasLocation.active = !1),
        this.that.canvas.select.clear();
        ...
        var g = this.that.mouse.start_x > a ? a : this.that.mouse.start_x
          ...
          , i = e
          , j = f;
        this.that.mouse.start_x > a && (c++,
        i--),
        this.that.mouse.start_y > b && (d++,
        j--),
        this.setSelection(g, h, c, d, c, d),
        this.that.SelectController.setCordinates(i, j)
    }
    ,
    q.prototype.setSelection = function(a, b, c, d, e, f, g) {
        c > 1 && !d && (d = 1),
        d > 1 && !c && (c = 1),
        this.that.SelectController.start_x = a,
        this.that.SelectController.start_y = b,
        this.that.SelectController.start_width = c,
        this.that.SelectController.start_height = d,
        this.that.SelectController.drag_width = c,
        this.that.SelectController.drag_height = d,
        this.that.SelectController.start_drag_x = a,
        this.that.SelectController.start_drag_y = b,
        this.that.SelectController.end_drag_x = a + c,
        this.that.SelectController.end_drag_y = b + d,
        this.that.SelectController.cut_x = a,
        this.that.SelectController.cut_y = b,
        this.that.SelectController.cut_width = c,
        this.that.SelectController.cut_height = d,
        this.that.SelectController.width = c,
        this.that.SelectController.height = d,
        this.showHideStampButton();
        g ? a : this.that.mouse.start_x,
        g ? b : this.that.mouse.start_y;
        this.drawSelectArea(a, b, e, f),
        this.selectCanvasLocation = {
            default_x: a,
            default_y: b,
            x: a,
    ...
    q.prototype.dragging = function(a) {
        var b = 90;
        this.options.rotateAnyDegree.value && (b = 15),
        this.moved = !0,
        this.that.SelectController.start_drag_width && this.that.SelectController.start_drag_height || (this.that.SelectController.start_drag_width = this.selectCanvasLocation.width,
        this.that.SelectController.start_drag_height = this.selectCanvasLocation.height),
        this.that.SelectController.start_drag_x && this.that.SelectController.start_drag_y || (this.that.SelectController.start_drag_x = this.that.SelectController.start_x,
        this.that.SelectController.start_drag_y = this.that.SelectController.start_y,
        this.that.SelectController.end_drag_x = this.that.SelectController.start_x + this.selectCanvasLocation.width,
        this.that.SelectController.end_drag_y = this.that.SelectController.start_y + this.selectCanvasLocation.height);
        var c = this.that.mouse.x1 + 1
          , d = this.that.mouse.y1 + 1
          , e = this.that.SelectController.width
          , f = this.that.SelectController.height;
        if (this.that.SelectController.start_width = this.selectCanvasLocation.width,
        this.that.SelectController.start_height = this.selectCanvasLocation.height,
        "rotate" == a) {
        ...
        if (this.that.keys.shift && ["nw", "ne", "se", "sw"].indexOf(a) > -1) {
            Math.abs(c - this.that.mouse.start_x),
            Math.abs(d - this.that.mouse.start_y);
            if ("se" == a) {
        ...
        "w" != a && "nw" != a && "sw" != a || (this.that.SelectController.start_drag_x = c),
        "n" != a && "ne" != a && "nw" != a || (this.that.SelectController.start_drag_y = d),
        "x" != a && "ne" != a && "se" != a || (this.that.SelectController.end_drag_x = c),
        "y" != a && "sw" != a && "se" != a || (this.that.SelectController.end_drag_y = d),
        (this.that.SelectController.end_drag_x - this.that.SelectController.start_drag_x > 1 || this.that.SelectController.end_drag_y - this.that.SelectController.start_drag_y > 1) && (this.that.SelectController.width = this.that.SelectController.end_drag_x - this.that.SelectController.start_drag_x,
        this.that.SelectController.height = this.that.SelectController.end_drag_y - this.that.SelectController.start_drag_y),
        this.that.SelectController.setCordinates(this.that.SelectController.width, this.that.SelectController.height),
        this.that.canvas.select.clear(),
        this.drawSelectArea(this.that.SelectController.start_x, this.that.SelectController.start_y, e, f),
        this.that.renderAfter.push(this.that.canvas.select.canvas)
    }
    ,
    ...
    q.prototype.rotate = function(a) {
        ...
        this.that.canvas.select.ctx.save(),
        this.that.canvas.select.ctx.translate(b + d / 2, c + e / 2),
        this.that.canvas.select.ctx.rotate(f),
        this.that.canvas.select.putSimple(this.selectCanvasLocation.image, -d / 2, -e / 2, d, e),
        this.that.canvas.select.setSmoothing(),
        this.that.canvas.select.ctx.fillStyle = this.dragColor,
        this.that.canvas.select.ctx.fillRect(-d / 2, -e / 2, d, e),
        this.that.canvas.select.ctx.restore(),
        this.drawSelectArea(b, c, d, e, !0),
        this.that.renderAfter.push(this.that.canvas.select.canvas)
    }
    ,
    q.prototype.drawSelectArea = function(a, b, c, d, e) {
        ...
        if (this.draggingActive && !e) {
            f = this.that.SelectController.drag_width,
            g = this.that.SelectController.drag_height;
            ...
            j >= 1 && k >= 1 && (this.that.canvas.select.setSmoothing(),
            this.that.canvas.select.putSimple(this.selectCanvasLocation.image, h, i, j, k),
            this.that.canvas.select.ctx.fillStyle = this.dragColor,
            this.that.canvas.select.ctx.fillRect(h, i, j, k),
            this.that.canvas.select.ctx.fillRect(h, i, j, k))
        }
        !f && g > 1 && (f = 1),
        !g && f > 1 && (g = 1),
        this.that.canvas.select.ctx.fillStyle = this.selectColor,
        this.that.canvas.select.ctx.fillRect(a, b, f, g),
        this.that.canvas.select.ctx.fillStyle = this.selectColorPrimary,
        this.that.canvas.select.ctx.fillRect(a, b, f, g)
    }
    ,
    q.prototype.renderSelectedArea = function() {
        this.that.canvas.select.clear(),
        this.that.SelectController.start_x = this.selectCanvasLocation.x,
        this.that.SelectController.start_y = this.selectCanvasLocation.y,
        this.that.SelectController.width = this.selectCanvasLocation.width,
        this.that.SelectController.height = this.selectCanvasLocation.height,
        this.drawSelectArea(this.selectCanvasLocation.x, this.selectCanvasLocation.y, this.selectCanvasLocation.width, this.selectCanvasLocation.height)
    }
    ,
    q.prototype.updateSelectCanvasArea = function(a, b, c, d) {
        this.that.canvas.select.clear(),
        this.selectCanvasLocation.width = a,
        this.selectCanvasLocation.height = b,
        this.that.SelectController.width = a,
        this.that.SelectController.height = b,
        this.drawSelectArea(this.selectCanvasLocation.x, this.selectCanvasLocation.y, this.selectCanvasLocation.width, this.selectCanvasLocation.height)
    }
    ,
    q.prototype.updateSelection = function(a, b) {
        var c = a ? a : this.that.canvas.rendering.image()
          , d = this;
        return b ? (this.that.SelectController.showAcceptButton(),
        this.that.canvas.layer.clear(),
        this.that.canvas.layer.putSimple(this.that.currentImage, 0, 0),
        this.that.canvas.layer.ctx.clearRect(this.selectCanvasLocation.default_x, this.selectCanvasLocation.default_y, this.that.SelectController.cut_width, this.that.SelectController.cut_height),
        this.that.SelectController.cutImageData && this.that.canvas.layer.putSimple(this.that.SelectController.cutImageData, this.selectCanvasLocation.default_x, this.selectCanvasLocation.default_y),
        this.that.canvas.layer.putSimple(c, this.selectCanvasLocation.x, this.selectCanvasLocation.y),
        this.selectCanvasLocation.image = c,
        void this.that.render()) : c.onload = function() {
    ...
    q.prototype.move = function() {
        if (this.selectCanvasLocation.image) {
            this.moved = !0,
            this.that.SelectController.showAcceptButton(),
            this.that.SelectController.hideSelectTools(),
            this.moving = !0,
            this.selectCanvasLocation.active = !0,
            this.that.SelectController.transform = !1,
            this.that.canvas.select.clear(),
            this.that.canvas.rendering.clear(),
            this.that.canvas.rendering.putSimple(this.selectCanvasLocation.image),
            this.that.canvas.layer.clear(),
            this.that.canvas.layer.putSimple(this.that.SelectController.currentImage, 0, 0),
            this.that.canvas.layer.ctx.clearRect(this.selectCanvasLocation.default_x, this.selectCanvasLocation.default_y, this.that.SelectController.cut_width, this.that.SelectController.cut_height),
            this.that.SelectController.cutImageData && this.that.canvas.layer.putSimple(this.that.SelectController.cutImageData, this.selectCanvasLocation.default_x, this.selectCanvasLocation.default_y);
            ...
            this.that.keys.shift && (c > d ? b = this.that.SelectController.start_y : a = this.that.SelectController.start_x),
            this.that.canvas.layer.setSmoothing(),
            this.that.canvas.layer.putSimple(this.that.canvas.rendering.canvas, a, b);
            this.selectCanvasLocation;
            this.selectCanvasLocation.x = a,
            this.selectCanvasLocation.y = b,
            this.that.SelectController.start_drag_x = !1
        }
    }
    ,
    q.prototype.off = function() {
        ...
        this.draggingActive)
            return this.draggingActive = !1,
            this.that.SelectController.start_x = this.that.SelectController.start_drag_x,
            this.that.SelectController.start_y = this.that.SelectController.start_drag_y,
            this.selectCanvasLocation.x = this.that.SelectController.start_drag_x,
            this.selectCanvasLocation.y = this.that.SelectController.start_drag_y,
            this.that.SelectController.drag_width = this.that.SelectController.width,
            this.that.SelectController.drag_height = this.that.SelectController.height,
            this.that.SelectController.start_drag_x = !1,
            this.that.SelectController.start_drag_y = !1,
            this.that.SelectController.start_drag_width = !1,
            this.rotating ? void this.that.SelectController.setRotateImage(this.rotating) : this.that.SelectController.resize(this.that.SelectController.width, this.that.SelectController.height);
        if (this.activeSelecting && (this.that.SelectController.status = !0,
        this.selectToolOnly && (this.that.canvas.rendering.clear(),
        this.that.canvas.rendering.canvas.width = this.that.SelectController.width,
        this.that.canvas.rendering.canvas.height = this.that.SelectController.height,
        this.that.canvas.rendering.putSimple(this.that.canvas.layer.canvas, 0, 0, this.that.SelectController.start_x, this.that.SelectController.start_y),
        this.that.canvas.rendering.image().onload = function() {
        ...
        !this.selectCanvasLocation.active) {
            ...
            if (this.that.canvas.rendering.canvas.width = this.that.width,
            this.that.canvas.rendering.canvas.height = this.that.height,
            this.that.canvas.rendering.putSimple(this.that.canvas.layer.canvas),
            this.that.SelectController.currentImage = !1,
            Math.abs(d) > 0 && Math.abs(e) > 0 || Math.abs(d) > 0 && !e || Math.abs(e) > 0 && !d) {
                e || (e = 1),
                d || (d = 1);
                var f = this.that.canvas.rendering.ctx.getImageData(b, c, d, e);
                this.that.canvas.rendering.canvas.width = Math.abs(d),
                this.that.canvas.rendering.canvas.height = Math.abs(e),
                this.that.canvas.rendering.ctx.putImageData(f, 0, 0),
                this.selectCanvasLocation.image = this.that.canvas.rendering.image()
            }
        }
        this.selectCanvasLocation.active && this.renderSelectedArea(),
        this.activeSelecting = !1,
        this.that.render()
    }
    ,
    q.prototype.history = function() {
        var a = this;
        this.undo || this.that.SelectController.transform || (this.undo = !0,
        this.that.LayerController.updateLayer(!1, function() {
            a.that.HistoryController.create()
        }))
    }
    ,
    q.prototype.alt = function(a) {}
    ,
    q.prototype.moveOff = function() {
        this.restore(!0)
    }
    ,
    ...
    q.prototype.renderChange = function(a) {
        ...
        this.that.LayerController.updateLayer(!1, function() {
            b.that.HistoryController.create(!1, function() {
                return b.that.SelectController.transform = !1,
                b.moved = !1,
                a()
            })
        })
    ...
    q.prototype.restore = function(a, b) {
        this.that.SelectController.hideAccept(),
        this.that.SelectController.hideSelectTools(),
        this.that.SelectController.hideStampButton(),
        this.doHistory(b),
        this.moving = !1,
        this.moved = !1,
        this.undo = !1,
        ...
        this.that.canvas.rendering["default"](),
        this.that.SelectController.currentImage = !1,
        this.that.SelectController.status = !1,
        this.that.SelectController.off(),
        this.that.SelectController.width = 0,
        this.that.SelectController.height = 0,
        this.selectCanvasLocation.width = 0,
        this.selectCanvasLocation.height = 0,
        this.that.SelectController.usingLasso = !1,
        this.that.currentImage = !1,
        a || this.that.render()
    }
    ,
    q.prototype.cancel = function() {
        this.that.isApp && (this.that.SelectController.status = !1),
        this.that.mouse.active = !1
    }
    ,
    q.prototype.doHistory = function(a) {
        ...
        (this.that.SelectController.transform || a || this.moved) && this.that.LayerController.updateLayer(!1, function() {
            b.that.HistoryController.create(),
            b.that.SelectController.transform = !1,
            b.moved = !1,
            b.that.updateData()
        })
    }
    ...
    r.prototype.render = function(a, b) {
        this.that.layPixel(String(a), String(b))
    }
    ,
    r.prototype.active = function(a) {
        ...
        this.that.mouse.active && this.imageLoaded) {
            ...
            this.that.mouse.x1 < this.that.mouse.start_x && !this.options.center.value && !this.that.keys.ctrl && (d = this.that.mouse.start_x,
            b = this.that.mouse.x1),
            this.that.mouse.y1 < this.that.mouse.start_y && !this.options.center.value && !this.that.keys.ctrl && (e = this.that.mouse.start_y,
            ...
            this.options.center.value || this.that.keys.ctrl ? (j = b,
            k = c) : (j = l,
            k = m,
            f = Math.round(f / 2),
            g = Math.round(g / 2));
            ...
            o = 2 * f * f * h,
            this.that.canvas.layer.clear(),
            this.that.canvas.layer.putSimple(this.currentImage); n < o; )
                this.render((i + j).toFixed(0), (h + k).toFixed(0)),
                this.render((-i + j).toFixed(0), (h + k).toFixed(0)),
                this.render((i + j).toFixed(0), (-h + k).toFixed(0)),
                this.render((-i + j).toFixed(0), (-h + k).toFixed(0)),
                p < 0 ? (i++,
                ...
                o -= 2 * f * f,
                p = p + n - o + g * g);
            for (q = g * g * ((i + .5) * (i + .5)) + f * f * ((h - 1) * (h - 1)) - f * f * g * g; h >= 0; )
                this.render((i + j).toFixed(0), (h + k).toFixed(0)),
                this.render((-i + j).toFixed(0), (h + k).toFixed(0)),
                this.render((i + j).toFixed(0), (-h + k).toFixed(0)),
                this.render((-i + j).toFixed(0), (-h + k).toFixed(0)),
    ...
    s.prototype.listeners = function() {
        ...
        a("#lightendarken-range-size").on("input", function() {
            b.that.settings.lightendarken.strengh = a(this).val(),
            a(".ligtendarken-level").text(a(this).val())
        })
    }
    ,
    ...
    s.prototype.active = function(a) {
        ...
        for (var b = 500, c = 0, d = this.options.strenth.value; this.that.mouse.active && this.imageLoaded; ) {
            var e = "rgba(0, 0, 0, " + d + ")";
            if ((3 == this.that.mouseEvent.which || this.options.lighter.value) && (e = "rgba(255, 255, 255, " + d + ")"),
            this.that.keyEvent && this.that.keyEvent.ctrlKey && (this.used = []),
            this.used.indexOf(this.that.mouse.x_0 + "-" + this.that.mouse.y_0) === -1 && (this.used.push(this.that.mouse.x_0 + "-" + this.that.mouse.y_0),
            this.that.layPixel(this.that.mouse.x_0, this.that.mouse.y_0, !1, e, !1, !0),
            this.that.mirrorDrawing(e)),
            this.that.mouse.x_0 == this.that.mouse.x_1 && this.that.mouse.y_0 == this.that.mouse.y_1)
                break;
            if (c++,
            c > b)
                break;
    ...
    var t = function(a) {
        ...
        this.setIntTime = !1,
        this.hasOptions = !0,
        this.canCreateHistory = !1,
        this.font_size = 1,
        this.size = 1,
        this.initActive = !1,
        this.callbackPrompt = !1,
        this.options = {
            font: {
                name: "font",
                type: "fonts",
    ...
    t.prototype.begin = function() {
        ...
        this.createHistory(),
        this.status = !0,
        this.that.ToolController.renderChange = !0,
        this.position = {
    ...
    t.prototype.preStart = function() {
        ...
        this.checkSettingHistoryController(function() {
            a.canCreateHistory = !0,
            a.begin(),
            (a.that.isMobile || a.that.isIpad) && a.that.TextController.prompt()
        })
    }
    ,
    t.prototype.beforeHistory = function() {
        this.currentImage && (this.that.canvas.select.clear(),
    ...
    t.prototype.cursor = function() {
        function a(a) {
            ...
            c *= b.size,
            b.cursorShown ? (b.cursorShown = !1,
            b.that.canvas.select.clear()) : (b.cursorShown = !0,
            b.that.canvas.select.ctx.fillStyle = "rgba(255,255,255,0.3)",
            b.that.canvas.select.ctx.fillRect(b.position.x, b.position.y, 1, c),
            b.that.canvas.select.ctx.fillStyle = "rgba(0,0,0,0.3)",
            b.that.canvas.select.ctx.fillRect(b.position.x, b.position.y, 1, c)),
            b.position && b.drawToLayer(!0)
        }
        if (this.position) {
            var b = this;
    ...
    t.prototype.checkSettingHistoryController = function(a) {
        var b = this;
        if (this.position && this.history.length >= 2 || this.canCreateHistory)
            this.that.LayerController.updateLayer(!1, function() {
                b.that.HistoryController.create(!1, function() {
                    if (b.canCreateHistory = !1,
                    a)
                        return a(!0)
                })
            });
    ...
    t.prototype.use = function(a, b, c) {
        var d = b ? b : a.which
          , e = d;
        if (this.callbackPrompt = !1,
        c && (this.callbackPrompt = c),
        this.position) {
            if (8 == d)
                return void this.backSpace();
            ...
            if ("object" == typeof g || [13, 32].indexOf(d) !== -1) {
                ...
                if (this.spacing_left = this.that.textData[f].spacing_left,
                this.spacing_top = this.that.textData[f].spacing_top,
                "object" == typeof this.that.textData[f][d] && (i = this.that.textData[f][d].image,
                this.spacing_left = this.that.textData[f][d].spacing_left,
                this.spacing_top = this.that.textData[f][d].spacing_top),
                this.spacing_left *= this.size,
                32 == e)
                    return this.updatePosition(parseInt(this.position.x) + parseInt(this.spacing_left), this.position.y),
                    void (this.callbackPrompt && this.callbackPrompt());
                if (13 == d)
                    return void this.returnKey();
                ...
                this.callbackPrompt && this.callbackPrompt()
        }
    }
    ,
    t.prototype.renderData = function(a, b, c) {
        ...
        this.that.loadImage(a, function(a) {
            var c = a.width * d.size
              , e = a.height * d.size;
            d.that.canvas.data.canvas.width = c,
            d.that.canvas.data.canvas.height = e,
            d.that.canvas.data.setSmoothing(),
            d.that.canvas.data.ctx.drawImage(a, 0, 0, c, e),
            b && d.callback()
        })
    }
    ,
    t.prototype.callback = function() {
        this.that.canvas.rendering.putSimple(this.that.canvas.data.canvas, this.position.x, this.position.y),
        this.updatePosition(parseInt(this.position.x) + parseInt(this.spacing_left), this.position.y),
        this.drawToLayer(),
        this.callbackPrompt && this.callbackPrompt()
    }
    ,
    t.prototype.drawToLayer = function(a, b, c) {
        if (this.currentImage)
            return this.that.canvas.layer.clear(),
            this.that.canvas.layer.putSimple(this.currentImage),
            this.that.canvas.layer.putSimple(this.that.canvas.rendering.canvas),
            a ? this.that.renderAfter.push(this.that.canvas.select.canvas) : this.that.canvas.select.clear(),
            b || this.that.render(),
            c ? c(!0) : void 0
    }
    ,
    ...
    t.prototype.backSpace = function() {
        if (this.history.length >= 2) {
            var a = this.history[this.history.length - 1]
              ...
              , d = a.image;
            this.that.canvas.rendering.clear(),
            this.that.canvas.rendering.putSimple(d),
            this.updatePosition(b, c),
            this.drawToLayer(),
            this.history.pop()
        }
    }
    ...
    t.prototype.returnKey = function() {
        this.position.y = this.position.y + parseInt(this.spacing_top) * this.size,
        this.position.x = this.position.default_x
    }
    ,
    ...
    u.prototype.active = function(a) {
        this.currentImage || (this.currentImage = this.that.canvas.layer.image(),
        this.imageData = this.that.canvas.layer.ctx.getImageData(0, 0, this.that.width, this.that.height)),
        this.currentImage && this.changeColor(a)
    }
    ,
    u.prototype.changeColor = function(a) {
        for (var b, c, d, e = 0, f = this.imageData.length; e < f; e += 4) {
            b = this.imageData.length[e],
            c = this.imageData.length[e + 1],
            d = this.imageData.length[e + 2];
            var g = that.that.RGBtoHSV(b, c, d);
            g.h += a;
            var h = that.that.HSVtoRGB(g.h, g.s, g.v);
            this.imageData.length[e] = h.r,
            this.imageData.length[e + 1] = h.g,
            this.imageData.length[e + 2] = h.b
        }
    ...
    var v = function(a) {
        ...
        this.options = {
            offset: {
                name: "Even Pixel",
                hint: "Offset dithering on the even number of pixels",
                type: "checkbox",
                value: !1
            }
        }
    ...
    ,
    v.prototype.pattern = function(a, b, c) {
        var d = 4;
        if ("bayer" == c) {
            a %= d,
            b %= d;
            var e = [[1, 9, 3, 11], [13, 5, 15, 7], [4, 12, 2, 10], [16, 8, 14, 6]]
        }
        if ("four" == c) {
            d = 2,
            a %= d,
    ...
    v.prototype.active = function(a) {
        this.currentImage || (this.that.canvas.rendering["default"](),
        this.currentImage = this.that.canvas.layer.image(),
        this.load()),
        this.that.mouse.active && this.currentImage && (this.that.canvas.layer.clear(),
        this.that.canvas.layer.putSimple(this.currentImage));
        var b = 500
          , c = 0;
        Math.abs(this.that.mouse.start_x - this.that.mouse.x_1),
        Math.abs(this.that.mouse.start_y - this.that.mouse.y_1),
        this.that.mouse.start_x,
        this.that.mouse.start_y;
        for (this.that.mouse.active && !this.setIsOff && (this.options.offset.value && (this.isOdd = !0),
        this.setIsOff = !0); this.that.mouse.active && this.currentImage && (this.that.ditheringLayPixel(!1, !1, !1, "rendering", this.isOdd),
        this.that.canvas.layer.putSimple(this.that.canvas.rendering.canvas),
        !(this.that.mouse.x_0 > this.that.width || this.that.mouse.x_1 > this.that.width || this.that.mouse.y_1 > this.that.height || this.that.mouse.y_0 > this.that.height)) && (this.that.mouse.x_0 != this.that.mouse.x_1 || this.that.mouse.y_0 != this.that.mouse.y_1) && (c++,
        !(c > b)); ) {
            this.that.mouseDistance()
        }
    }
    ...
    var z = function(a) {
        ...
        this.currentImage = !1,
        this.imageLoaded = !1,
        this.selectColor = "rgba(255,255,255,0.6)",
        this.selectColorPrimary = "rgba(0,0,0,0.6)",
        this.selectionActive = !1,
        this.closeLineActive = !1,
        this.start_x = 0,
        this.start_y = 0,
        this.last_x = 0,
        this.last_y = 0,
        this.selectingStyle = "normal",
        this.used = [],
        this.canErase = !0
    };
    ...
    z.prototype.active = function() {
        ...
        var a = this.that.maxHeight
          , b = 0;
        for (this.that.mouse.active && this.canErase && (this.that.canvas.select.clear(),
        this.canErase = !1); this.that.mouse.active && this.imageLoaded || this.closeLineActive; ) {
            var c = this.that.mouse.x_0 + "-" + this.that.mouse.y_0;
            if (this.that.SelectController.usingLasso = !0,
            this.start_x || (this.start_x = this.that.mouse.x_0,
            this.start_y = this.that.mouse.y_0,
            this.that.SelectController.currentSelectImage = !1),
            this.used.indexOf(c) === -1 && (this.used.push(c),
            this.draw(this.that.mouse.x_0, this.that.mouse.y_0)),
            this.closeLineActive || (this.last_x = this.that.mouse.x_1,
            this.last_y = this.that.mouse.y_1),
            this.that.mouse.x_0 > this.that.width || this.that.mouse.x_1 > this.that.width || this.that.mouse.y_1 > this.that.height || this.that.mouse.y_0 > this.that.height) {
                this.closeLineAction();
                break
            }
            if (this.that.mouse.x_0 == this.that.mouse.x_1 && this.that.mouse.y_0 == this.that.mouse.y_1 || this.that.mouse.x_0 == this.that.mouse.last_x && this.that.mouse.y_0 == this.that.mouse.last_y) {
                this.closeLineAction();
                break
            }
            if (this.selectionActive = !0,
            b++,
            b > a) {
                this.closeLineAction();
                break
    ...
    z.prototype.draw = function(a, b, c) {
        a < 0 && (a = 0),
        a > this.that.width - 1 && (a = this.that.width - 1),
        b < 0 && (b = 0),
        b > this.that.height - 1 && (b = this.that.height - 1),
        this.that.canvas.select.ctx.fillStyle = c ? c : this.selectColor,
        this.that.canvas.select.ctx.fillRect(a, b, 1, 1),
        this.that.canvas.select.ctx.fillStyle = c ? c : this.selectColorPrimary,
        this.that.canvas.select.ctx.fillRect(a, b, 1, 1)
    }
    ,
    ...
    z.prototype.closeLineAction = function() {
        this.closeLineActive && (this.that.mouse.prevent = !1,
        this.closeLineActive = !1,
        this.bucketImage(),
        this.render(),
        this.that.render())
    ...
    z.prototype.bucketImage = function() {
        ...
        this.that.getDrawnPixels(function(b, c, d, e, f, g, h) {
            ...
            d += 2,
            a.that.canvas.rendering.clear(),
            a.that.canvas.rendering.canvas.width = c,
            a.that.canvas.rendering.canvas.height = d,
            a.that.canvas.rendering.putSimple(a.that.canvas.select.canvas, -(e - 1), -(f - 1)),
            a.that.bucketCreate(function() {
                a.that.canvas.select.clear(),
                a.that.canvas.rendering.canvas.width = a.that.width,
                a.that.canvas.rendering.canvas.height = a.that.height,
                a.that.canvas.select.putSimple(a.that.canvas.data.canvas, e - 1, f - 1),
                a.that.canvas.select.ctx.fillStyle = "#000000",
                a.that.canvas.select.ctx.fillRect(0, 0, a.that.width, f),
                a.that.canvas.select.ctx.fillRect(0, f - 1 + d, a.that.width, a.that.height),
    ...
    z.prototype.extract = function() {
        ...
        this.that.canvas.data.clear(),
        this.that.canvas.data.putSimple(this.currentImage),
        this.that.canvas.data.ctx.globalCompositeOperation = "destination-out",
        this.that.canvas.data.putSimple(this.that.canvas.select.canvas),
        this.that.canvas.data.ctx.globalCompositeOperation = "source-over",
        this.that.canvas.rendering.clear(),
        this.that.canvas.rendering.putSimple(this.currentImage),
        this.that.canvas.rendering.ctx.globalCompositeOperation = "destination-in",
        this.that.canvas.rendering.putSimple(this.that.canvas.select.canvas),
        this.that.canvas.rendering.ctx.globalCompositeOperation = "source-over";
        ...
        this.that.getDrawnPixels(function(c, d, e, f, g, h, i) {
            a.that.canvas.rendering.clear(),
            a.that.canvas.rendering.canvas.width = d,
            a.that.canvas.rendering.canvas.height = e,
            a.that.canvas.rendering.ctx.putImageData(c, -f, -g),
            a.that.canvas.data.clear(),
            a.that.canvas.data.canvas.width = d,
            a.that.canvas.data.canvas.height = e,
            a.that.canvas.data.ctx.putImageData(b, -f, -g),
            a.that.SelectController.cutImageData = a.that.canvas.data.image();
            var j = a.that.canvas.rendering.image();
            j.onload = function() {
                var b = a.that.SelectController.copyDataFormat(this, d, e);
                a.that.SelectController.cut_width = 0,
                a.that.SelectController.cut_height = 0,
                a.restore(),
                a.that.ToolController.tool = a.that.ToolController.tools.SelectTool,
                a.that.ToolController.tool.setSelection(f, g, d, e, d, e, !0),
                a.that.SelectController.pasteSelection(f, g, f, g, !0, !0, b),
                a.that.SelectController.showStampButton(),
                a.that.render()
            }
        }, "data"),
        this.that.canvas.select.clear()
    ...
    z.prototype.mouseCorrection = function() {
        this.that.mouse.prevent = !0,
        this.last_x > this.that.width - 1 && (this.last_x = this.that.width - 1),
        this.last_y > this.that.height - 1 && (this.last_y = this.that.height - 1),
        this.that.mouse.dx = Math.abs(this.last_x - this.start_x),
        this.that.mouse.dy = Math.abs(this.last_y - this.start_y),
        this.that.mouse.sx = this.start_x < this.last_x ? 1 : -1,
        this.that.mouse.sy = this.start_y < this.last_y ? 1 : -1,
        this.that.mouse.err = this.that.mouse.dx - this.that.mouse.dy,
        this.that.mouse.x_1 = this.last_x,
        this.that.mouse.y_1 = this.last_y,
        this.that.mouseDistance(this.start_x, this.start_y)
    }
    ,
    z.prototype.close = function(a) {
        this.mouseCorrection(),
        this.closeLineActive = !0,
        this.active()
    }
    ,
    z.prototype.off = function(a) {
        this.selectionActive && (this.close(),
        this.selectionActive = !1),
        this.restore(),
        this.that.isApp && this.getCurrent()
    }
    ...
    var A = function(a) {
        ...
        this.last_mouse_x = 0,
        this.last_mouse_y = 0,
        this.current_mouse_x = -1,
        this.current_mouse_y = -1,
        this.hasPoint = !1,
        this.selectingStyle = "normal",
        this.canErase = !0,
        this.keySet = !1
    ...
    A.prototype.getSelectCurrent = function() {
        var a = this;
        this.currentSelectImage = this.that.canvas.select.image(),
        this.currentSelectImage.onload = function() {
            a.imageSelectLoaded = !0,
            a.currentSelectImage = this
        }
    }
    ,
    A.prototype.active = function() {
        this.currentImage || (this.that.canvas.select.clear(),
        this.getCurrent(),
        this.getSelectCurrent());
        var a = this.that.maxHeight
          , b = 0;
        for (this.that.mouse.active && this.canErase && (this.that.canvas.select.clear(),
        this.canErase = !1),
        this.that.mouse.active && this.imageLoaded && this.that.canvas.select.clear(),
        this.that.mouse.active && (this.that.SelectController.active = !0); this.closeLineActive || this.that.mouse.active && this.that.SelectController.active && this.hasPoint; ) {
            if (this.start_x || (this.start_x = this.that.mouse.x_0,
            this.start_y = this.that.mouse.y_0,
            this.that.SelectController.currentSelectImage = !1),
            this.draw(this.that.mouse.x_0, this.that.mouse.y_0),
            this.that.mouse.x_0 > this.that.width || this.that.mouse.x_1 > this.that.width || this.that.mouse.y_1 > this.that.height || this.that.mouse.y_0 > this.that.height) {
            ...
            if (this.closeLineActive || (this.last_x = this.that.mouse.x_1,
            this.last_y = this.that.mouse.y_1),
    ...
    A.prototype.setPoint = function() {
        return this.hasPoint = !0,
        this.start_x == this.that.mouse.x_1 && this.start_y == this.that.mouse.y_1 ? this.close() : (this.getSelectCurrent(),
        this.that.mouse.start_x = this.that.mouse.x_1,
        void (this.that.mouse.start_y = this.that.mouse.y_1))
    }
    ,
    ...
    A.prototype.draw = function(a, b, c) {
        this.that.canvas.select.putSimple(this.currentSelectImage),
        this.that.canvas.select.ctx.fillStyle = c ? c : this.selectColor,
        this.that.canvas.select.ctx.fillRect(a, b, 1, 1),
        this.that.canvas.select.ctx.fillStyle = c ? c : this.selectColorPrimary,
        this.that.canvas.select.ctx.fillRect(a, b, 1, 1)
    ...
    A.prototype.close = function(a) {
        this.mouseCorrection(),
        this.closeLineActive = !0,
        this.that.SelectController.active = !1,
        this.that.mouse.active = !1,
        this.hasPoint = !1,
        this.active()
    }
    ...
    B.prototype.active = function(a) {
        var b = this;
        this.currentImage || this.getCurrent(),
        this.that.bucketCreate(function() {
            b.bucketImage = b.that.canvas.data.image(),
            b.bucketImage.onload = function() {
                b.extract()
            }
        }, a, !0),
        this.that.mouse.active = !1
    ...
    B.prototype.extract = function() {
        ...
        this.that.canvas.data.clear(),
        this.that.canvas.data.putSimple(this.currentImage),
        this.that.canvas.data.ctx.globalCompositeOperation = "destination-in",
        this.that.canvas.data.putSimple(this.bucketImage),
        this.that.canvas.data.ctx.globalCompositeOperation = "source-over",
        this.that.canvas.rendering.clear(),
        this.that.canvas.rendering.putSimple(this.currentImage),
        this.that.canvas.rendering.ctx.globalCompositeOperation = "destination-out",
        this.that.canvas.rendering.putSimple(this.bucketImage),
        this.that.canvas.rendering.ctx.globalCompositeOperation = "source-over";
        var b = this.that.canvas.rendering.ctx.getImageData(0, 0, this.that.width, this.that.height);
        this.that.getDrawnPixels(function(c, d, e, f, g, h, i) {
            a.that.canvas.rendering.clear(),
            ...
            var j = a.that.canvas.rendering.image();
            j.onload = function() {
                a.that.SelectController.copySection(this, !1, !0),
                a.that.SelectController.cut_width = 0,
                a.that.SelectController.cut_height = 0,
                a.restore(),
                a.that.ToolController.tool = a.that.ToolController.tools.SelectTool,
                a.that.ToolController.tool.setSelection(f, g, d, e, d, e, !0),
                a.that.SelectController.pasteSelection(f, g, f, g, !0),
                a.that.SelectController.showStampButton(),
                a.that.render()
            }
        }, "data"),
    ...
    var C = function(a) {
        ...
        this.size = !1,
        this.currentBrushImage = !1,
        this.init()
    };
    C.prototype.init = function() {
        this.that.settings.brush.image && this.that.settings.brush.image.src || this["new"](),
        this.listeners()
    }
    ,
    ...
    C.prototype.changeSize = function() {
        ...
        a <= 0 && (a = 1),
        this.that.canvas.rendering["default"](),
        this.that.canvas.rendering.canvas.width = Math.abs(a),
        this.that.canvas.rendering.canvas.height = Math.abs(b),
        this.that.canvas.rendering.setSmoothing(),
        this.that.canvas.rendering.ctx.drawImage(this.currentBrushImage.image, 0, 0, a, b),
        this.fromSrc(this.that.canvas.rendering.dataURL(), !0)
    }
    ,
    ...
    C.prototype.set = function(a, b) {
        b && (this.currentBrushImage = !1),
        this.that.settings.brush.image = a,
        this.that.settings.brush.width = a.width,
        this.that.settings.brush.height = a.height,
        this.that.settings.brush.solid = this.that.canvasToSolid(this.that.settings.brush.image, !1, !1, !0),
        this.that.settings.brush.black = this.that.canvasToSolid(this.that.settings.brush.image, "#000000", !1, !0),
        this.that.settings.brush.mouse = this.that.canvasToSolid(this.that.settings.brush.image, "#000000", .25, !0),
        this.that.ToolController.setBrushImage(),
        this.setOptions(),
        this.that.ToolController.loadOptions(),
        this.that.canvas.rendering["default"]()
    }
    ,
    ...
    C.prototype.active = function(a) {
        var b = 500
          , c = 0;
        if (this.currentImage || this.getCurrent(),
        this.options.track.value)
            for (!this.that.mouse.active || this.initClick || this.that.keyEvent || (this.initClick = !0); this.that.mouse.active && this.imageLoaded && (this.that.layPixel(!1, !1, !1, !1, "rendering", 1),
            !(this.that.mouse.x_0 > this.that.width || this.that.mouse.x_1 > this.that.width || this.that.mouse.y_1 > this.that.height || this.that.mouse.y_0 > this.that.height)) && (this.that.mouse.x_0 != this.that.mouse.x_1 || this.that.mouse.y_0 != this.that.mouse.y_1) && (c++,
            !(c > b)); ) {
                this.that.mouseDistance()
            }
        else
            this.that.mouse.active && (this.that.layPixel(!1, !1, !1, !1, "rendering", 1),
            this.initClick = !0);
        (this.that.mouse.active && this.imageLoaded || this.that.mouse.activeForceReady) && (this.that.canvas.layer.clear(),
        this.that.canvas.layer.putSimple(this.currentImage),
        this.options.pattern.value ? this.that.ToolController.drawToCanvas(this.that.canvas.data.canvas, "layer") : this.that.ToolController.drawToCanvas(this.that.canvas.rendering.canvas, "layer"))
    }
    ,
    ...
    C.prototype.setOptions = function() {
        a("#range-brushsize-preview").text(this.that.settings.brush.width),
        a("#range-brushsize").val(this.that.settings.brush.width)
    }
    ,
    ...
    D.prototype.toggleSecondaryColor = function() {
        this.value = this.self.that.ColorController.color,
        this.self.that.ToolController.loadOptions()
    }
    ,
    D.prototype.active = function(a) {
        if (this.currentImage || (this.currentImage = this.that.canvas.layer.image(),
        this.load()),
        this.that.mouse.active && this.imageLoaded && (!this.startX && this.options.bucket.value || !this.startX && this.options.bucketAll.value)) {
            this.that.bucketCreate(function() {}, this.options.bucketAll.value)
        }
        this.that.mouse.active && this.imageLoaded && (this.that.canvas.layer.clear(),
        this.that.canvas[this.canvas].clear(),
        this.that.canvas[this.canvas].putSimple(this.currentImage));
        this.that.maxWidth;
        this.that.mouse.active && this.imageLoaded && (this.startX || (this.startX = this.that.mouse.x_0,
        this.startY = this.that.mouse.y_0,
        0 == this.startX && (this.startX = 1)),
        this.endX = this.that.mouse.x_0,
        this.endY = this.that.mouse.y_0,
        0 == this.endX && (this.endX = 1),
        0 == this.endY && (this.endY = 1),
        this.apply())
    }
    ,
    D.prototype.apply = function() {
        if (this.startX) {
            ...
            this.options.radial.value)
                var d = this.that.canvas[this.canvas].ctx.createRadialGradient(this.startX, this.startY, 1, this.startX, this.startY, c);
            else
                var d = this.that.canvas[this.canvas].ctx.createLinearGradient(this.startX, this.startY, this.endX, this.endY);
            var e = this.that.ColorController.secondary;
            if (this.that.isApp && this.options.secondary.value && (e = this.options.secondary.value),
            this.options.transparent.value || this.that.isMobile && !this.that.isTablet && !this.that.isApp) {
                e = "transparent";
            ...
            d.addColorStop(0, g),
            d.addColorStop(1, e),
            this.that.canvas[this.canvas].ctx.fillStyle = d,
            this.that.canvas[this.canvas].ctx.fillRect(0, 0, this.that.width, this.that.height),
            this.options.bucket.value || this.options.bucketAll.value) {
                var h = this.that.canvas[this.canvas].ctx.getImageData(0, 0, this.that.width, this.that.height);
                this.that.canvas[this.canvas].clear(),
                this.that.settings.dithering && (h = this.ditherImageData(h)),
                this.that.canvas[this.canvas].ctx.putImageData(h, 0, 0),
                this.that.canvas[this.canvas].ctx.globalCompositeOperation = "destination-in",
                this.that.canvas[this.canvas].putSimple(this.that.canvas.data.canvas),
                this.that.canvas[this.canvas].ctx.globalCompositeOperation = "source-over",
                this.that.canvas.layer.putSimple(this.currentImage),
                this.that.canvas.layer.putSimple(this.that.canvas[this.canvas].canvas)
            } else {
                if (this.that.settings.dithering) {
                    var h = this.that.canvas[this.canvas].ctx.getImageData(0, 0, this.that.width, this.that.height);
                    h = this.ditherImageData(h),
                    this.that.canvas[this.canvas].ctx.putImageData(h, 0, 0),
                    this.that.canvas.layer.putSimple(this.currentImage)
                }
                this.that.canvas.layer.putSimple(this.that.canvas[this.canvas].canvas)
    ...
    ,
    D.prototype.ditherImageData = function(a) {
        for (var b = new Uint32Array(a.data.buffer), c = 0; c < b.length; c += 1) {
            var d = this.that.getExactXYFromPosition(c);
            (this.that.isOdd(d[0]) && this.that.isOdd(d[1]) || !this.that.isOdd(d[0]) && !this.that.isOdd(d[1])) && (b[c] = "0x00000000")
        }
        return a
    }
    ,
    D.prototype.dittering = function(a, b) {
        for (var c = this.that.width, d = this.that.height, e = this.that.canvas[this.canvas].ctx.getImageData(0, 0, c, d), f = e.data, g = 0; g < d; g++)
            for (var h = 0; h < c; h++) {
                var i, j = 4 * (g * c + h), k = f[j + 3];
                switch (b) {
                case "checker":
                    i = (Math.floor(h / a) + Math.floor(g / a)) % 2 === 0;
                    break;
                case "horizontalLines":
                    i = Math.floor(g / a) % 2 === 0;
                    break;
                case "verticalLines":
                    i = Math.floor(h / a) % 2 === 0;
                    break;
                default:
                    return void console.log("Invalid dithering pattern given.")
                }
                i ? f[j] = f[j + 1] = f[j + 2] = f[j + 3] = 0 : f[j + 3] = k
            }
        this.that.canvas[this.canvas].ctx.putImageData(e, 0, 0),
        this.that.canvas.layer.putSimple(this.that.canvas[this.canvas].canvas)
    }
    ,
    ...
    var E = function(a) {
        ...
        this.tools = {},
        this.tool = !1,
        this.createHistory = !0,
        this.renderChange = !1,
        this.multiOpen = !1,
        this.currentTool = !1,
        this.drawToCanvasRenderTimer = null,
        this.brushes = this.brushData(),
        this.backgroundPatternImageData = !1,
        this.backgroundPatternImage = !1
    };
    E.prototype.init = function() {
        this.listeners(),
        this.tools.PencilTool = new f(this.that),
        this.tool = this.tools.PencilTool,
        this.loadCustomBrushes(),
        this.switchCursor(this.that.tool),
        this.setIcon(),
        "object" != typeof this.tools.HandTool && (this.tools.HandTool = new i(this.that))
    }
    ,
    E.prototype.listeners = function() {
        ...
        a("#tool-option-appended, #extra-panel-content").on("input", ".tool-change", function() {
            var c = a(this).attr("data-tool")
              ...
              , f = a(this).val();
            e && (d = e),
            b.tool.options[d].value = f,
            a(".range-" + d).val(f),
            a("." + c + "-" + d + "-value").text(f),
            "function" == typeof b.tool.options[d].fn && b.tool.options[d].fn(f)
        }),
        ...
        a("#tool-option-appended, #extra-panel-content").on("change", ".select-tool-options", function() {
            var c = a(this).attr("data-option")
              , d = a(this).val();
            a(".select-tool-options").val(d),
            "function" == typeof b.tool.options[c].fn && b.tool.options[c].fn(d)
        }),
    ...
    E.prototype.switchToolOption = function(b, c) {
        this.tool.options[b].value = c,
        this.checkCancelOptions(b),
        this.checkToolMulti(b),
        a(".op-" + b).prop("checked", c),
        "function" == typeof this.tool.options[b].fn && this.tool.options[b].fn(c)
    }
    ,
    ...
    E.prototype.hideMulti = function() {
        this.multiOpen && (this.multiOpen = !1,
        this.multiChecking = !1,
        a("#tool-multi").hide())
    }
    ,
    E.prototype.cancel = function() {
        "function" == typeof this.tool.cancel && this.tool.cancel(),
        this.that.mouse.activeForce = !1,
        this.that.mouse.active = !1,
        this.that.mouse.ignoreFinish = !0,
        this.that.mouse.createHistory = !1,
        this.that.online.send = !1,
        this.tool.currentImage
    }
    ,
    ...
    E.prototype.bucketBackgroundPattern = function(a) {
        ...
        this.that.backgroundImageRepeat("data", this.that.stamps.data, function() {
            ...
            b.backgroundPatternImageData = a,
            b.backgroundPatternImage = b.that.canvas.data.image()
        })
    }
    ,
    E.prototype.checkToolMulti = function(b) {
        !this.tool.options[b].value && this.tool.options[b].multi && (b = "default"),
        this.tool.options[b] && this.tool.options[b].multi && this.tool.multi[b] && a("#" + this.tool.id + " .icon-tool").css({
    ...
    E.prototype.checkCancelOptions = function(b) {
        ...
        this.tool.options[b] && this.tool.options[b].cancels && a.each(this.tool.options[b].cancels, function(b, d) {
            c.tool.options[d].value = !1,
            a("#op-" + d).prop("checked", !1)
        })
    }
    ,
    ...
    E.prototype.destroyTools = function() {
        ...
        a.each(this.tools, function(a, c) {
            "function" == typeof b.tools[a].destroy && "SelectTool" != a && (b.tools[a].destroy(),
            b.tools[a] = !1)
        })
    }
    ,
    E.prototype.loadBrushesElements = function() {
        a("#popup-container #brush-settings-display").html(""),
        a.each(this.brushes, function(b, c) {
    ...
    E.prototype.setBrushColor = function(a, b) {
        (this.that.settings.brush.image && "Brush" == this.that.tool || b && this.that.settings.brush.image) && (this.that.settings.brush.solid = this.that.canvasToSolid(this.that.settings.brush.image, a, !1, !0),
        this.that.settings.brush.black = this.that.canvasToSolid(this.that.settings.brush.image, "#000000", !1, !0))
    }
    ,
    ...
    ,
    E.prototype.toggleAppToolDraw = function(a) {}
    ,
    E.prototype.selectTool = function(b, c, d, e) {
        var f = this;
        return a("#tools-container .tool-selection").removeClass("active"),
        b.addClass("active"),
        e || "Stamp" == c || "Select" == c ? (this.finished(),
        this.renderChange ? this.checkRenderNeeded(function() {
            f.selectTool(b, c, d)
        }) : ("Text" == this.that.tool && this.doHistory(),
        this.restore(),
        this.hideButtons(),
        this.showButtons(c),
        this.that.tool = c,
        this.toggleMirrorWrapper(),
        this.hideISO(),
        this.activate(d),
        this.use(),
        this.startTool(),
        ...
        this.loadOptions(),
        this.setIcon(),
        this.hidePanningButton(),
        this.toggleToolBarPixelSize(),
        this.switchCursor(this.that.tool),
        void ("function" == typeof this.tool.on && this.tool.on()))) : (this.that.mouse.active = !1,
        void this.that.LayerController.updateLayer(!1, function() {
            f.selectTool(b, c, d, !0)
        }, !0))
    }
    ,
    E.prototype.checkRenderNeeded = function(a) {
        this.renderChange && (this.renderChange = !1,
        this.tool.renderChange(function() {
            return a()
        }))
    }
    ,
    ...
    E.prototype.activate = function(b) {
        "Stamp" == this.that.tool && ("object" != typeof this.tools.StampTool && (this.tools.StampTool = new w(this.that),
        this.tools.StampTool.active()),
        this.tool = this.tools.StampTool),
        "Select" == this.that.tool && ("object" != typeof this.tools.SelectTool && (this.tools.SelectTool = new q(this.that),
        this.tools.SelectTool.active()),
        this.tool = this.tools.SelectTool),
        "Text" == this.that.tool && (this.that.TextController.loadCustom(),
        a(".dropdown-tool-container").addClass("active")),
        "Line" == this.that.tool && this.showISO()
    }
    ,
    ...
    E.prototype.use = function() {
        this.that.finished && (this.that.mouse.active && (this.that.ColorController.checkForColorChange(),
        this.makeHistory()),
        "Pencil" == this.that.tool && ("object" != typeof this.tools.PencilTool && (this.tools.PencilTool = new f(this.that)),
        "object" != typeof this.tools.EraserTool && (this.tools.EraserTool = new j(this.that)),
        "object" != typeof this.tools.ColorPickerTool && (this.tools.ColorPickerTool = new o(this.that)),
        this.tool = this.tools.PencilTool),
        "Hand" == this.that.tool && ("object" != typeof this.tools.HandTool && (this.tools.HandTool = new i(this.that)),
        this.tool = this.tools.HandTool),
        "Spray" == this.that.tool && ("object" != typeof this.tools.SprayTool && (this.tools.SprayTool = new h(this.that)),
        this.tool = this.tools.SprayTool),
        "Filter" == this.that.tool && ("object" != typeof this.tools.FilterTool && (this.tools.FilterTool = new g(this.that),
        this.tools.FilterTool.createBrush()),
        this.tool = this.tools.FilterTool),
        "Brush" == this.that.tool && ("object" != typeof this.tools.BrushTool && (this.tools.BrushTool = new C(this.that)),
        this.tool = this.tools.BrushTool),
        "Eraser" == this.that.tool && (this.tool = this.tools.EraserTool),
        "Line" == this.that.tool && ("object" != typeof this.tools.LineTool && (this.tools.LineTool = new k(this.that)),
        this.tool = this.tools.LineTool),
        "Square" == this.that.tool && ("object" != typeof this.tools.SquareTool && (this.tools.SquareTool = new m(this.that)),
        this.tool = this.tools.SquareTool),
        "Circle" == this.that.tool && ("object" != typeof this.tools.CircleTool && (this.tools.CircleTool = new r(this.that)),
        this.tool = this.tools.CircleTool),
        "Bucket" == this.that.tool && ("object" != typeof this.tools.BucketTool && (this.tools.BucketTool = new n(this.that)),
        this.tool = this.tools.BucketTool),
        "ColorPicker" == this.that.tool && (this.tool = this.tools.ColorPickerTool),
        "Move" == this.that.tool && ("object" != typeof this.tools.MoveTool && (this.tools.MoveTool = new p(this.that)),
        this.tool = this.tools.MoveTool),
        "Select" == this.that.tool && ("object" != typeof this.tools.SelectTool && (this.tools.SelectTool = new q(this.that)),
        "object" != typeof this.tools.LassoTool && (this.tools.LassoTool = new z(this.that)),
        "object" != typeof this.tools.WandTool && (this.tools.WandTool = new B(this.that)),
        "object" != typeof this.tools.PolyTool && (this.tools.PolyTool = new A(this.that)),
        this.tool = this.tools.SelectTool),
        "Gradient" == this.that.tool && ("object" != typeof this.tools.GradientTool && (this.tools.GradientTool = new D(this.that)),
        this.tool = this.tools.GradientTool),
        "LightenDarken" == this.that.tool && ("object" != typeof this.tools.LightenDarkenTool && (this.tools.LightenDarkenTool = new s(this.that)),
        this.tool = this.tools.LightenDarkenTool),
        "Text" == this.that.tool && ("object" != typeof this.tools.TextTool && (this.tools.TextTool = new t(this.that)),
        this.tool = this.tools.TextTool),
        "Dithering" == this.that.tool && ("object" != typeof this.tools.DitheringTool && (this.tools.DitheringTool = new v(this.that)),
        this.tool = this.tools.DitheringTool),
        "Lasso" == this.that.tool && ("object" != typeof this.tools.LassoTool && (this.tools.LassoTool = new z(this.that)),
        this.tool = this.tools.LassoTool),
        this.tool.active())
    }
    ,
    ...
    E.prototype.drawToCanvas = function(a, b) {
        var c = this
          , d = 50;
        this.that.mouse.active && (this.that.mouse.doubleTapActive || !this.that.app.fingerToDraw || !this.that.isApp || this.that.isApp && this.that.app.fingerToDraw && Date.now() > this.that.mouse.activeAt + d) || this.that.mouse.activeForceReady ? (clearTimeout(this.drawToCanvasRenderTimer),
        this.that.canvas[b].putSimple(a),
        this.that.mouse.activeForceReady && (this.that.mouse.activeForceReady = !1,
        setTimeout(function() {
            c.that.render()
        }, 1))) : (clearTimeout(this.drawToCanvasRenderTimer),
        this.drawToCanvasRenderTimer = setTimeout(function() {
            c.that.mouse.activeForceReady = !0,
            c.drawToCanvas(a, b)
        }, d + 1))
    }
    ,
    E.prototype.off = function() {
        "function" == typeof this.tool.off && this.tool.off(),
        this.turnOffButtons(),
        this.resetRainbowColor(),
        this.that.online.status && this.that.online.send && (this.that.OnlineController.writeLayer(),
        this.that.online.send = !1)
    }
    ,
    E.prototype.showPanningButton = function() {
        this.currentTool = this.that.tool,
        this.that.tool = "Hand",
        a("#panning-active").show()
    }
    ,
    E.prototype.hidePanningButton = function() {
        a("#panning-active").hide(),
        this.currentTool = !1
    }
    ,
    E.prototype.offPanningButton = function() {
        this.that.tool = this.currentTool,
        this.hidePanningButton()
    }
    ,
    ...
    E.prototype.restore = function() {
        "function" == typeof this.tool.restore && this.tool.restore(),
        this.renderChange = !1,
        this.turnOffButtons(),
        this.resetRainbowColor()
    }
    ...
    E.prototype.showButtons = function(b) {
        b = b.toLowerCase(),
        a("#right-sidebar ." + b + "-tool-toggle").css("display", "inline-block")
    }
    ,
    ...
    E.prototype.history = function(a, b) {
        var c = a.data.currentLayer
          , d = a.data.frame;
        a.data.layer;
        0 == this.that.FrameController.selectByUnqid(d.unqid) && this.that.FrameController.newFromData(d),
        this.that.FrameController.frames[a.data.currentFrame].layers = [],
        this.that.FrameController.frames[a.data.currentFrame].layers = a.data.layers,
        this.that.FrameController.frames[a.data.currentFrame].selectedLayer = c,
        this.that.FrameController.select(a.data.currentFrame),
        this.that.LayerController.selectLayer(c),
        this.that.LayerController.updateList(),
        this.that.LayerController.select(),
        this.restore()
    }
    ,
    E.prototype.showOptions = function() {
        ...
        this.tool.hasOptions ? (a("#tool-options-title").text(this.that.tool),
        a("#extra-panel-content").show().removeClass("hidden"),
        a("#tool-sidebar-tab").hasClass("active") || a("#sidebar-not").addClass("active"),
        a("#sidebar-tool-content .check-tool").each(function() {
            var c = b.that.tool.toLowerCase()
              , d = a(this).attr("data-tool");
            a(this).hide(),
            c == d && a(this).show()
        })) : (a("#tool-options-title").text("No"),
        a("#extra-panel-content").hide(),
        a("#sidebar-not").removeClass("active"))
    }
    ,
    ...
    E.prototype.mirrorToggle = function(b) {
        var c = b.attr("data-type")
          , d = this;
        this.that.mirror[c] ? this.that.mirror[c] = !1 : this.that.mirror[c] = !0,
        a("#mirror-tool .mirror-tool").removeClass("active"),
        a("#mirror-tool .mirror-tool").each(function() {
    ...
    E.prototype.addBrushData = function(a) {
        ...
        c.push(a),
        this.brushes.push(a),
        this.that.putStorage("pix_brush_data", JSON.stringify(c))
    }
    ,
    E.prototype.subBrushData = function(a) {
        if (!(a <= 8)) {
            ...
            this.that.putStorage("pix_brush_data", JSON.stringify(b)),
            this.loadBrushesElements()
        }
    }
    ,
    ...
    E.prototype.loadOptions = function() {
        var b = this;
        return a("#sidebar-tool-content .appened-options").remove(),
        a("#tool-option-name span").text(this.that.tool),
        a("#tool-option-appended").html(""),
        "object" != typeof this.tool.options ? void a("#tool-option-appended").html('<span class="no-o">No options</span>') : (this.loadToolOptionsAppend("tool-option-appended"),
        this.that.isApp || this.loadToolOptionsAppend("extra-panel-content", "sidebar"),
        void ("Text" == this.that.tool && b.that.TextController.appendPreviews()))
    }
    ,
    E.prototype.loadToolOptionsAppend = function(b, c) {
        var d = this
          , e = c ? " on " + c : "";
        c = c ? c : "",
        a.each(this.tool.options, function(f, g) {
            var h = ""
              , i = (g.tag ? g.tag : "",
            g.preview ? g.preview : g.name);
            if (!(g.require && !d.that[g.require].data || g.hidden || d.that.isApp && g.hideApp) && (!g.onlyApp || d.that.isApp)) {
                if ("checkbox" == g.type) {
                    var j = g.value ? 'checked="checked"' : "";
                    h = '<div class="toggle-option"><input ' + j + ' aria-label="' + g.hint + e + '"  type="checkbox" id="op-' + f + c + '" class="check-box op-' + f + ' filled-in form-control-app tool-option-checkbox" data-set="' + f + '" value="true"/><label for="op-' + f + c + '" class="tool-toggle" title="' + g.hint + '">' + i + '<div class="toggle-label-helper">' + g.hint + "</div></label></div>",
                    d.that.isApp && (h = '<ons-list-item><div class="center">' + i + '</div><div class="right"><ons-switch class="tool-option-checkbox" ' + j + ' data-set="' + f + '" input-id="op-' + f + '"></ons-switch></div></ons-list-item>')
                }
                if ("range" == g.type) {
                    ...
                    d.that.isApp && (k = '<ons-range style="width: 100%" class="tool-change range-' + g.name + '" data-tool="' + d.that.tool + '" data-option="' + g.name + '" value="' + g.value + '" input-id="range-' + g.name + '" min="' + g.min + '" step="' + g.step + '" max="' + g.max + '"></ons-range>'),
                    h = '<div class="tool-title">' + i + ' (<span id="range-' + g.name + c + '-preview" class="' + d.that.tool + "-" + g.name + '-value">' + g.value + '</span>)</div><div class="range-wrapper"><label class="d-none" for="range-' + g.name + c + '">' + g.name + "</label>" + k + '<span class="thumb"><span class="value">' + g.value + "</span></span></div>"
                }
                if ("button" == g.type && (h = '<div class="tool-act-btn"><div class="defaul-app-button tool-actbtn" data-option="' + g.name + '">' + i + "</div>",
                d.that.isApp && (h = '<div class="tool-act-btn"><ons-button class="full tool-actbtn cb ol" modifier="quiet" data-option="' + g.name + '">' + i + "</ons-button></div>")),
                "brush" == g.type && (d.that.isApp || (h = '<div class="tool-title tb-h pt-0">Current Brush (Click to change)</div>'),
                h = h + '<div class="brush-canvas-wrapper" id="brush-canvas-wrapper"><img src="' + d.that.settings.brush.image.src + '" class="brush-image pp" height="100px"></div>'),
                "dropdown" == g.type) {
                ...
                if ("fonts" == g.type && (h = '<div class="list-selection-images pp"><div id="fonts-toolbar-options"></div></div>'),
                "stamps" == g.type) {
                    var m = "";
                    d.that.stamps.data && (m = '<div class="thumb-preview pp" style="background-image: url(' + d.that.stamps.data.src + ')"></div>'),
                    h = '<div class="defaul-app-button full stamp-select">' + m + "Pick Pattern</div>"
                }
    ...
    var F = function(b) {
        this.that = b,
        this.cookieName = "ad-002",
        this.adEl = a("#ad-popup-content")
    };
    ...
    F.prototype.close = function() {
        this.removeAd(),
        this.that.createCookie(this.cookieName, "true", 30)
    }
    ,
    ...
    G.prototype.autoUndo = function(a, b) {
        ...
        a && (c = a),
        this.undo.push(b),
        c ? this.redo.splice(a, 1) : this.redo.pop()
    }
    ,
    ...
    G.prototype.doUndo = function() {
        var a = this;
        this.undo.length >= 1 && ("Select" == this.that.tool && this.that.ToolController.tool.moved && this.that.SelectController.accept(),
        "Text" == this.that.tool && this.that.ToolController.tool.history.length && this.that.ToolController.tool.checkSettingHistoryController(),
        setTimeout(function() {
    ...
    G.prototype.doRedo = function() {
        var a = (this.redo[this.redo.length - 1],
        this.redo[this.redo.length - 2]);
        this.redo.length >= 1 && this.call(a, "redo", !1),
        this.redo.length <= 1 && (this.redo = [])
    }
    ,
    ...
    G.prototype.create = function(a, b) {
        ...
        !this.that.app.ready && this.that.isApp || this.that.startHistory(function(e) {
            ...
            a ? void d.redo.push(f) : (d.undo.push(f),
            d.redo = [],
            d.checkLimit(),
            d.that.setProgressImage(e[c].preview),
            b ? b(!0) : void 0)
        })
    }
    ,
    ...
    G.prototype.work = function(a, b) {
        ...
        this.that.loadHistoryData(a, function(d) {
            if (c.loadFrames(d, a.currentFrame),
            b)
                return b()
        })
    }
    ...
    G.prototype.loadFrames = function(a, b) {
        ...
        this.that.LayerController.layers = [],
        this.that.canvas.top && this.that.canvas.top["default"](),
        this.that.canvas.bottom && this.that.canvas.bottom["default"](),
        this.that.FrameController.frames = a,
        a[d] && (b = d),
        a[b].layers[c] || (this.that.LayerController.currentLayer = a[b].selectedLayer),
        this.that.FrameController.select(b),
        this.that.FrameController.updateList();
        var e = this.that.FrameController.frame();
        this.that.updateDisplayCanvas(this.that.LayerController.layers, e.selectedLayer),
        this.that.render(),
        this.that.loading = !1,
        this.that.online.status && this.that.OnlineController.writeLayer(),
        this.that.updateData()
    }
    ;
    var H = function(b) {
        this.that = b,
        this.jElement = a("#" + b.element.id),
        this.roundImage = !1,
        this.roundImageMouse = !1,
        this.roundImageMouseData = !1,
        this.touchCount = 0,
        this.touches = [],
        this.active = !1,
        this.activeAt = 0,
        this.activeForce = !1,
        this.activeForceReady = !1,
        this.rightClick = !1,
        this.renderMouse = !0,
        this.prevent = !1,
        this.up = !1,
        ...
        this.start_x = !1,
        this.start_y = !1,
        this.removedMobile = !1,
        this.mousePageX = 0,
        this.mousePageY = 0,
        this.mouseMoveX = 0,
        this.mouseMoveY = 0,
        this.scrollBarBuffer = 15,
        this.middleClickDown = !1,
        this["in"] = !1,
        this.x = 0,
        this.y = 0,
        this.x1 = 0,
        ...
        this.app_y_last = !1,
        this.app_use = !1,
        this.app_touch_index = !1,
        this.app_touch_active = !1,
        this.app_button_down = !1,
        this.app_update_frame = !1,
        this.removeTips = !1,
        this.doubleTapTimer = !1,
        this.doubleTapSet = 0,
        this.doubleTapActive = !1,
        this.pixelTrace = !!this.that.isApp && a("#pixel-trace"),
        this.pixelMouse = !!this.that.isApp && a("#pixel-mouse"),
        this.mouseXEl = a("#mouse-x-canvas"),
        this.mouseYEl = a("#mouse-y-canvas"),
        this.mouseXE2 = a("#mouse-x-sidebar"),
        this.mouseYE2 = a("#mouse-y-sidebar"),
        this.last_ex = 0,
        this.last_ey = 0,
        this.lastSpeedX = 0,
        this.lastSpeedY = 0,
        ...
        this.pinchStartX = 0,
        this.pinchStartY = 0,
        this.pinchCurrentX = 0,
        this.pinchCurrentY = 0,
        this.pinchInit = !1,
        this.pinchTimer = !1,
    ...
    H.prototype.desktopListeners = function(b) {
        ...
        a("#canvas-layers-appened").on("mouseout", function(a) {
            c.that.isMobile && !c.isTablet || (c["in"] = !1,
            c.out(a))
        }),
        a(b).bind("mousedown", function(b) {
            var d = a(this)
              ...
              , k = b.pageY - e.top;
            c.isTouch = !1,
            c.that.isMobile && !c.isTablet || c.that.isApp || (3 == b.which && (c.rightClick = !0),
            c.that.ZoomController.zoom > c.that.zoom["default"] && (j > f - c.scrollBarBuffer || k > g - c.scrollBarBuffer) && h > f && i > g || b.target.classList.contains("select-tool") || b.target.classList.contains("select-helpers") || c.checkPreConditions() || (2 == b.which && (b.preventDefault(),
            c.setHandTemp()),
            c.createHistory = !0,
            c.down(b)))
        }),
    ...
    H.prototype.mobileListeners = function(b) {
        ...
        a(b).bind("touchstart", function(a, b) {
            ...
            if (d.touches = a.originalEvent.touches,
            d.isTouch = !0,
            d.up = !1,
            d.activeDrawing || (d.activeDrawing = Date.now()),
            f >= 2 && Date.now() - d.activeDrawing > 150 && (e = !1),
            2 === f && e)
                d.pinchStart(a.originalEvent);
            else if (f >= 3 && e)
                d.touchStartMove();
            else {
                if (a.target.classList.contains("select-tool") || a.target.classList.contains("select-helpers") || d.checkPreConditions())
                    return;
                clearTimeout(c),
                d.removeTips || d.doRemoveTips();
        ...
        a(b).bind("touchmove", function(a) {
            ...
            2 === b && e ? d.pinchMove(a.originalEvent) : b >= 3 && e ? d.touchMoving() : d.panning(),
            d.move(a.originalEvent.touches[0])
        }),
        a(b).bind("touchend", function(a) {
            a.preventDefault(),
            a.originalEvent.touches.length || (e = !0,
            d.up = !0,
            d.finish(a.originalEvent.touches[0]))
        })
    }
    ,
    H.prototype.appListeners = function(b) {
        function c(a) {
            ...
            "undefined" != typeof a.originalEvent) {
                if (g.that.app.fingerToDraw && a.originalEvent.touches[a.originalEvent.touches.length - 1].radiusX < 50 && a.originalEvent.touches[a.originalEvent.touches.length - 1].radiusY < 50 || g.that.app.fingerToDraw && 0 === a.originalEvent.touches[a.originalEvent.touches.length - 1].radiusX)
                    j = a.originalEvent.touches.length;
                else
                    for (var b = 0; b < a.originalEvent.touches.length; b++)
                        "canvas-touchmove" != a.originalEvent.touches[b].target.id && "canvas_display" != a.originalEvent.touches[b].target.id && "canvas-layers-container" != a.originalEvent.touches[b].target.id && "canvas_grid_image" != a.originalEvent.touches[b].target.id || j++;
                if (g.activeDrawing || (g.activeDrawing = Date.now()),
                g.touchCount = j,
                j >= 2 && Date.now() - g.activeDrawing > 150 && (i = !1),
                j >= 2 && i && !g.app_button_down)
                    g.pinchStart(a.originalEvent);
                else {
                    if (g.checkPreConditions())
                        return;
                    if (g.that.app.fingerToDraw)
                        g.app_touch_index = 0;
                    else
                        for (var b = 0; b < a.originalEvent.touches.length; b++)
                            "canvas-touchmove" != a.originalEvent.touches[b].target.id && "canvas_display" != a.originalEvent.touches[b].target.id && "canvas-layers-container" != a.originalEvent.touches[b].target.id && "canvas_grid_image" != a.originalEvent.touches[b].target.id && "pixel-trace" != a.originalEvent.touches[b].target.id || (g.app_touch_index = b);
                    var c = a.originalEvent.touches[g.app_touch_index];
                    g.that.app.fingerToDraw && (g.setClickMobile(c),
                    g.position(c)),
                    g.app_touch_active = !0,
                    g.app_update_frame = !0,
                    g.app_use = !0,
                    g.up = !1,
                    g.activeAt = Date.now(),
                    g.activeForce = !0,
                    g.down(c),
                    g.that.app.fingerToDraw && (g.createHistory = !0,
                    g.active = !0,
                    g.move(c))
                }
            }
        ...
        function d(a) {
            if (g.that.app.fingerToDraw && (j = a.originalEvent.touches.length),
            j >= 2 && i)
                g.pinchMove(a.originalEvent);
            else {
                ...
                var b = a.originalEvent.touches[g.app_touch_index]
                  , c = !1;
                if (!g.that.app.fingerToDraw)
                    for (var d = 0; d < a.originalEvent.touches.length; d++)
                        c || "canvas-touchmove" != a.originalEvent.touches[d].target.id && "canvas_display" != a.originalEvent.touches[d].target.id && "canvas-layers-container" != a.originalEvent.touches[d].target.id && "canvas_grid_image" != a.originalEvent.touches[d].target.id && "pixel-trace" != a.originalEvent.touches[d].target.id || (b = a.originalEvent.touches[d],
                        c = !0);
                if (!g.app_touch_active)
                    return;
        ...
        function e(a) {
            ...
            if (j--,
            g.app_touch_index = !1,
            !g.that.app.fingerToDraw)
                for (var c = 0; c < a.originalEvent.touches.length; c++)
                    "canvas-touchmove" != a.originalEvent.touches[c].target.id && "canvas_display" != a.originalEvent.touches[c].target.id && "canvas-layers-container" != a.originalEvent.touches[c].target.id && "canvas_grid_image" != a.originalEvent.touches[c].target.id && "pixel-trace" != a.originalEvent.touches[c].target.id || (g.app_touch_index = c);
            g.up = !0,
            g.app_button_down && "Select" == g.that.tool && g.that.ToolController.tool.moving && g.endDrawButtonApp(),
            (g.doubleTapActive || g.that.app.fingerToDraw) && (g.toolsUp(),
            g.doubleTapActive = !1,
            g.active = !1,
            g.activeForce && (g.activeForceReady = !0)),
            g.app_button_down && (g.app_touch_index = 1),
            g.app_touch_active = !1,
            g.app_use = !1,
            g.touchCount = j,
            (!j || j <= 0 || !a.originalEvent.touches.length) && (j = 0,
            i = !0,
            g.touchCount = 0,
            g.activeForceReady && ["Select", "Hand", "Bucket"].indexOf(g.that.tool) == -1 && (g.that.ToolController.tool.active(),
            g.activeForce = !1,
            g.activeForceReady = !1),
            g.that.ToolController.tools.HandTool.off(!0),
            g.finish(b)),
            (g.that.zoom_step > 1 && Math.abs(g.app_x - g.x0) >= 3 && !g.that.app.fingerToDraw || g.that.zoom_step > 1 && Math.abs(g.app_y - g.y0) >= 3 && !g.that.app.fingerToDraw) && (g.app_x = g.x0,
            g.app_y = g.y0,
            g.that.ZoomController.position(!1, !1, !0))
        }
        function f(a) {
            g.createHistory = !0,
            g.doubleTap(!0)
        ...
        var g = this
          , h = (a("#drawing-canvas-conatiner"),
        a("#app-draw-down"))
          , i = !0
          , j = 0;
        a("#drawing-container").bind("touchstart", c),
        a("#drawing-container").bind("touchend", e),
        a("#drawing-container").bind("touchmove", d),
        a("#drawing-container").bind("doubletap", f),
        h.bind("touchstart", function(b) {
            a("#app-draw-down").addClass("set"),
            g.app_button_down = !0,
            g.createHistory = !0,
            g.active = !0,
            g.app_use = !0,
        ...
        h.bind("touchend keyup", function(a) {
            g.app_button_down && (g.endDrawButtonApp(),
            g.finish())
        })
    }
    ,
    H.prototype.setHandTemp = function() {
        this.middleClickDown = this.that.tool,
        this.that.tool = "Hand"
    }
    ,
    H.prototype.resetHandTemp = function(a) {
        this.that.tool = a ? a : this.middleClickDown,
        this.middleClickDown = !1
    }
    ,
    H.prototype.resetLast = function() {
        this.last_x = this.that.width / 2,
        this.last_y = this.that.height / 2,
        this.that.ZoomController.last_x = this.that.width / 2,
        this.that.ZoomController.last_y = this.that.height / 2
    }
    ,
    ...
    H.prototype.touchMoving = function() {
        this.isTouchMoving && (this.isPinching = !1,
        this.active && this.that.ToolController.cancel(),
        this.that.ToolController.tools.HandTool.active(!0))
    }
    ,
    H.prototype.touchEndMove = function() {
        this.isTouchMoving = !1,
        this.that.NavigationController.ignoreZoomLastClicks || this.that.ToolController.tools.HandTool.off()
    }
    ,
    H.prototype.pinchStart = function(b) {
        if (!this.isPinching && !this.isTouchMoving) {
            ...
            this.isPanning = !0,
            this.isPinching = !0,
            this.active && (this.activeAt = !1,
            this.that.ToolController.cancel());
            ...
            this.pinchPreviousX = this.that.ZoomController.last_cord_x,
            this.pinchPreviousY = this.that.ZoomController.last_cord_y,
            this.pinchStartX = h[0],
            this.pinchStartY = h[1]
        }
    }
    ,
    H.prototype.pinchMiddlePoint = function(b, c, d, e) {
        ...
        var k = (g + i) / 2
          , l = (h + j) / 2;
        return this.pinchCurrentX = k,
        this.pinchCurrentY = l,
        [k, l]
    }
    ,
    H.prototype.pinchMove = function(b) {
        if (this.isPinching && !this.isTouchMoving) {
            ...
            l /= 20,
            l = this.that.round(l, .5),
            this.lastPinchDist || (this.lastPinchDist = l,
            this.lastLargePinchDist = m),
            this.pinchMoveInit || (this.lastX3 = j,
            this.lastY3 = k,
            this.lastXY = j + k,
            this.pinchMoveInit = !0);
            var n = 15;
            if ((j > this.lastX3 + n || j < this.lastX3 - n) && !this.forceZooming || (k > this.lastY3 + n || k < this.lastY3 - n) && !this.forceZooming || this.forcePanning && !this.forceZooming)
                return void (!this.forcePanning && this.forceZooming || "Hand" == this.that.tool || !this.that.app.fingerToDraw || (this.forcePanning = !0,
                this.that.ToolController.tools.HandTool.active(!0, j, k, !0),
                this.that.render()));
            if ((m > this.lastLargePinchDist + 18 || m < this.lastLargePinchDist - 18) && (this.forceZooming = !0),
            this.lastPinchDist == l || !this.forceZooming)
                return;
            this.that.ZoomController.zoom < 1 && (d = .1),
            this.that.ZoomController.zoom > 5 && (d = .75),
            this.that.ZoomController.zoom > 10 && (d = 1),
            this.that.ZoomController.zoom > 20 && (d = 1.25),
            this.lastPinchDist > l ? (this.that.ZoomController.zoom -= d,
            e = "out",
            this.that.ZoomController.zoom >= this.that.grid.max_size && (this.that.ZoomController.zoom = this.that.round(this.that.ZoomController.zoom, 1, "down")),
            this.that.ZoomController.zoomingOut = !0,
            this.pinchInit || (this.pinchInit = !0,
            this.that.isApp || (this.pinchStartX = this.that.ZoomController.last_x,
            this.pinchStartY = this.that.ZoomController.last_y))) : (this.that.ZoomController.zoomingOut = !1,
            this.that.ZoomController.zoom += d,
            this.that.ZoomController.zoom >= this.that.grid.max_size && (this.that.ZoomController.zoom = this.that.round(this.that.ZoomController.zoom, 1, "up"))),
            this.lastPinchDist = l,
            "in" == e && (this.pinchInit = !0,
            this.that.ZoomController.last_x = this.pinchStartX,
            this.that.ZoomController.last_y = this.pinchStartY),
            this.that.ZoomController.zoomRange(this.that.ZoomController.zoom, this.that.ZoomController.last_x, this.that.ZoomController.last_y)
        }
    }
    ,
    ...
    H.prototype.pinchEnd = function() {
        this.forceZooming = !1,
        this.forcePanning = !1,
        this.isPinching && (this.pinchMoveInit = !1,
        this.lastPinchDist = 0,
        this.isPinching = !1)
    }
    ,
    H.prototype.doRemoveTips = function() {
        this.that.removeTips(),
        this.removeTips = !0
    }
    ,
    H.prototype.endDrawButtonApp = function() {
        a("#app-draw-down").removeClass("set"),
        this.app_button_down = !1,
        this.app_touch_index = 0
    }
    ,
    H.prototype.listeners = function() {
        var b = this
          , c = "#canvas-layers-appened";
        this.that.isMobileDevice && (this.scrollBarBuffer = 0),
        this.that.isApp || (this.desktopListeners("#drawing-canvas-conatiner"),
        this.mobileListeners("#drawing-canvas-conatiner"),
        a(document).dblclick(function() {
            b.doubleClick()
        })),
        this.that.isApp && this.appListeners(c),
    ...
    H.prototype.doubleTap = function(a) {
        if (this.that.isApp && ["Select"].indexOf(this.that.tool) == -1 && !this.that.app.fingerToDraw) {
            ...
            this.doubleTapSet++,
            (this.doubleTapSet >= 2 || a) && (this.active = !0,
            this.doubleTapActive = !0,
            this.doubleTapSet = 0,
    ...
    H.prototype.changePixelSize = function(b) {
        ...
        c > 24 && (c = 24),
        c <= 1 && (c = 1),
        this.that.isOdd(c) && 1 !== c && (c += 1,
        a("#right-sidebar .pixel-range-size, #pixel-size-adjust .pixel-range-size").val(c)),
        this.that.pixelPerfect.status && c > 1,
        a("#right-sidebar .pixel-size-drawing, #pixel-size-adjust .pixel-size-drawing").text(c),
        this.that.pixelDrawingSize = c
    }
    ,
    H.prototype.getPixelSizeImage = function() {
        ...
        this.roundImageMouse = !1,
        this.roundImageMouseData = !1,
        this.that.pixelDrawingSize > 1 && this.that.generateCircle("data", this.that.pixelDrawingSize, "#000000", function(b, c) {
            a.roundImageMouse = b,
            a.roundImageMouseData = c,
            a.roundImage = a.that.generateCircle("data", a.that.pixelDrawingSize)
        })
    }
    ,
    ...
    H.prototype.setClickMobile = function(a) {
        ...
        b.length && (this.x1 = b[0],
        this.y1 = b[1])
    }
    ,
    H.prototype.move = function(a) {
        return this.position(a),
        this.that.loading || this.that.isApp && !this.that.app.ready ? void (this.active = !1) : void (this.checkPosition() && (this.lcx = this.x_1,
        this.lcy = this.y_1,
        this.mouseMoveX = this.x_1,
        this.mouseMoveY = this.y_1,
        this.init(),
        this.renderMouse = !0,
        this.render(a)))
    }
    ...
    H.prototype.checkPosition = function() {
        if ("Brush" == this.that.tool && this.that.ToolController.tool.options && 0 !== this.that.ToolController.tool.options.spacing.value) {
            ...
            if (this.lcx - a < this.x_1 && this.x_1 < this.lcx + a && this.lcy - a < this.y_1 && this.y_1 < this.lcy + a && this.active && "Brush" == this.that.tool)
                return !1
        } else if ("Filter" == this.that.tool && this.active) {
            var b = 1;
            if (this.x_1 > this.lcx - b && this.x_1 < this.lcx + b && this.y_1 > this.lcy - b && this.y_1 < this.lcy + b)
                return !1
        } else if (this.lcx === this.x_1 && this.lcy === this.y_1 && this.active && ["Hand"].indexOf(this.that.tool) == -1)
            return !1;
        return !0
    }
    ,
    ...
    H.prototype.finish = function(a) {
        var b = this
          , c = !1;
        return this.ignoreFinish && (this.ignoreFinish = !1),
        this.toolsUp(),
        this.that.SelectController.active ? this.that.SelectController.setPoint() : (this.pinchEnd(),
        this.touchEndMove(),
        this.setLastClicks(),
        this.activeDrawing = !1,
        this.isPanning = !1,
        ...
        this.pinchInit = !1,
        this.lastPinchDist = 0,
        this.active && (this.that.loading = !0,
        c = !0),
        this.app_update_frame && (c = !0),
        this.middleClickDown && this.resetHandTemp(),
        this.up = !1,
        this.that.isApp && this.that.app.fingerToDraw || (this.active = !1),
        void (c && (this.createHistoryTimeout = !1,
        this.createHistoryTimeout = this.createHistory && (this.that.width > 700 || this.that.height > 700),
        this.that.LayerController.updateLayer(!1, function(a) {
            b.defaultItems(a)
        }, !0, this.createHistoryTimeout))))
    }
    ,
    H.prototype.defaultItems = function(a) {
        return this.createHistory && a && this.createHistoryTimeout ? this.mouseEnd() : (this.that.ColorController.restoreSetColor(),
        this.that.ToolController.off(),
        this.that.ToolController.createHistory = !0,
        this.start_x = !1,
        this.start_y = !1,
        this.appX = !1,
        this.appY = !1,
        this.rightClick = !1,
        (this.that.isTouch || this.that.isMobile) && (this.lcx = !1,
        this.lcy = !1),
        ["Line", "Square", "Circle"].indexOf(this.that.tool) !== -1 && !this.that.isApp,
        this.that.isApp && (this.x_0 = -9999,
        this.y_0 = -9999,
        this.that.app.fingerToDraw || (this.x_0 = this.x_1,
        this.y_0 = this.y_1)),
        this.createHistory && !this.createHistoryTimeout && this.mouseEnd(),
        this.that.loading = !1,
        ["Pencil"].indexOf(this.that.tool) !== -1 && this.that.ToolController.use(),
        void this.that.mouseEnded())
    }
    ,
    H.prototype.removeMobile = function() {
        this.that.isMobile && !this.removedMobile && (this.removedMobile = !0,
        a(".ui-tooltip").remove(),
        a("#left-sidebar").removeClass("active"),
        a("#right-sidebar").removeClass("active"))
    }
    ,
    H.prototype.checkPreConditions = function() {
        ...
        return this.that.online.status && this.that.LayerController.layers[a].name != this.that.online.layer_id ? (this.that.showAlert(this.that.messages("online_layer")),
        !0) : !(!this.that.LayerController.layers[a].options.locked || ["ColorPicker"].indexOf(this.that.tool) != -1) && (this.that.showAlert(this.that.messages("layer_locked")),
        !0)
    }
    ,
    H.prototype.down = function(a) {
        if (this.that.online.send = !0,
        clearTimeout(this.that.LayerController.updateLayerTime),
        !(this.that.loading || this.that.isApp && !this.that.app.ready || (this.that.isApp || this.removeMobile(),
        this.that.SelectController.active))) {
            switch (this.createHistory = !0,
            a.which) {
            case 3:
            ...
            this.that.isApp || (this.active = !0),
            this.that.mouseEvent = a,
            this.setCloseHook(),
            this.setFirstClicks(this.x_1, this.y_1),
            this.that.clickCount = !0,
            this.init(),
            this.render(a)
        }
    }
    ...
    H.prototype.setFirstClicks = function(a, b) {
        return a || b ? (this.start_x = a,
        void (this.start_y = b)) : (this.start_x = null != this.lx ? this.lx : this.x_1,
        void (this.start_y = null != this.ly ? this.ly : this.y_1))
    }
    ,
    H.prototype.setLastClicks = function() {
        return this.that.isApp && this.that.app.fingerToDraw ? void (this.ignoreLastclicks = !1) : (this.active && (this.last_x = this.lx,
        this.last_y = this.ly,
        "Hand" == this.that.tool || this.that.isApp || (this.that.ZoomController.last_x = this.last_x,
        this.that.ZoomController.last_y = this.last_y)),
        this.that.isApp && ("Hand" != this.that.tool && !this.ignoreLastclicks,
        this.app_x_last = this.lx,
        this.app_y_last = this.ly,
        this.last_ex = !1,
        this.last_ey = !1),
        void (this.ignoreLastclicks = !1))
    }
    ,
    ...
    ,
    H.prototype.checkSamePosition = function(a) {}
    ,
    H.prototype.exactPos = function() {
    ...
    H.prototype.position = function(a, b) {
        if (this.that.finished && !this.prevent) {
            ...
            if (this.mousePageX = a.pageX,
            this.mousePageY = a.pageY,
            this.that.isApp) {
            ...
            var j = Math.floor(e / (g * d))
              , k = Math.floor(f / (g * d));
            this.appX || (this.appX = j,
            this.appY = k);
            var l = this.appX - j
              , m = this.appY - k;
            if (this.xx = j,
            this.yy = k,
            !this.that.isApp || this.that.isApp && this.that.app.fingerToDraw ? (this.x_1 = Math.floor(e / (g * d)),
            this.y_1 = Math.floor(f / (g * d))) : (this.x_1 = this.app_x_last - l,
            this.y_1 = this.app_y_last - m,
            this.x_1 <= 0 && (this.x_1 = 0),
            this.y_1 <= 0 && (this.y_1 = 0),
            this.x_1 >= this.that.width - 1 && (this.x_1 = this.that.width - 1),
            this.y_1 >= this.that.height - 1 && (this.y_1 = this.that.height - 1)),
            b)
                return [this.x_1, this.y_1];
            this.x_0 = null == this.x1 ? this.x_1 : this.x1,
            this.y_0 = null == this.y1 ? this.y_1 : this.y1,
            (["Line", "Square", "Circle"].indexOf(this.that.tool) !== -1 && this.active || "Select" == this.that.tool && this.active && this.that.ToolController.tools.SelectTool && this.that.ToolController.tools.SelectTool.options.poly.value) && (this.x_0 = this.start_x,
            this.y_0 = this.start_y,
            "Line" == this.that.tool && this.that.settings.isoLines && this.doISOSetup()),
            "Line" != this.that.tool;
            var n = this.x_1
              , o = this.y_1;
            return this.that.isWindowsIE || (this.mouseXEl.text(n + 1),
            this.mouseYEl.text(o + 1),
            this.mouseXE2.text(n + 1),
            this.mouseYE2.text(o + 1)),
            this.x0 = this.x_0,
            this.y0 = this.y_0,
            this.active || this.that.isMobile || this.that.isTablet || (this.x_0 = this.x_1,
            this.y_0 = this.y_1),
            this.dx = Math.abs(this.x_1 - this.x_0),
            this.dy = Math.abs(this.y_1 - this.y_0),
            this.sx = this.x_0 < this.x_1 ? 1 : -1,
            this.sy = this.y_0 < this.y_1 ? 1 : -1,
            this.err = this.dx - this.dy,
            this.x1 = this.x_1,
            this.y1 = this.y_1,
            this.last_abs_pos = this.absPosition(),
    ...
    H.prototype.doISOSetup = function() {
        ...
        d = d < 0 ? 0 : d,
        d = Math.floor(d),
        a > b ? this.start_y < this.y_1 ? this.y_1 = this.start_y + d : this.y_1 = this.start_y - d : this.start_x < this.x_1 ? this.x_1 = this.start_x + d : this.x_1 = this.start_x - d
    }
    ,
    H.prototype.absPosition = function(a, b) {
        return a = a ? a : this.x_0,
        b = b ? b : this.y_0,
        this.that.width * b + a + 1
    }
    ,
    H.prototype.cordsFromPosition = function(a) {
        var b = 1
          ...
          , g = f.split(".")
          , h = d.substr(-1);
        return 1 == g.length ? (b = this.that.width,
        c = g[0]) : (c = parseInt(g[0]) + 1,
        b = "0" == h ? g[1] + "0" : Math.abs(g[1])),
        [b, c]
    }
    ,
    H.prototype.drawingPosition = function(a) {}
    ,
    H.prototype.render = function(a, b, c) {
        ...
        if (a = c ? a : d.x,
        b = c ? b : d.y,
        this.that.isApp && this.pixelTrace && !this.that.app.fingerToDraw) {
        ...
        if (!(this.active && !this.that.isApp || !this.renderMouse && !this.that.isApp || !this["in"] && !this.active || this.that.isMobile && !this.that.isApp || this.that.isApp && this.that.app.fingerToDraw))
            if ("Brush" == this.that.tool && this.that.settings.brush.image) {
                ...
                this.that.canvas.display.ctx.globalAlpha = .5,
                this.that.canvas.display.ctx.filter = "invert(1)",
                this.that.canvas.display.putSimple(this.that.settings.brush.mouse, k, l),
                this.that.canvas.display.ctx.filter = "none",
                this.that.canvas.display.ctx.globalAlpha = 1
            } else
                this.that.ToolController.tool.brushImage ? (a = this.x1 - this.that.ToolController.tool.options.size.value,
                b = this.y1 - this.that.ToolController.tool.options.size.value,
                this.that.canvas.display.ctx.globalAlpha = .3,
                this.that.canvas.display.putSimple(this.that.ToolController.tool.brushImage, a, b),
                this.that.canvas.display.ctx.globalAlpha = .15,
                this.that.canvas.display.ctx.filter = "invert(1)",
                this.that.canvas.display.putSimple(this.that.ToolController.tool.brushImage, a, b),
                this.that.canvas.display.ctx.filter = "none",
                this.that.canvas.display.ctx.globalAlpha = 1) : this.that.settings.roundedPixel && this.roundImage && ["Pencil", "Line", "Square", "Circle", "Eraser"].indexOf(this.that.tool) > -1 ? (this.that.canvas.display.ctx.globalAlpha = .3,
                this.that.canvas.display.putSimple(this.roundImageMouse, a, b),
                this.that.canvas.display.ctx.globalAlpha = .15,
                this.that.canvas.display.ctx.filter = "invert(1)",
                this.that.canvas.display.putSimple(this.roundImageMouse, a, b),
                this.that.canvas.display.ctx.filter = "none",
                this.that.canvas.display.ctx.globalAlpha = 1) : (this.that.canvas.display.ctx.fillStyle = "rgba(255,255,255,0.3)",
                this.that.canvas.display.ctx.fillRect(a, b, e, e),
                this.that.canvas.display.ctx.fillStyle = "rgba(0,0,0,0.3)",
                this.that.canvas.display.ctx.fillRect(a, b, e, e))
    }
    ,
    ...
    var I = function(a) {
        this.currentLayer = 0,
        this.that = a,
        this.frame = a.FrameController.frames[0],
        this.layers = this.frame.layers,
        this.beforeHistory = {},
        this.layerFocus = !1,
        this.initLoaded = !1,
        this.blankImage = !1,
        this.updateLayerTime = !1,
        this.opacityChanging = !1,
        this.html = "",
        this.currentFilterValue = 0,
    ...
    I.prototype.selectFrame = function(b) {
        if (this.frame = b,
        this.layers = this.frame.layers,
        this.that.settings.persLayers || (this.currentLayer = this.frame.selectedLayer),
        "object" == typeof this.layers) {
            var c = [];
    ...
    I.prototype.addLayer = function(a, b, d, e, f) {
        ...
        e = e ? e : 1,
        a = a ? a : new c(this.layers.length,b),
        this.layers = this.that.FrameController.frames[g].layers,
        b && a.init(),
        d ? a.src = d : this.initLoaded && (a.src = this.blankLayer()),
        a.opacity = e,
        f && (a.details = f),
        this.layers.push(a),
        this.updateOpacityElement(a),
        this.updateList()
    }
    ,
    ...
    I.prototype.limitCheck = function() {
        return this.layers.length >= this.that.maxLayers && (alert("Max layers exceeded."),
        !0)
    }
    ,
    I.prototype.promptAddlayer = function() {
        var b = this;
        if (this.that.ToolController && this.that.ToolController.renderChange)
            return this.that.ToolController.checkRenderNeeded(function() {
                b.promptAddlayer()
            });
        ...
        a("#layers-container .layer-list").removeClass("active"),
        a("#layer-" + this.currentLayer).parent().addClass("active");
        var e = this.that.canvas.layer;
        e.clear(),
        this.move(parseInt(this.layers.length) - 1, parseInt(d) + 1),
        this.that.layersNewAllFrames(this.layers[this.currentLayer], parseInt(this.layers.length) - 1, parseInt(d) + 1),
        this.makeHistory("Layer", "Add", "Undo")
    }
    ,
    I.prototype.promptRenameLayer = function(a) {
        ...
        d && (c.name = d,
        this.that.layersRenameAllFrames(b, d),
        this.updateList(),
        this.makeHistory("Layer", "Rename", "Undo"))
    }
    ,
    I.prototype.listeners = function() {
        var b = this;
        document.getElementById("layers-container") || (this.container = a('<div id="layer_container" class="panel"><div class="append-layers"></div><a href="#" id="add-layer">Add Layer</a></div>'),
        a(".drawing-wrapper").append(this.container)),
        a(document).on("mouseup", function(a) {
        ...
        a("#layer-focus").click(function() {
            this.layerFocus ? this.layerFocus = !1 : this.layerFocus = !0,
            b.select()
        });
        var c = 0
          , d = !1
          , e = 125;
        (this.that.isMobile || this.that.isTablet || this.that.isTouch) && (d = ".layer-preview",
        e = 75),
        this.that.isApp && (d = ".layer-move"),
        a("#layers-container").sortable({
            scrollSpeed: 3,
            delay: e,
            axis: "y",
            handle: d,
        ...
        a("#right-sidebar, #layer-dropdown").on("click", ".layer-outline", function(c) {
            c.preventDefault(),
            b.outlineLayer(a(this).attr("data-id"))
        }),
        ...
        this.that.isApp && (f = "click"),
        a("#layers-panel").on(f, ".layer-select", function() {
            b.select(a(this))
        }),
    ...
    I.prototype.changeLayerOption = function(b, c, d, e) {
        ...
        if (this.layers[this.currentLayer].options.locked)
            return this.that.showAlert(this.that.messages("layer_locked_alter")),
            !0;
        switch (h) {
        case "percent":
            f += "%";
        ...
        this.currentFilterValue || (this.currentFilterValue = f,
        this.currentFilter = g),
        this.that.filter.imageData || this.that.filter.status || (this.that.filter.imageData = this.that.canvas.layer.ctx.getImageData(0, 0, this.that.width, this.that.height),
        this.that.filter.newImageData = this.that.canvas.layer.ctx.getImageData(0, 0, this.that.width, this.that.height)),
        this.that.isApp || a("#" + g + "-update").text(f),
        this.that.filter.status ? this.layers[this.currentLayer].options.filter[g] = f : (this.that["filter" + i]("layer", f),
        this.that.canvas.layer.ctx.putImageData(this.that.filter.newImageData, 0, 0)),
        this.that.render()
    }
    ,
    I.prototype.changeingOptionEnd = function(b) {
        var c = this.layers[this.currentLayer];
        this.that.filter.status || (this.that.isApp ? (c.createFilters(),
        this.that.app.store.commit("app/setFilterByPayload", {
            name: this.currentFilter,
            val: c.options.filter[this.currentFilter]
        }),
        this.that.app.store.dispatch("app/loadFilters")) : (a("#" + this.currentFilter + "-update").text(a("#" + this.currentFilter + "-range").attr("data-default")),
        a("#" + this.currentFilter + "-range").val(a("#" + this.currentFilter + "-range").attr("data-default"))),
        this.currentFilterValue = !1,
        this.currentFilter = !1),
        this.that.filter.imageData = !1,
        this.updateLayer(),
        this.that.render(),
        this.that.FrameController.updateFramePreview(),
        this.that.OnlineController.writeLayer(),
        this.that.ToolController.restore(),
        this.that.ToolController.use(),
        this.makeHistory("Layer", "Layer Style", "Undo")
    }
    ,
    I.prototype.setLayerOptions = function(b) {
        var c = this.layers[this.currentLayer];
        if (this.that.isApp)
            return c.options.filter || c.createFilters(),
            this.that.app.store.commit("app/setFilters", c.options.filter),
            void this.that.app.store.dispatch("app/loadFilters");
        if (this.that.filter.status) {
            c.options.filter || c.createFilters();
            for (var d in c.options.filter)
                a("#" + d + "-update").text(c.options.filter[d]),
                a("#" + d + "-range").val(parseFloat(c.options.filter[d]))
        }
    }
    ,
    I.prototype.setSibebarLayer = function(b) {
        ...
        var c = this.layers[b];
        a("#layer-blend-options").val(c.options.blend),
        this.checkClippingMask(c)
    }
    ,
    I.prototype.toggleClippingMask = function(b) {
        b = b ? b : this.currentLayer;
        var c = this.layers[b];
        "source-atop" == c.options.blend ? a("#layer-blend-options").val("source-over") : a("#layer-blend-options").val("source-atop"),
        this.updateBlend()
    }
    ,
    I.prototype.checkClippingMask = function(b) {
        a("#clipping-mask").prop("checked", !1),
        "source-atop" == b.options.blend && a("#clipping-mask").prop("checked", !0)
    }
    ,
    I.prototype.updateBlend = function(b) {
        if (this.checkPreConditions(b))
            return void a("#layer-blend-options").val("source-over");
        b = b ? b : this.currentLayer;
        var c = this.layers[b];
        c.options.blend = a("#layer-blend-options").val(),
        this.checkClippingMask(c),
        this.updateList(),
        this.that.render(),
        this.that.FrameController.updateFramePreview(),
        this.that.OnlineController.writeLayer(),
        this.makeHistory("Layer", "Layer Name", "Undo")
    }
    ,
    I.prototype.doMerge = function(a) {
        "up" == a ? this.move(this.currentLayer, parseInt(this.currentLayer) + 1, !0) : this.move(this.currentLayer, parseInt(this.currentLayer) - 1, !0),
        this.updateMove()
    }
    ,
    I.prototype.updateMove = function() {
        this.that.FrameController.frame().layers = this.layers,
        this.makeHistory("Layer", "Move", "Undo")
    }
    ,
    I.prototype.flipLayer = function(a) {
        ...
        this.that.ToolController.restore(),
        this.that.flip(a, c, this.that.canvas.layer, function() {
            b.updateLayer(),
            b.that.render(),
            b.that.FrameController.updateFramePreview(),
            b.that.OnlineController.writeLayer(),
            setTimeout(function() {
                b.that.ToolController.restore()
            }, 50),
            b.makeHistory("Layer", "Flip", "Undo")
        })
    }
    ,
    I.prototype.outlineLayer = function(a, b) {
        ...
        if (this.that.isApp && (d = this.currentLayer),
        !this.checkPreConditions()) {
            if (!b)
                return this.that.OutlineController.open(a);
            var e = this.layers[d];
            return this.that.ToolController.restore(),
            this.that.render(),
            this.that.outline(e, "rendering", function() {
                c.updateLayer(),
                c.that.render(),
                c.that.FrameController.updateFramePreview(),
                c.that.OnlineController.writeLayer(),
                c.makeHistory("Layer", "Outline", "Undo")
            })
        }
    }
    ,
    I.prototype.cloneToAllFrames = function() {
        ...
        this.that.layerCloneToAllFrames(this.currentLayer, this.layers[this.currentLayer], function() {
            a.updateLayer(),
            a.that.render(),
            a.makeHistory("Layer", "Layer Clone Frames", "Undo")
        })
    }
    ,
    I.prototype.alterPixels = function(a, b) {
        if (!this.checkPreConditions(b)) {
            ...
            this.that.ToolController.restore(),
            this.that.canvas.rendering["default"](),
            this.that.canvas.rendering.putSimple(c.src);
            for (var d = this.that.canvas.rendering.ctx.getImageData(0, 0, this.that.width, this.that.height), e = this.that.hexToRgb(this.that.getDrawingcolor()), f = 0; f < d.data.length; f += 4)
                0 != d.data[f + 3] && ("fill" == a && (d.data[f] = e.r,
                d.data[f + 1] = e.g,
                d.data[f + 2] = e.b),
                "invert" == a && (d.data[f] = 255 - d.data[f],
                d.data[f + 1] = 255 - d.data[f + 1],
                d.data[f + 2] = 255 - d.data[f + 2]));
            this.that.canvas.layer["default"](),
            this.that.canvas.layer.ctx.putImageData(d, 0, 0),
            this.updateLayer(),
            this.that.render(),
            this.that.online.status && this.that.OnlineController.writeLayer(),
            this.that.FrameController.updateFramePreview(),
    ...
    I.prototype.checkPreConditions = function(a) {
        return a = a ? a : this.currentLayer,
        !!this.layers[a].options.locked && (this.that.showAlert(this.that.messages("layer_locked_alter")),
        !0)
    }
    ,
    I.prototype.deleteLayer = function(b, c, d, e) {
        if (d = d ? d : this.currentLayer,
        this.layers[d].options.locked)
            return void this.that.showAlert(this.that.messages("layer_locked_delete"));
        var f = this.layers[d];
        if (1 != this.layers.length) {
            ...
            a("#layer-" + d).remove();
            var h = this;
            this.that.layersDeleteAllFrames(f.id),
            setTimeout(function() {
                h.updateList(),
                h.that.render(),
                h.makeHistory("Layer", "Delete", "Redo"),
                h.that.ToolController.restore(),
                h.that.updateData()
            }, 1)
        }
    }
    ...
    I.prototype.del = function(a) {
        var b = this.layers[a];
        "object" == typeof b && (this.frame.layers.splice(a, 1),
        this.layers = this.frame.layers)
    }
    ,
    I.prototype.mergeLayer = function(a, b, d, e, f) {
        ...
        var i = h[b]
          ...
          , l = i.id;
        k.canvas.height = this.that.canvas.layer.canvas.height,
        k.canvas.width = this.that.canvas.layer.canvas.width,
        j = "down" == a ? h[parseInt(b) - 1] : h[parseInt(b) + 1],
        "object" == typeof j && ("down" == a ? (k.ctx.filter = this.that.layerOptionsFilter(j),
        k.ctx.globalCompositeOperation = j.options.blend,
        k.putImageData(j.src, j.opacity),
        k.ctx.filter = this.that.layerOptionsFilter(i),
        k.ctx.globalCompositeOperation = i.options.blend,
        k.putImageData(i.src, i.opacity),
        l = parseInt(this.currentLayer) - 1) : (k.ctx.filter = this.that.layerOptionsFilter(i),
        k.ctx.globalCompositeOperation = i.options.blend,
        k.putImageData(i.src, i.opacity),
        k.ctx.filter = this.that.layerOptionsFilter(j),
        k.ctx.globalCompositeOperation = j.options.blend,
        k.putImageData(j.src, j.opacity)),
        k.ctx.filter = "none",
        ...
        k.image().onload = function() {
            ...
            return k.src = this,
            f ? f(k, d) : (g.currentLayer = l,
            void (e || (g.del(j.id),
            g.del(l),
            g.that.layersMergeAllFrames(a, b + 0, j.id, l, parseInt(h.length) - 1, parseInt(g.currentLayer), function() {
                g.layers.push(k),
                g.move(parseInt(g.layers.length) - 1, parseInt(g.currentLayer)),
                g.updateList(),
                g.select(),
                g.that.FrameController.frame().layers = g.layers,
                g.makeHistory("Layer", "Merge", "Undo"),
                g.that.loading = !1,
                g.that.updateData()
            }))))
        }
    ...
    I.prototype.opacityLayer = function(b) {
        ...
        if (this.checkPreConditions())
            return a("#opacity-layer").val(c.opacity),
            void a("#opacity-layer-number").text(Math.floor(100 * c.opacity) + "%");
        this.opacityChanging || (this.opacityChanging = c.opacity);
        var d = b.val();
        c.opacity = d,
        a("#opacity-layer-number").text(Math.floor(100 * c.opacity) + "%"),
    ...
    I.prototype.promptLayerOpacity = function() {
        ...
        if (null != c && (c = parseInt(c),
        c <= 100 && c >= 0)) {
            var d = c / 100;
            b.opacity = d,
            a("#opacity-layer-number").text(Math.floor(100 * b.opacity) + "%"),
            a("#opacity-layer").val(d),
            this.that.updateDisplayCanvas(this.layers, this.currentLayer),
            this.that.FrameController.updateFramePreview(),
            this.updateLayer(),
            this.that.render(),
            this.opacityLayerUpdate()
        }
    }
    ,
    I.prototype.opacityLayerUpdate = function() {
        var a = this.layers[this.currentLayer];
        this.opacityChanging && this.opacityChanging != a.opacity && this.makeHistory("Layer", "Layer Opacity", "Undo"),
        this.opacityChanging = !1,
        this.that.online.status && this.that.OnlineController.writeLayer()
    }
    ,
    I.prototype.updateOpacityElement = function(b) {
        return "object" != typeof b ? (alert(this.that.getResponse("res-layer-error")),
        this.that.ExportImportController["export"]()) : (a("#opacity-layer").val(b.opacity),
        void a("#opacity-layer-number").text(Math.floor(100 * b.opacity) + "%"))
    }
    ,
    ...
    I.prototype.template = function(a, b) {
        ...
        this.that.isApp && (e = '<div class="layer-icon pr-1" title="Clipping Mask"><i class="ft ft-icon-corner-left-down"></i></div>')),
        this.that.isApp && (f = '<div class="layer-move"><div class="layer-move-icon"><i class="ft ft-icon-maximize-2"></i></div></div>'),
        d = '<div id="layer-preview-' + a + '" class="layer-preview layer-select preview-layer-' + a + '" data-id="' + a + '" style="background-image:url(' + b.src.src + ');"></div>',
        '<div title="Layer Status" id="layer-' + a + '" class="layer-list ' + i() + " " + g() + " " + j() + " layer-" + a + " " + this.layerActiveTemplate(a) + '" data-id="' + a + '">' + f + '<div class="layer-viewable" title="Visible" data-id="' + a + '">' + this.iconActive(b.active) + "</div>" + e + d + '<div class="layer-name layer-select layer-' + a + '" title="' + b.name + '" data-id="' + a + '">' + h() + b.name + '</div><div class="layer-inline-item layer-lock layer-' + a + '" title="Lock/Unlock Layer" data-id="' + a + '">' + this.iconLock(b.options.locked) + '</div><div class="layer-outline layer-' + a + '" title="Outline Layer" data-id="' + a + '"><i class="fa fa-square-o" aria-hidden="true"></i></div></div>'
    }
    ,
    I.prototype.layerLock = function(a) {
        var b = (a.parent().attr("data-id"),
        this.layers[a.parent().attr("data-id")]);
        b.options.locked = !b.options.locked,
        this.updateList(),
        this.makeHistory("Layer", "Layer Lock", "Undo"),
        this.that.updateData()
    }
    ,
    I.prototype.layerVisability = function(a) {
        ...
        this.layers[a.parent().attr("data-id")]);
        b.active ? (b.active = !1,
        a.html(this.iconActive(b.active))) : (b.active = !0,
        a.html(this.iconActive(b.active))),
        this.that.updateDisplayCanvas(this.layers, this.currentLayer),
        this.that.FrameController.updateFramePreview(),
        this.that.render(),
        this.that.updateData(),
        this.makeHistory("Layer", "Layer Visability", "Undo")
    }
    ,
    ...
    I.prototype.select = function(a, b, c) {
        if (this.that.ToolController.restore(),
        b || 0 === b) {
            if (b < 0 || !this.layers[b] || b > this.layers.length - 1)
                return;
            this.currentLayer = b
        }
        a && (this.currentLayer = a.parent().attr("data-id")),
    ...
    I.prototype.selectLayer = function(b) {
        if (b = parseInt(b),
        !(b < 0 || !this.layers[b] || b > this.layers.length - 1)) {
            b = b ? b : this.currentLayer,
            this.that.isApp;
            var c = this.layers[b];
            this.currentLayer = b,
            this.frame.selectedLayer = this.currentLayer,
            this.updateOpacityElement(c),
            this.updateLayerCanvas(c.src),
            this.setSibebarLayer(),
            this.that.updateDisplayCanvas(this.layers, this.currentLayer),
            this.that.render(),
            this.setLayerOptions(),
            a("#layers-container .layer-list").removeClass("active"),
            a("#layer-" + this.currentLayer).addClass("active")
        }
    }
    ,
    ...
    I.prototype.updateList = function() {
        ...
        c.html(""),
        a.each(this.layers, function(a, d) {
            b.layers[a].id = a,
            c.prepend(b.template(a, d))
        }),
        this.that.updateDisplayCanvas(this.layers, this.currentLayer),
        a("#layer-count").text(this.layers.length)
    }
    ,
    I.prototype.updateCurrentLayerSrc = function(b) {
        var c = this;
        b = b ? b : c.currentLayer,
        setTimeout(function() {
    ...
    I.prototype.render = function() {
        ...
        this.that.canvas.display,
        this.that.canvas.display.canvas.width,
        this.that.canvas.display.canvas.height,
        this.layers[this.currentLayer])
          , b = this;
        "undefined" != typeof a && null != a && (a.active && (this.that.canvas.display.ctx.filter = this.that.layerOptionsFilter(a),
        "source-atop" == a.options.blend && this.layers[this.currentLayer - 1] ? this.that.clipRender(a, this.layers[this.currentLayer - 1], function(a) {
            b.that.canvas.display.putImageData(a, 1, b.that.zoom)
        }, this.that.canvas.layer.canvas) : (this.that.canvas.display.ctx.globalCompositeOperation = a.options.blend,
        this.that.canvas.display.putImageData(this.that.canvas.layer.canvas, a.opacity, this.that.zoom, a)),
        this.that.canvas.display.ctx.filter = "none",
        this.that.canvas.display.ctx.globalCompositeOperation = "source-over"),
        this.that.updateTileCanvases())
    }
    ,
    ...
    I.prototype.blankLayer = function() {
        ...
        a["default"]();
        var b = new Image;
        return b.src = a.canvas.toDataURL("image/png"),
        b
    }
    ,
    I.prototype.updateLayer = function(a, b, c, d) {
        ...
        if (d)
            return clearTimeout(this.updateLayerTime),
            this.updateLayerTime = setTimeout(function() {
                e.updateLayer(a, b, c)
            }, 300),
            void b();
        var h = g.canvas.toDataURL("image/png");
        this.that.loadImage(h, function(d) {
            return "undefined" == typeof f || null == f ? (e.currentLayer = 0,
            e.updateList(),
            e.select(),
            console.info("The app has ran into an error. Enable AutoSave or Save locally and re-open to save data.")) : (e.updateLayerPreview(f, h),
            a ? d : (f.src = d,
            c && e.that.FrameController.updateFramePreview(),
            b ? b(d) : void 0))
        })
    }
    ,
    I.prototype.move = function(a, b, c) {
        b >= this.layers.length || b < 0 || (this.layers.splice(b, 0, this.layers.splice(a, 1)[0]),
        this.currentLayer = b,
        this.updateList(),
        this.select(),
        this.scrollTo(),
        c && this.that.layersMoveAllFrames(b, a))
    }
    ,
    I.prototype["import"] = function(a) {
        ...
        this.layers.push(e),
        this.move(parseInt(this.layers.length) - 1, parseInt(d.id) + 1),
        this.updateList(),
        this.select(),
        this.that.settings.persLayers = !1,
        this.that.FrameController.frame().layers = this.layers,
        this.makeHistory("Layer", "Imported Layer", "Undo")
    }
    ,
    I.prototype.duplicate = function() {
        ...
        if (!this.limitCheck()) {
            ...
            this.that.loadImage(e.src, function(c) {
                e.src = c,
                a.layers.push(e),
                a.that.layerDuplicateAllFrames(e, parseInt(a.layers.length) - 1, parseInt(b.id) + 1, function() {
                    a.move(parseInt(a.layers.length) - 1, parseInt(b.id) + 1),
                    a.updateList(),
                    a.select(),
                    a.that.FrameController.frame().layers = a.layers,
                    a.makeHistory("Layer", "Add Duplicate", "Undo"),
                    a.that.updateData()
                })
            })
        }
    ...
    ,
    I.prototype.flatten = function(a, b, c, d, e) {
        var f = this
          , g = b ? this.that.previewSize : 1;
        c && (g = c);
        var h = this.that.width * g
          , i = this.that.height * g;
        this.that.canvas.data.canvas.width = h,
        this.that.canvas.data.canvas.height = i,
        this.that.canvas.data.setSmoothing(),
        this.that.canvas.data.clear();
        for (var j = a.length, k = 0, l = [], m = 0; m < j; m++) {
            var n = a[m]
              , o = n.src;
            if (n.active) {
                1 != n.opacity && this.that.canvas.data.setAlpha(n.opacity),
                "string" != typeof o && "" != o && o || (o = this.that.canvas.layer.image());
                var p = o.width * g
                  , q = o.height * g;
                this.that.canvas.data.ctx.filter = this.that.layerOptionsFilter(n, g),
                "source-atop" == n.options.blend && n.active && a[m - 1] && a[m - 1].active ? (this.that.canvas.data.setAlpha(1),
                n.src = o,
                this.that.clipRender(n, a[m - 1], function(a) {
                    f.that.canvas.data.putImageData(a, 1, f.that.zoom)
                })) : (this.that.canvas.data.ctx.globalCompositeOperation = n.options.blend,
                this.that.canvas.data.ctx.drawImage(o, 0, 0, p, q)),
                this.that.canvas.data.ctx.globalCompositeOperation = "source-over",
                this.that.canvas.data.ctx.filter = "none",
                this.that.canvas.data.restoreAlpha(),
                l.push(n)
            }
            if (k++,
            k == j) {
                var r = this.that.canvas.data.dataURL();
                return this.that.isApp || (this.that.canvas.extended && e && this.that.canvas.extended.ctx.drawImage(this.that.canvas.data.canvas, 0, 0),
                this.that.canvas.data["default"]()),
                d ? d(r) : r
            }
        }
    ...
    I.prototype.download = function(a, b) {
        ...
        this.that.canvas.rendering.clear(),
        this.that.canvas.rendering.canvas.width = e,
        this.that.canvas.rendering.canvas.height = f,
        this.that.canvas.rendering.ctx.mozImageSmoothingEnabled = !1,
        this.that.canvas.rendering.ctx.imageSmoothingEnabled = !1,
        this.that.canvas.rendering.ctx.drawImage(d.src, 0, 0, e, f),
        this.that.canvas.rendering.canvas.toBlob(function(a) {
            return c.that.canvas.rendering["default"](),
            b ? b(a) : void saveAs(a, "pixil-layer-" + d.name + ".png")
        })
    }
    ,
    ...
    var J = function(a) {
        this.currentFrame = 0,
        this.that = a,
        this.speeds = [25, 50, 75, 100, 125, 150, 200, 250, 300, 350, 400, 450, 500, 1e3, 2500, 5e3],
        this.frames = [],
        this.template = function(a) {
            var b = this.frames[a]
              , c = "";
            a == this.currentFrame && (c = "active");
            var d = "";
            return this.that.isApp && (d = '<div class="frame-move"><div class="frame-move-icon"><i class="ft ft-icon-maximize-2"></i></div></div>'),
    ...
    J.prototype.updateFrameCount = function() {
        this.frames.length > 1 ? a("#frame-count-wrapper").show(0) : a("#frame-count-wrapper").hide(),
        a("#frame-count").text(this.frames.length)
    }
    ,
    ...
    J.prototype.updateFramePreview = function(b, c) {
        ...
        "object" == typeof d && this.that.LayerController.flatten(d.layers, !0, 1, function(c) {
            a("#preview-img-" + b).attr("src", c),
            e.that.NavigationController.update(c),
            d.preview = c
        })
    }
    ,
    ...
    J.prototype.init = function(a) {
        a || this.listeners(),
        this.appendOptionsToAllFramesSpeed(),
        this["new"](!0)
    }
    ,
    ...
    J.prototype.listeners = function() {
        ...
        var d = 0
          , e = !1
          , f = 125;
        (this.that.isMobile || this.that.isTablet || this.that.isTouch) && (e = ".frame-tag",
        f = 75),
        this.that.isApp && (e = ".frame-move"),
        a("#frames-appended").sortable({
            scrollSpeed: 3,
            delay: f,
            axis: "x",
            handle: e,
            ...
            update: function(c, e) {
                ...
                a("#frames-appended .frame-select").each(function() {
                    var c = a(this).attr("data-id");
                    c == d && b.move(d, f, !1, !1, !0),
                    f++
                })
            }
        });
        var g = "click touchstart";
        this.that.isApp && (g = "click"),
        a("#frames-placement").on(g, ".select-frame", function() {
            var c = a(this).attr("data-id");
            b.select(c, !1, !0)
        }),
        ...
        a("#frames-placement").on("change", ".frame-speed", function() {
            ...
            c > parseInt(5e3) && (c = 5e3),
            c < parseInt(10) && (c = 10),
            b.speed(d, parseInt(c))
        }),
    ...
    J.prototype.select = function(b, c, d) {
        if (!(b < 0 || !this.frames[b] || b > this.frames.length - 1)) {
            ...
            this.frames[b];
            this.currentFrame = b,
            a("#frames-appended .frame-select").removeClass("active"),
            a("#frames-appended .frame-id-" + b).addClass("active"),
            c || (this.that.setOnionSkin(),
            this.that.showOnionSkin(!0)),
            this.updateCurrentFrame(),
            this.that.LayerController.selectFrame(this.frame()),
            this.that.LayerController.updateCurrentLayerSrc(),
            this.updateFramePreview(),
            this.updateFrameTiles()
        }
    }
    ,
    ...
    J.prototype.flip = function(a) {
        ...
        if (!this.that.online.status) {
            if (!this.that.canvas.extended)
                return this.that.createCanvas("extended", this.that.width, this.that.height, function() {
                    b.flip(a)
                });
            for (var d = 0, e = 0; e < c.length; e++) {
                ...
                g.onload = function() {
                    d++,
                    c[this.i].src = this,
                    d >= c.length && (b.updateFramePreview(),
                    b.select(b.currentFrame),
                    setTimeout(function() {
                        b.that.ToolController.restore()
                    }, 50),
                    b.that.LayerController.makeHistory("Frame", "Flip", "Undo"),
                    b.that.canvas.extended.destroy())
                }
                ,
                g.src = f
            }
    ...
    J.prototype["new"] = function(a, b, e, f, g) {
        ...
        !a || f) {
            ...
            e && (j.src = e),
            j.init(),
            this.frame().layers.push(j),
            this.move(this.frames.length - 1, h + 1, !0),
            g ? this.select(0, !0) : this.select(h + 1, !0)
        }
        this.frame().init(this.that.width, this.that.height),
        b && (this.frame().speed = b),
        e && (this.frame().preview = e.src),
        this.updateList(),
        this.that.updateData(),
        this.frameScrollLeft(),
        this.that.finished && this.that.layersNewFrame(this.frame(), this.frames[h]),
        a || this.that.LayerController.makeHistory("Layer", "Add Frame", "Undo")
    }
    ,
    ...
    J.prototype.newCanvas = function() {
        var a = new Image;
        return a.src = this.that.canvas.layer.empty,
        a
    }
    ,
    J.prototype.updateList = function() {
        this.updateFrameCount(),
        a("#frames-appended").html("");
        var b = this;
    ...
    J.prototype.duplicate = function(a) {
        this.that.isApp && this.frames.length > 9,
        ...
        for (var b = this.frames[a], c = jQuery.extend(!0, {}, b), d = [], e = 0; e < b.layers.length; e++) {
            ...
            d.push(f),
            d.length == b.layers.length && (c.layers = d,
            c.unqid = Math.random().toString(36).substring(7),
            this.frames.push(c),
            this.move(this.frames.length - 1, a + 1, !0),
            this.select(a + 1),
            this.that.setOnionSkin(),
            this.that.showOnionSkin(!0),
            this.that.updateAppFrames(),
            this.that.LayerController.makeHistory("Layer", "Duplicate Frame", "Redo"),
            this.frameScrollLeft())
        }
    }
    ,
    ...
    J.prototype.updateFrameTiles = function() {
        if (this.that.settings.frames.tile) {
            ...
            "undefined" != typeof c && (e = '<div class="frame-tile pre pp"><div class="frame-bg" ' + f + '></div><img src="' + c.preview + '" class="frame-tile-item" width="100%" data-id="' + (b - 1) + '" /></div></div>'),
            "undefined" != typeof d && (d = '<div class="frame-tile nex pp"><div class="frame-bg" ' + f + '></div><img src="' + d.preview + '" class="frame-tile-item" width="100%" data-id="' + (b + 1) + '" /></div></div>'),
            e && a("#frame-tiles").append(e),
            d && a("#frame-tiles").append(d)
        }
    }
    ,
    J.prototype.updateAllSpeed = function(b) {
        if ("" != b.trim() && " " != b && "n" != b) {
            ...
            a("#frames-container .all-frames-speed").val("n"),
            this.updateList(),
            this.that.HistoryController.create()
        }
    }
    ...
    J.prototype.move = function(a, b, c, d, e) {
        if (!(b >= this.frames.length || b < 0)) {
            ...
            c || e || this.that.LayerController.makeHistory("Layer", "Move Frame", "Undo"),
            this.frames.splice(b, 0, this.frames.splice(a, 1)[0]);
            ...
            for (var g = 0; g < this.that.layers.length; g++)
                this.that.layers[g].frames.splice(b, 0, this.that.layers[g].frames.splice(a, 1)[0]);
            this.that.setOnionSkin(),
            this.that.showOnionSkin(!0),
            this.that.render(),
            this.updateList(),
            c || this.that.LayerController.makeHistory("Layer", "Move Frame", "Redo")
        }
    }
    ,
    J.prototype["delete"] = function(b) {
        if (1 != this.frames.length) {
            this.frames[b];
            this.frames.splice(b, 1),
            a.each(this.that.layers, function(a, c) {
                c.frames.splice(b, 1)
            }),
            this.currentFrame == b ? (b = parseInt(b),
            this.currentFrame = b - 1 <= 0 ? 0 : b - 1) : this.currentFrame > b && (this.currentFrame = parseInt(this.currentFrame) - 1),
            this.select(this.currentFrame),
            this.updateList(),
            this.that.updateData(),
            this.that.setOnionSkin(),
            this.that.showOnionSkin(!0),
            this.that.LayerController.makeHistory("Layer", "Delete Frame", "Redo")
        }
    }
    ,
    J.prototype.add = function(a, b) {
        if (this.that.isApp && this.frames.length > 9,
        !b && this.that.ToolController && this.that.ToolController.renderChange)
            return this.that.ToolController.checkRenderNeeded(function() {});
    ...
    J.prototype.history = function(a, b) {
        this.currentFrame = a.data.currentFrame,
        this.frames = a.data.frames,
        this.select(this.currentFrame),
        his.updateList()
    }
    ,
    J.prototype.flattenAll = function(a, b, c) {
        for (var d = this, e = [], f = this.frames.length - 1; f >= 0; f--) {
            var g = this.frames[f];
            g.data_id = f,
            g.active && this.that.LayerController.flatten(g.layers, a, b, function(a) {
                e.push({
                    src: a,
                    speed: g.speed,
                    data_id: g.data_id
    ...
    J.prototype.download = function(a, b, c, d, e) {
        ...
        this.that.loadImage(h, function(a) {
            return f.that.canvas.data.clear(),
            f.that.canvas.data.canvas.width = j,
            f.that.canvas.data.canvas.height = k,
            f.that.canvas.data.setSmoothing(),
            f.that.canvas.data.clear(),
            f.that.canvas.data.putSimple(a, 0, 0, j, k),
            h = f.that.canvas.data.dataURL(),
            b && (i = b),
            d ? e ? e(h) : h : (f.that.isApp && (f.that.ons.platform.isAndroid() ? f.that.canvas.data.canvas.toBlob(function(a) {
                f.that.ons.downloadAndroid(Date.now() + ".png", a, h),
                f.that.canvas.data["default"]()
            }) : f.that.ons.downloadiOS(h)),
            f.that.isApp || (e ? f.that.canvas.extended && (f.that.canvas.extended.setSmoothing(),
            f.that.canvas.extended.clear(),
            f.that.canvas.extended.putSimple(a, 0, 0, j, k),
            f.that.canvas.extended.canvas.toBlob(function(a) {
                return f.that.canvas.extended["default"](),
                e(a)
            })) : saveAs(h, i)),
            void f.that.canvas.rendering["default"]())
        })
    }
    ,
    J.prototype.downloadAll = function() {
        ...
        if (!this.that.canvas.extended) {
            var d = this.that.width * this.that.downloadSizes.frame
              , e = this.that.width * this.that.downloadSizes.frame;
            return this.that.createCanvas("extended", d, e, function() {
                b.that.canvas.extended.setSmoothing(),
                b.that.canvas.extended.clear(),
                b.downloadAll()
            })
        }
        if (1 == this.frames.length)
    ...
    J.prototype.resizeFrames = function() {
        for (var a = 0; a < this.frames.length; a++) {
            var b = this.frames[a];
            b.width = this.that.width,
            b.height = this.that.height
        }
    }
    ,
    J.prototype.downloadSheet = function() {
        for (var a = this, b = this.that.downloadSizes.frame, c = [], d = 0; d < this.frames.length; d++) {
            ...
            this.that.LayerController.flatten(e.layers, !0, b, function(b) {
                c.push(b),
                c.length == a.frames.length && a.createSheet(c)
            })
        }
    }
    ,
    J.prototype.createSheet = function(a) {
        ...
        if (!this.that.canvas.extended)
            return this.that.createCanvas("extended", !1, !1, function() {
                b.createSheet(a)
            });
        this.that.canvas.extended.setSmoothing(),
        this.that.canvas.extended.clear(),
        this.that.canvas.extended.canvas.width = d * this.frames.length,
        this.that.canvas.extended.canvas.height = e;
        var f = prompt("Save as", "pixilart-sprite");
        f || (f = "pixilart-sprite");
        for (var g = 0, h = 0; h < a.length; h++) {
            var i = new Image;
            i.i = h,
            i.onload = function() {
                b.that.canvas.extended.ctx.drawImage(this, this.i * d, 0),
                g++,
                g >= a.length && (b.that.downloadAppCanvas("extended"),
                saveAs(b.that.canvas.extended.dataURL(), f),
                b.that.canvas.extended.destroy())
            }
            ,
            i.src = a[h]
    ...
    var K = function(b) {
        var c = this;
        this.common = ["000000", "ffffff", "7f7f7f", "a1a1a1", "c3c3c3", "c40424", "880015", "b97a57", "dba88c", "ed1c24", "f75b63", "f26f9b", "ff7f27", "f7ab79", "ffc90e", "fff200", "cfc532", "efe4b0", "1ee656", "0c6624", "22b14c", "b5e61d", "5487ff", "00a2e8", "99d9ea", "3f48cc", "7f86e3", "7092be", "720899", "cd55cf", "a349a4", "c8bfe7"],
        this.defaultColors = ["000000", "ffffff", "f44336", "e91e63", "9c27b0", "673ab7", "3f51b5", "2196f3", "03a9f4", "00bcd4", "009688", "4caf50", "8bc34a", "cddc39", "ffeb3b", "ffc107", "ff9800", "ff5722", "795548", "9e9e9e", "607d8b"],
        this.skinTones = ["ffe0bd", "ffdbac", "ffcd94", "eac086", "e0ac69", "f1c27d", "ffad60", "c68642", "8d5524", "896347", "765339", "613d24", "4c2d17", "391e0b", "351606", "2d1304", "180a01", "090300"],
        this.simple = ["ffffff", "d4d4d4", "a1a1a1", "787878", "545454", "303030", "000000", "edc5c5", "e68383", "ff0000", "de2424", "ad3636", "823737", "592b2b", "f5d2ee", "eb8dd7", "f700b9", "bf1f97", "9c277f", "732761", "4f2445", "e2bcf7", "bf79e8", "9d00ff", "8330ba", "6d3096", "502c69", "351b47", "c5c3f0", "736feb", "0905f7", "2e2eb0", "2d2d80", "252554", "090936", "c7e2ed", "6ac3e6", "00bbff", "279ac4", "347c96", "2d5b6b", "103947", "bbf0d9", "6febb3", "00ff88", "2eb878", "349166", "2b694c", "0c3d25", "c2edc0", "76ed70", "0dff00", "36c72c", "408c3b", "315c2e", "144511", "d6edbb", "b5eb73", "8cff00", "89c93a", "6f8f44", "4b632a", "2a400c", "f1f2bf", "eef069", "ffff00", "baba30", "91913f", "5e5e2b", "3b3b09", "ffdeb8", "f2ae61", "ff8400", "c48037", "85623d", "573e25", "3d2309", "fcbbae", "ff8066", "ff2b00", "cc553d", "9c5b4e", "61372e", "36130b"],
        this.common = ["000000", "ffffff", "464646", "b4b4b4", "990030", "9c5a3c", "ed1c24", "ffa3b1", "ff7e00", "e5aa7a", "ffc20e", "f5e49c", "fff200", "fff9bd", "a8e61d", "d3f9bc", "22b14c", "00b7ef", "99d9ea", "4d6df3", "709ad1", "2f3699", "546d8e", "6f3198", "b5a5d5"],
        this.that = b,
        this.colorPaletteShown = !1,
        this.maxColors = 500,
        this.currentSelection = "common",
        this.colorArray = [],
        this.that.isMobileDevice && (this.currentSelection = "default"),
        this.that.isApp && (this.defaultColors = [],
        this.currentSelection = "common"),
        this.color = "#000000",
        this.colorReverse = !1,
        this.secondary = "#ffffff",
        this.mobileColorsAll = ["ffebee", "ffcdd2", "ef9a9a", "e57373", "ef5350", "e53935", "d32f2f", "c62828", "b71c1c", "ff8a80", "ff5252", "ff1744", "d50000", "fce4ec", "f8bbd0", "f48fb1", "f06292", "ec407a", "e91e63", "d81b60", "c2185b", "ad1457", "880e4f", "ff80ab", "ff4081", "f50057", "c51162", "f3e5f5", "e1bee7", "ce93d8", "ba68c8", "ab47bc", "9c27b0", "8e24aa", "7b1fa2", "6a1b9a", "4a148c", "ea80fc", "e040fb", "d500f9", "aa00ff", "ede7f6", "d1c4e9", "b39ddb", "9575cd", "7e57c2", "673ab7", "5e35b1", "512da8", "4527a0", "311b92", "b388ff", "7c4dff", "651fff", "6200ea", "e8eaf6", "c5cae9", "9fa8da", "7986cb", "5c6bc0", "3f51b5", "3949ab", "303f9f", "283593", "1a237e", "8c9eff", "536dfe", "3d5afe", "304ffe", "e3f2fd", "bbdefb", "90caf9", "64b5f6", "42a5f5", "2196f3", "1e88e5", "1976d2", "1565c0", "0d47a1", "82b1ff", "448aff", "2979ff", "2962ff", "e1f5fe", "b3e5fc", "81d4fa", "4fc3f7", "29b6f6", "03a9f4", "039be5", "0288d1", "0277bd", "01579b", "80d8ff", "40c4ff", "00b0ff", "0091ea", "e0f7fa", "b2ebf2", "80deea", "4dd0e1", "26c6da", "00bcd4", "00acc1", "0097a7", "00838f", "006064", "84ffff", "18ffff", "00e5ff", "00b8d4", "e0f2f1", "b2dfdb", "80cbc4", "4db6ac", "26a69a", "009688", "00897b", "00796b", "00695c", "004d40", "a7ffeb", "64ffda", "1de9b6", "00bfa5", "e8f5e9", "c8e6c9", "a5d6a7", "81c784", "66bb6a", "4caf50", "43a047", "388e3c", "2e7d32", "1b5e20", "b9f6ca", "69f0ae", "00e676", "00c853", "f1f8e9", "dcedc8", "c5e1a5", "aed581", "9ccc65", "8bc34a", "7cb342", "689f38", "558b2f", "33691e", "ccff90", "b2ff59", "76ff03", "64dd17", "f9fbe7", "f0f4c3", "e6ee9c", "dce775", "d4e157", "cddc39", "c0ca33", "afb42b", "9e9d24", "827717", "f4ff81", "eeff41", "c6ff00", "aeea00", "fffde7", "fff9c4", "fff59d", "fff176", "ffee58", "ffeb3b", "fdd835", "fbc02d", "f9a825", "f57f17", "ffff8d", "ffff00", "ffea00", "ffd600", "fff8e1", "ffecb3", "ffe082", "ffd54f", "ffca28", "ffc107", "ffb300", "ffa000", "ff8f00", "ff6f00", "ffe57f", "ffd740", "ffc400", "ffab00", "fff3e0", "ffe0b2", "ffcc80", "ffb74d", "ffa726", "ff9800", "fb8c00", "f57c00", "ef6c00", "e65100", "ffd180", "ffab40", "ff9100", "ff6d00", "fbe9e7", "ffccbc", "ffab91", "ff8a65", "ff7043", "ff5722", "f4511e", "e64a19", "d84315", "bf360c", "ff9e80", "ff6e40", "ff3d00", "dd2c00", "efebe9", "d7ccc8", "bcaaa4", "a1887f", "8d6e63", "795548", "6d4c41", "5d4037", "4e342e", "3e2723", "fafafa", "f5f5f5", "eeeeee", "e0e0e0", "bdbdbd", "9e9e9e", "757575", "616161", "424242", "212121", "eceff1", "cfd8dc", "b0bec5", "90a4ae", "78909c", "607d8b", "546e7a", "455a64", "37474f", "263238"],
        this.importNameCount = 1;
    ...
    K.prototype.resetPresets = function() {
        ...
        if (a) {
            ...
            this.updateColors(this.currentSelection),
            this.updateOptions(),
    ...
    K.prototype.updatePreset = function() {
        var b = this;
        this.colorPresets[this.currentSelection] = [],
        a("#color-container .color-select").each(function() {
    ...
    K.prototype.init = function() {
        this.initColors(),
        this.color = "#000000",
        this.elementSelect(a("#color-000000")),
        this.listeners(),
        this.updateOptions(),
        this.setToolColors(),
        this.importColorPallet(),
        this.that.isMobile
    }
    ,
    ...
    K.prototype.setColor = function(a) {
        var b = this.color
          , c = this.secondary;
        a && !this.colorReverse && (this.secondary = b,
        this.color = c,
        this.colorReverse = !0)
    }
    ,
    K.prototype.restoreSetColor = function() {
        var a = this.color
          , b = this.secondary;
        this.colorReverse && (this.secondary = a,
        this.color = b,
        this.colorReverse = !1)
    }
    ,
    K.prototype.load = function(b, c, d) {
        var e = this
          , f = [];
        c = c || !1,
        b = b ? b : this.colorPresets[this.currentSelection],
        this.colorArray = [],
        (!this.that.isMobileDevice && !this.that.isApp || this.that.isApp) && a("#mobile-color-container, #color-container, #colors-bar-mobile").html(""),
        b = b.slice(0, this.maxColors),
        a.each(b, function(b, g) {
            g = g.toLowerCase(),
            e["new"](g, c),
            e.that.isApp || f.indexOf(g) > -1 || (f.push(g),
            (!c && !e.that.isMobile || d || e.that.isApp) && (!e.that.isMobileDevice && !e.that.isApp || e.that.isApp ? a("#color-container").append(e.template(g)) : a("#mobile-color-container, #color-container, #colors-bar-mobile").append(e.template(g))))
        });
        var g = b[0];
        "ffffff" != g && "FFFFFF" != g || (g = "000000"),
        this.select(g)
    }
    ,
    K.prototype.checkForColorChange = function() {
        this.newColor && (this["new"](this.newColor),
        this.newColor = !1)
    }
    ,
        ...
        !this.that.isApp) {
            var d = {
                ...
                onChange: function(b, d, e, f) {
                    f ? c.secondary = "#" + d : c.color = "#" + d,
                    c.setToolColors(),
                    c.newColor = d,
                    a(this).parent().hasClass("is-flat") || a("#color-picker-panel").ColorPickerSetColor("#" + d)
                },
            ...
            a("#add-color, #primary-color, #secondary-color").ColorPicker(d),
            d.flat = !0,
            a("#color-picker-panel").ColorPicker(d)
        }
    ...
    K.prototype.listenersRedo = function() {
        var b = this
          , c = "pointerdown";
        this.that.isTouch && (c = "pointerdown"),
        a("#popup-container, #colors-bar-mobile").on("click", ".color-select", function(c) {
            var d = a(this).attr("data-color");
            b.select(d),
            a(this).parent().hasClass("mobile-color-container") && b.that.hidePopup()
        }),
    ...
    K.prototype.showPalettes = function() {
        if (a("#colors-list-wrapper").is(":visible"))
            return void this.hidePalettes();
    ...
    K.prototype.removePreset = function() {
        ...
        if (c && !(this.colorPresets.length <= 1 || "default" == this.currentSelection)) {
            ...
            this.colorPresets = d,
            this.that.settings.palette_ids = e,
    ...
    K.prototype.usePalette = function(b, c) {
        if (!b.hasClass("new-modal") || c) {
            ...
            "undefined" == typeof this.colorPresets[f] && (this.colorPresets[f] = [],
            this.that.settings.palette_ids[f] = g,
            this.load(e)),
            this.that.palette_id = g,
            this.updateOptions(),
            this.updateColors(f, this.that.isTablet),
            this.elementSelect(a("#color-" + e[0])),
            this.hidePalettes(),
            this.updatePaletteSettings()
        }
    }
    ...
    K.prototype.updatePaletteSettings = function() {
        this.that.isApp || (this.that.settings.palettes = this.colorPresets,
        this.that.updateSettings())
    }
    ,
                ...
                for (var i = 0; i < c; i += 4) {
                    ...
                    if (0 != b[i + 3])
                        for (var g = 0; g < e; g++) {
                            ...
                            (o <= j || j === !1) && (k = h,
                            j = o),
                            g == d.length - 1 && (b[i] = k.r,
                            b[i + 1] = k.g,
                            b[i + 2] = k.b)
                        }
                }
                this.that.canvas.layer.ctx.putImageData(a, 0, 0),
                this.applyPaletteDone(),
                b = null,
                a = null
            }
        }
    ...
    K.prototype.applyPaletteDone = function() {
        var a = this;
        this.that.render(),
        this.that.LayerController.updateLayer(),
        this.that.FrameController.updateFramePreview(),
        this.that.ToolController.restore(),
        this.that.LayerController.updateLayer(!1, function() {
            a.that.HistoryController.create()
    ...
    K.prototype.updateColors = function(b, c) {
        if ((!this.that.isMobile || this.that.isTablet || this.that.isApp) && "object" == typeof this.colorPresets[b]) {
            for (var d = 0; d < this.colorPresets[b].length; d++)
                this.colorPresets[b][d] = this.colorPresets[b][d].toLowerCase();
            a(".color-presets").val(b),
            this.currentSelection = b,
            this.load(!1, !1, c),
            this.that.settings.palette_ids[b] ? this.that.palette_id = this.that.settings.palette_ids[b] : this.that.palette_id = !1,
            this.that.settings.palette = b,
            this.updatePaletteSettings()
        }
    }
    ,
    ...
    K.prototype.updateOptions = function() {
        var b = this
          , c = "";
        this.that.isApp || (a("#color-presets").html(""),
        a.each(this.colorPresets, function(a, d) {
            c = c + '<option value="' + a + '"',
            a == b.currentSelection && (c += ' selected="selected"'),
            c = c + ">" + a + "</option>"
        }),
    ...
    K.prototype.template = function(a, b) {
        ...
        '<div id="color-' + a + '" class="color color-select color-' + a + " " + b + " col-" + a + '" data-color="' + a + '" title="' + a + '"><div class="color-block" style="background-color:#' + a + '"></div></div>'
    }
    ,
    K.prototype.mobileColors = function() {
        var b = this;
        this.colorPresets[this.currentSelection] = this.mobileColorsAll.concat(this.colorPresets[this.currentSelection]),
    ...
    K.prototype["new"] = function(b, c, d) {
        ...
        if (this.check(b)) {
            if (this.colorPresets[this.currentSelection].indexOf(b) === -1)
                return this.that.isApp ? this.colorPresets[this.currentSelection].unshift(b) : this.colorPresets[this.currentSelection].push(b),
                this.that.isApp ? a("#color-container").prepend(this.template(b)) : this.that.isMobileDevice ? a("#colors-bar-mobile").append(this.template(b)) : a("#color-container").append(this.template(b)),
                this.that.isApp && this.colorPresets[this.currentSelection].length > this.maxColors && (this.colorPresets[this.currentSelection] = this.colorPresets[this.currentSelection].slice(0, this.maxColors),
                a("#color-container .color-select:last-child").remove()),
                this.ignoreSelected || this.select(b, e),
                void this.updatePaletteSettings();
            this.select(b, e),
            "primary" == e ? this.color == "#" + b && this.select(b, e) : this.secondary == "#" + b && this.select(b, e)
        }
    }
    ,
    K.prototype.importColorsFromPallet = function(b, c) {
        ...
        e.length >= 1 && (b = "custom-" + b,
        this.colorPresets[b] = e,
        this.updateOptions(),
        this.updateColors(b),
        this.that.isApp || (a("#color-presets").val(b),
        this.elementSelect(a("#color-" + d))))
    }
    ,
    ...
    K.prototype.getColorsFromCanvas = function(a) {
        ...
        return f > 1e5 ? this.that.showAlert(this.that.messages("filesize")) : void this.that.loadImage(d, function(a) {
            ...
            for (var c = e.that.canvas.data.ctx.getImageData(0, 0, e.that.width, e.that.height), d = 0; d < c.data.length; d += 4) {
                ...
                f = f.toLowerCase(),
                b.indexOf(f) == -1 && c.data[d + 3] > 0 && (b.push(f),
                e["new"](f, !1, !0))
            }
        })
    }
    ...
    K.prototype.elementSelect = function(b, c, d) {
        ...
        !this.that.isApp && a("#color-" + d).length >= 1 && (!c || c && "primary" == c ? this.color = "#" + d : this.secondary = "#" + d,
        a("#color-container .color-select, #colors-bar-mobile .color-select, #mobile-color-container .color-select").removeClass("active"),
        b.addClass("active"),
        this.end()),
        this.setToolColors()
    }
    ...
    K.prototype.end = function() {
        ...
        this.that.mouse.getPixelSizeImage())
    }
    ,
    K.prototype.removeColor = function(b) {
        ...
        if (a("#color-" + c).length >= 1) {
            ...
            d > -1 && (this.colorPresets[this.currentSelection].splice(d, 1),
            a("#color-" + c).remove(),
            this.updatePaletteSettings())
        }
    }
    ...
    K.prototype.select = function(b, c) {
        ...
        b = b.toLowerCase();
        var d = b.toUpperCase();
        this.colorPresets[this.currentSelection].indexOf(b) === -1 && this.colorPresets[this.currentSelection].indexOf(d) === -1 && this["new"](b),
        this.elementSelect(a(".color-" + b), c),
        this.setAppColorButton(),
        this.that.isApp || a("#color-picker-panel").ColorPickerSetColor("#" + b),
        this.that.isApp && a("#drawing-wrapper .current-color-shown").css({
            backgroundColor: "#" + b
        })
    }
    ;
    var L = function(b, c, d) {
        ...
        this.zoomTimeX = 0,
        this.zoomTimeY = 0,
        this.zoomMotionCurrent = 1,
        this.zoomMotionWidth = 0,
        this.zoomMotionHeight = 0,
        this.zoomMotionX = 0,
        this.zoomMotionY = 0,
        this.zoomingOut = !1,
        this.scrollZoom = !1,
        this.ignorePos = !1,
        this.setRangeLastClicks = !1,
        this.previousZoom = -1,
        this.previousZoomX = 0,
        this.previousZoomY = 0,
        this.rangeResetActive = !1,
        this.rangeResetTimer = !1,
        this.rangeResetAmount = 0,
        this.panX = 0,
        this.panY = 0,
        this.setLastClicks = !1,
        this.fit_size = 0,
        this.reset(),
        this.zoomOutMax = 0,
        this.canvas = a("#canvas-layers-container"),
        a("#canvas-layers-appened").addClass("css")
    };
    L.prototype.init = function(b) {
        var c = this
          , d = a("#drawing-canvas-conatiner");
        a("#zoom-range").attr("max", this.maxZoom),
        this.that.isApp || d.bind("wheel mousewheel", function(a) {
            c.that.isMobile || c.that.settings.disableScrollZoom || (a.preventDefault(),
            c.setLastClicks = !0,
            c.scrollZoom = !0,
            c.active(a))
        }),
        ...
        a("#zoom-range-reset").on("input", function(b) {
            var d = a(this)
              , e = parseInt(d.val());
            c.rangeResetAmount = e,
            c.rangeResetActive = !0,
            c.zoomRangeReset()
        }),
        a("#zoom-range-reset").on("change", function(b) {
            c.rangeResetActive = !1,
            a("#zoom-range-reset").val(25)
        }),
        this.align(),
    ...
    L.prototype.fit = function() {
        this.zoomRange(this.that.zoom["default"]),
        this.center()
    }
    ,
    L.prototype.reset = function(a) {
        this.zoom = 1,
        this.that.zoom_step = 1;
        var b = this.that.width
          , c = this.that.height;
        this.last_x = b / 2,
        this.last_y = c / 2,
        this.zoom = this.that.zoom["default"],
        this.minZoom = this.that.zoom["default"],
        this.zoomMotionCurrent = this.that.zoom["default"],
        this.out = !1,
        this.previousZoomX = this.last_x,
        this.previousZoomY = this.last_y,
        this.setRange(),
        a && this.use()
    }
    ,
    L.prototype.zoomRangeReset = function() {
        ...
        a > 0 ? (b = !0,
        a *= -1) : a = Math.abs(a),
        !this.rangeResetTimer && this.rangeResetActive && (this.zoomRangeAction(a),
        this.rangeResetTimer = setTimeout(function() {
            clearTimeout(c.rangeResetTimer),
            c.rangeResetTimer = !1,
            c.zoomRangeReset()
        }, 30))
    }
    ...
    L.prototype.zoomRangeAction = function(a) {
        this.zoom *= Math.pow(.999, a / 25 * 100),
        this.checkLimits(),
        this.zoom >= this.that.grid.max_size && (this.zoom > this.lastZoomInt ? this.zoom = this.that.round(this.zoom, 1, "up") : this.zoom = this.that.round(this.zoom, 1, "down")),
        this.lastZoomInt = this.zoom;
        var b = this.last_x
          , c = this.last_y
          , d = d ? d : b
          , e = e ? e : c;
        this.that.NavigationController.ignoreZoomLastClicks = !0,
        this.setZoomVars(),
        this.render(d, e)
    }
    ,
    ...
    L.prototype.checkLimits = function() {
        this.zoom >= this.maxZoom && (this.zoom = this.maxZoom),
        this.zoom <= this.minZoom && !this.that.settings.zoomUnlock && !this.that.isApp && (this.zoom = this.minZoom),
        this.zoom <= 1 && this.minZoom >= 1 && (this.zoom = 1),
        this.zoom <= .25 && (this.zoom = .25)
    }
    ,
    L.prototype.active = function(a, b, c) {
        if (!this.that.mouse.middleClickDown && !this.loading) {
            ...
            d < 0 && d > -25 && (d = -25),
            d > 0 && d < 25 && (d = 25),
            this.zoom *= Math.pow(.999, d),
            this.lastZoomInt || (this.lastZoomInt = this.that.zoom["default"]),
            this.zoom >= this.that.grid.max_size && (this.zoom > this.lastZoomInt ? this.zoom = this.that.round(this.zoom, 1, "up") : this.zoom = this.that.round(this.zoom, 1, "down")),
            this.lastZoomInt = this.zoom,
            this.checkLimits();
            var e = !1
              , f = !1;
            this.scrollZoom || this.that.ToolController.cancel(),
            (this.zoom < this.previousZoom || this.zoom == this.previousZoom) && (this.zoomingOut = !0),
            this.previousZoom = this.zoom,
            (c || this.zoomingOut) && (e = this.last_x,
            f = this.last_y,
            this.that.isApp && !this.that.app.fingerToDraw && (e = this.that.mouse.app_x_last,
            f = this.that.mouse.app_y_last),
            this.that.NavigationController.ignoreZoomLastClicks = !0),
            this.setZoomVars(),
            this.render(e, f)
        }
    ...
    L.prototype.setZoomVars = function() {
        this.that.zoom_ratio = this.zoom,
        this.that.zoom_step = this.zoom
    }
    ,
    L.prototype.render = function(a, b) {
        ...
        this.zoomTimeX && this.scrollZoom && (d = this.zoomTimeX,
        e = this.zoomTimeY),
        this.loading = !0,
        this.that.grid.status ? this.that.createGrid("grid", function() {
            c.end(d, e)
        }) : this.end(d, e)
    }
    ,
    L.prototype.end = function(a, b) {
        ...
        this.use(a, b),
        this.that.render(),
        this.that.NavigationController.placement(),
        this.that.NavigationController.clickLocation(),
        this.setLastClicks && (this.setLastClicks = !1,
        this.last_x = a,
        this.last_y = b),
        this.setRangeLastClicks && (this.setRangeLastClicks = !0,
        this.that.mouse.touchEndMove()),
        clearTimeout(this.loadingTimer),
        clearTimeout(this.zoomTimer),
        this.scrollZoom && (this.zoomTimeX = a,
        this.zoomTimeY = b,
    ...
    L.prototype.setLastZoom = function() {
        this.zoomMotionWidth = this.that.width * this.that.pixel_size * this.zoom,
        this.zoomMotionHeight = this.that.height * this.that.pixel_size * this.zoom,
        this.zoomMotionX = this.last_x,
        this.zoomMotionY = this.last_y,
        this.zoomMotionCurrent = this.zoom
    }
    ,
    L.prototype.align = function(b, c, d, e) {
        if (d = d ? d : a("#drawing-canvas-conatiner").width(),
        e = e ? e : a("#drawing-canvas-conatiner").height(),
        b || (b = this.canvas.width()),
        c || (c = this.canvas.height()),
        this.canvas.css({
            left: 0,
            top: 0
        }),
    ...
    L.prototype.position = function(b, c, d) {
        b = b ? b : this.that.mouse.x_0,
        c = c ? c : this.that.mouse.y_0,
        this.that.isApp && !this.that.app.fingerToDraw && (b = this.that.mouse.app_x_last,
        c = this.that.mouse.app_y_last),
        this.zoomTimeX && this.scrollZoom && !this.zoomingOut && (b = this.zoomTimeX,
        c = this.zoomTimeY),
        this.last_cord_x = b,
        this.last_cord_y = c,
        this.previousZoom = this.zoom;
        ...
        this.zoomingOut && (e = 0,
        f = 0),
        b < this.previousZoomX ? this.previousZoomX -= e : b > this.previousZoomX && (this.previousZoomX += e),
        c < this.previousZoomY ? this.previousZoomY -= f : c > this.previousZoomY && (this.previousZoomY += f),
        this.that.isApp || (b = this.previousZoomX,
        c = this.previousZoomY);
        ...
        this.scrollX = g,
        this.scrollY = h,
        d ? a("#drawing-canvas-conatiner").animate({
            scrollTop: h,
            scrollLeft: g
    ...
    L.prototype.setZoomPosition = function() {
        ...
        this.last_x = Math.round((b.width() / 2 - c.left) / d),
        this.last_y = Math.round((b.height() / 2 - c.top) / d),
        this.previousZoomX = Math.round((b.width() / 2 - c.left) / d),
        this.previousZoomY = Math.round((b.height() / 2 - c.top) / d)
    }
    ,
    L.prototype.center = function() {
        var b = a("#drawing-canvas-conatiner").width()
          , c = a("#drawing-canvas-conatiner").height()
          , d = (a("#canvas-layers-container").position(),
        this.that.pixel_size * this.zoom,
        this.that.width / 2 * this.that.pixel_size * this.zoom)
        ...
        this.previousZoomX = this.last_x,
        this.previousZoomY = this.last_y,
        this.that.alignPan(f, g)
    }
    ,
    L.prototype.zoomUse = function(a, b, c, d) {
        this.canvas.width(c).height(d),
        this.that.isApp && this.that.app.fingerToDraw || this.align(c, d),
        this.position(a, b),
        this.that.mouse.render(),
        this.that.TileController.updatePlacement()
    }
    ,
    L.prototype.zoomMotion = function(a, b, c, d, e) {}
    ,
    L.prototype.use = function(a, b) {
        var c = this.that.width
          , d = this.that.height;
        return c = c * this.that.pixel_size * this.zoom,
        d = d * this.that.pixel_size * this.zoom,
        this.zoomUse(a, b, c, d)
    }
    ;
    var M = function(a) {
        this.that = a
    ...
    var N = function(a) {
        ...
        this.downloadActive = !1,
        this.downloadButtonText = "",
        this.downloadButtonLoadingtext = this.that.getResponse("res-loading") + '.. <span class="loading-percent-preview-gif"></span>'
    };
    N.prototype.init = function() {
        this.listeners(),
        this.close(),
        this.downloadButtonText = a("#download-preview").html()
    }
    ,
    N.prototype.reset = function() {
        this.that.previewSize = this.that.pixel_size * this.that.zoom,
        a("#preview-size-change, #preview-size-change-nav").val("default")
    }
    ,
    N.prototype.listeners = function() {
        ...
        a(".preview-select").change(function() {
            ...
            a(".preview-select").val(c),
            b.that.previewSize = d
        })
    }
    ,
    N.prototype.previewFrames = function() {
        var a = this;
        this.show(),
        this.that.FrameController.flattenAll(!0, 1, function(b) {
            b.length >= 1 && a.loop(b)
        })
    }
    ,
    N.prototype.close = function() {
        this.that.finished && (this.active = !1,
        clearTimeout(this.loopTimer),
        a(".preview-container").removeClass("active"),
        a(".close-preview-button").hasClass("hidden") && a(".close-preview-button").removeClass("hidden"))
    }
    ,
    N.prototype.showLoading = function() {
        a(".preview-container").addClass("active"),
        a(".preview-loading").show(),
        a(".close-preview-button").addClass("hidden"),
        a(".preview-content").hide()
    }
    ,
    N.prototype.hideLoading = function() {
        a(".preview-container").removeClass("active"),
        a(".close-preview-button").removeClass("hidden"),
        a(".preview-content").show()
    }
    ,
    N.prototype.show = function() {
        return this.active = !0,
        a(".preview-container").hasClass("active") ? void this.close() : (this.that.FrameController.frames.length > 1 ? a("#download-preview").addClass("active") : a("#download-preview").removeClass("active"),
        a(".preview-container").removeAttr("style"),
        a(".preview-container").addClass("active"),
        a(".preview-loading").show(),
        void a(".preview-content-append").html(""))
    }
    ,
    ...
    N.prototype.doLoop = function(a) {
        var b = !1
          , c = this;
        this.active && (b = a[this.imagePosition],
        this.imagePosition >= a.length && (this.imagePosition = 0,
        b = a[this.imagePosition]),
        this.imagePosition++,
        b && (this.image(b.src),
    ...
    N.prototype.loop = function(b) {
        ...
        var c = this.that.previewSize ? this.that.previewSize : this.that.zoom["default"]
          , d = this.that.width * c
          , e = this.that.height * c;
        a("#preview-content, #preview-appened").width(d).height(e),
        a("#preview-loading").hide(),
        clearTimeout(this.loopTimer),
        this.doLoop(b)
    }
    ,
    N.prototype.download = function(b) {
        ...
        a("#download-preview").html(this.downloadButtonLoadingtext),
        b.attr("data-select-size") && (d = parseInt(this.that.downloadSizes.gif)),
        this.downloadActive || (this.downloadActive = !0,
        this.that.GifController.download(d, !0, function(b) {
            var d = URL.createObjectURL(b);
            saveAs(d, "pixil-gif-drawing.gif"),
            a("#download-preview").html(c.downloadButtonText),
            a(".loading-gif-restart").text(""),
            c.downloadActive = !1
        }))
    }
    ;
    var O = function(b) {
        ...
        this.cut_height = 0,
        this.copyData = !1,
        this.secondaryCopyData = !1,
        this.cutImageData = !1,
        this.currentImage = !1,
        this.transform = !1,
        this.currentSizeImage = !1,
        this.currentSizeImageLoaded = !1,
        this.currentSelectImage = !1,
        this.rotateImageColors = [],
        this.developerData = [],
        this.usingLasso = !1,
        this.informationHTML = a("#select-information").html(),
        a("#select-information").remove()
    };
    O.prototype.init = function() {
        this.listeners(),
        this.hideStampButton()
    }
    ,
    O.prototype.listeners = function() {
        ...
        a(document).keydown(function(a) {
            if (46 == a.keyCode && b.deleteSelection(),
            (event.ctrlKey || event.metaKey) && 67 == a.keyCode && b.copySection(),
            (event.ctrlKey || event.metaKey) && 86 == a.keyCode && b.pasteSelection(),
            (event.ctrlKey || event.metaKey) && 88 == a.keyCode && b.cutSelection(),
            (event.ctrlKey || event.metaKey) && 68 == a.keyCode && b.hasSelection() && b.accept(),
            b.that.developer) {
                if (192 == a.keyCode) {
    ...
    O.prototype.selectLayerContent = function(a) {
        ...
        var b = this.that.canvas.layer.ctx.getImageData(0, 0, this.that.width, this.that.height)
          ...
          , j = 0;
        this.cutImageData = !1;
        for (var k = 0; k < b.data.length; k += 4)
            c >= this.that.width && (c = 0,
            d++),
            b.data[k + 3] > 0 && ((c <= e || e === !1) && (e = c),
            (d <= f || f === !1) && (f = d),
            (c >= g || g === !1) && (g = c),
            (d >= h || h === !1) && (h = d)),
            c++;
        ...
        if (this.secondaryCopyData = this.copyDataFormat(l, l.width, l.height),
        i > 1 && j > 1 && (this.that.ToolController.tool.setSelection(e, f, i, j, i, j, !0),
        this.that.ToolController.tool.activeSelecting = !0,
        this.that.ToolController.tool.selectCanvasLocation.active = !1,
        this.that.ToolController.tool.off(),
        this.that.SelectController.setCordinates(i, j),
        this.that.render(),
        a))
            return a()
    ...
    O.prototype.setCordinates = function(b, c) {
        Math.abs(b) > 0 || Math.abs(c) > 0 ? (a("#select-size-display").removeClass("hidden-hard"),
        a("#select-width").text(Math.abs(b)),
        a("#select-height").text(Math.abs(c))) : a("#select-size-display").addClass("hidden-hard")
    }
    ,
    O.prototype.resize = function(a, b) {
        var c = this;
        if (!(a <= 0 || b <= 0))
            return this.currentSizeImage ? void (this.currentSizeImageLoaded && this.resizeCanvas(a, b)) : (this.currentSizeImageLoaded = !1,
            this.currentSizeImage = this.that.canvas.rendering.image(),
            this.currentSizeImage.onload = function() {
                c.currentSizeImageLoaded = !0,
                c.resizeCanvas(a, b)
            }
            )
    }
    ...
    O.prototype.resizeCanvas = function(a, b) {
        var c = this;
        this.that.canvas.rendering.canvas.width = a,
        this.that.canvas.rendering.canvas.height = b,
        this.that.canvas.rendering.setSmoothing(),
        this.that.ToolController.tool.options.repeat.value ? this.that.backgroundImageRepeat("rendering", this.secondaryCopyData.image, function() {
            c.resizeSrc(c.that.canvas.rendering.dataURL(), !0)
        }, a, b) : (this.that.canvas.rendering.ctx.drawImage(this.currentSizeImage, 0, 0, a, b),
        this.resizeSrc(this.that.canvas.rendering.dataURL(), !0)),
        this.setCordinates(a, b)
    }
    ,
    O.prototype.setRotateImage = function(a) {
        var b = this
          , c = !1
          , d = !1;
        return c = this.that.canvas.rendering.canvas.width,
        d = this.that.canvas.rendering.canvas.height,
        this.currentSelectImage ? (a += this.currentDeg,
        this.degRotate(a)) : void this.that.getDrawnPixels(function(c, d, e, f, g, h, i, j) {
            b.that.canvas.rendering.clear(),
            b.that.canvas.rendering.canvas.width = d,
            b.that.canvas.rendering.canvas.height = e,
            b.that.canvas.rendering.setSmoothing(),
            b.that.canvas.rendering.ctx.putImageData(c, -f, -g),
            b.currentSelectImage = b.that.canvas.rendering.image(),
            b.rotateImageColors = !1,
            j.length < 20 && j.length >= 1 && (b.rotateImageColors = j),
            b.currentSelectImage.onload = function() {
                b.currentDeg = 0,
                b.degRotate(a)
            }
    ...
    O.prototype.degRotate = function(a) {
        ...
        var c = this.currentSelectImage.width
          ...
          , g = c;
        e = Math.round(this.drag_width / 2) + this.start_x,
        f = Math.round(this.drag_height / 2) + this.start_y,
        d > c && (g = d),
        g = Math.round(g + g / 2);
        Math.round((g - c) / 2),
        Math.round((g - d) / 2);
        this.that.canvas.data.clear(),
        this.that.canvas.data.canvas.width = Math.round(g),
        this.that.canvas.data.canvas.height = Math.round(g),
        this.that.canvas.data.setSmoothing(),
        this.that.canvas.data.ctx.save(),
        this.that.canvas.data.ctx.translate(Math.round(g / 2), Math.round(g / 2)),
        this.that.canvas.data.ctx.rotate(a * Math.PI / 180),
        this.that.canvas.data.setSmoothing(),
        this.that.canvas.data.ctx.drawImage(this.currentSelectImage, Math.round(-c / 2), Math.round(-d / 2), c, d),
        this.that.canvas.data.ctx.restore(),
        this.that.getDrawnPixels(function(c, d, g, h, i, j, k) {
            b.that.canvas.rendering.clear(),
            b.that.canvas.rendering.canvas.width = d,
            b.that.canvas.rendering.canvas.height = g,
            b.that.canvas.rendering.setSmoothing(),
            b.that.canvas.rendering.ctx.putImageData(c, -h, -i);
            var l = Math.floor(e - d / 2)
              , m = Math.floor(f - g / 2);
            b.currentSizeImage = !1,
            b.currentDeg = a,
            b.width = d,
            b.height = g,
            b.drag_width = d,
            ...
            b.start_x = l,
            b.start_y = m,
            b.that.ToolController.tool.selectCanvasLocation.x = l,
            b.that.ToolController.tool.selectCanvasLocation.y = m,
            b.that.ToolController.tool.selectCanvasLocation.width = d,
            b.that.ToolController.tool.selectCanvasLocation.height = g,
            b.that.ToolController.tool.rotating = !1,
            b.that.ToolController.tool.updateSelection(),
            b.that.ToolController.tool.updateSelectCanvasArea(d, g),
            b.that.render(),
            b.setCordinates(d, g)
    ...
    O.prototype.resetSet = function(a, b) {
        b && (this.currentSizeImage = !1),
        this.that.ToolController.tool.updateSelection(a, !0),
        this.that.ToolController.tool.updateSelectCanvasArea(this.that.canvas.rendering.canvas.width, this.that.canvas.rendering.canvas.height),
        this.that.render()
    }
    ,
    O.prototype.cutSelection = function() {
        return !!this.hasSelection() && (this.copySection(!1, !0),
    ...
    O.prototype.developerInformation = function(a) {
        ...
        this.developerData.push(d),
        console.log(d)
    }
    ,
    O.prototype.downloadSelection = function() {
        var b = this.that.canvas.rendering.dataURL();
        a("#dowmnload-a").attr("href", b),
        a("#dowmnload-a").attr("download", "Pixilart selection"),
        a("#dowmnload-a")[0].click()
    }
    ,
    ...
    O.prototype.hideSelectTools = function() {
        a("#canvas-layers-container .select-helpers").removeClass("active"),
        this.that.isApp && a("#select-accept, #select-copy, #select-delete, #select-paste, #select-flip-x, #select-flip-y").hide()
    }
    ,
    O.prototype.showSelectTools = function(b, c) {
        if (this.that.fileDrawing && a("#tool-select-bar .save-text-selection, #canvas-layers-container .save-text-selection").length >= 1 && a("#tool-select-bar .save-text-selection, #canvas-layers-container .save-text-selection").remove(),
        this.height >= 1 && this.width >= 1 || this.width > 0 && !this.height || this.height > 0 && !this.width) {
            ...
            a("#canvas-layers-container .select-helpers").addClass("active"),
            this.that.isApp && a("#select-accept, #select-copy, #select-delete, #select-flip-x, #select-flip-y").show()
        } else
            this.hideSelectTools(),
            this.copyData && a("#select-paste").show()
    }
    ,
    ...
    O.prototype.showStampButton = function() {
        a("#tool-select-bar .selection-disabled, #extra-panel-content .select-tool-toggle").removeClass("disabled"),
        a("#select-size-display").show(),
        this.showToggleButtons(),
        this.that.isExternal || (a("#save-stamp-bar").parent(".submit-menu").css("display", "block"),
        a("#save-stamp-bar, #save-stamp-bar-right").removeClass("hidden-hard"),
        a("#select-size-display").removeClass("hidden-hard"),
        a("#set-brush-tool, #set-brush-bar").removeClass("hidden-hard"),
        a("#set-pattern-tool").removeClass("hidden-hard"),
        a("#select-tools-tool").show(),
        this.copyData || a("#paste-selection-bar, #paste-selection-tool").addClass("disabled"))
    }
    ,
    O.prototype.hideStampButton = function() {
        a("#set-brush-tool, #set-brush-bar").addClass("hidden-hard"),
        a("#set-pattern-tool").addClass("hidden-hard"),
        a("#save-stamp-bar, #save-stamp-bar-right").addClass("hidden-hard"),
        a("#select-tools-tool").hide(),
        a("#tool-select-bar .selection-disabled, #extra-panel-content .select-tool-toggle").addClass("disabled"),
        a("#select-size-display").addClass("hidden-hard"),
        this.copyData && a("#paste-selection-bar, #paste-selection-tool").removeClass("disabled")
    }
    ,
    ...
    O.prototype.deleteSelection = function() {
        var a = this;
        this.status && (this.that.canvas.layer.clear(),
        this.that.canvas.layer.putSimple(this.currentImage, 0, 0),
        this.that.canvas.layer.ctx.clearRect(this.cut_x, this.cut_y, this.cut_width, this.cut_height),
        this.cutImageData && this.that.canvas.layer.putSimple(this.cutImageData, this.cut_x, this.cut_y),
        this.that.ToolController.restore(),
        this.that.LayerController.updateLayer(),
        this.that.FrameController.updateFramePreview(),
        this.that.LayerController.updateLayer(!1, function() {
    ...
    O.prototype.clearCopy = function() {
        this.copyData = !1,
        a("#paste-selection-bar, #paste-selection-tool").addClass("selection-disabled")
    }
    ,
    O.prototype.applyFilter = function(a) {
        var b = this
          , c = a.attr("data-type");
        this.that.canvas.rendering.clear(),
        this.that.canvas.rendering.width = this.secondaryCopyData.width,
        this.that.canvas.rendering.height = this.secondaryCopyData.width,
        this.that.canvas.rendering.putSimple(this.secondaryCopyData.image);
        ...
        switch ("brightness" != c && "contrast" != c || (e >= 50 && (e += 100),
        e < 50 && (e += 50)),
        c) {
        case "brightness":
        ...
        d.data.set(f),
        this.that.canvas.rendering.ctx.putImageData(d, 0, 0),
        this.that.canvas.rendering.image().onload = function() {
            var a = b.copyDataFormat(this, this.width, this.height);
            b.pasteSelection(b.start_x, b.start_y, b.start_x, b.start_y, !0, !0, a),
            b.accept()
        }
    }
    ,
    O.prototype.copyDataFormat = function(a, b, c) {
        ...
        d.width = b,
        d.height = c,
        this.secondaryCopyData = d,
        d
    }
    ,
    O.prototype.copySection = function(b, c, d) {
        return !(!this.hasSelection() && !b) && (this.copyData = {},
        b ? this.copyData = this.copyDataFormat(b, b.width, b.height) : this.copyData = this.copyDataFormat(this.that.canvas.rendering.image(), this.that.canvas.rendering.canvas.width, this.that.canvas.rendering.canvas.height),
        this.that.isApp ? a("#select-paste").show() : a("#paste-selection-bar, #paste-selection-tool").removeClass("selection-disabled"),
        void (c || (d || (this.cutImageData = !1),
        this.that.ToolController.restore(),
        this.that.ToolController.bucketBackgroundPattern())))
    }
    ,
    ...
    O.prototype.setPattern = function() {
        return !!this.hasSelection() && (this.that.stamps.data = this.that.canvas.rendering.image(),
        this.that.ToolController.restore(),
        this.that.ToolController.bucketBackgroundPattern(),
        void (this.that.debug && console.log(this.that.stamps.data)))
    }
    ,
    O.prototype.setBrush = function() {
        return !!this.hasSelection() && (this.that.settings.brush.status = !0,
        this.that.settings.brush.image = this.that.canvas.rendering.image(),
        this.that.settings.brush.width = this.that.canvas.rendering.canvas.width,
        this.that.settings.brush.height = this.that.canvas.rendering.canvas.height,
        this.that.settings.brush.solid = this.that.canvasToSolid(this.that.settings.brush.image),
        this.that.settings.brush.mouse = this.that.canvasToSolid(this.that.settings.brush.image, "#000000", .25),
        this.that.ToolController.setBrushImage(),
        this.that.ToolController.restore(),
        this.that.settings.brush.width <= 50 && this.that.settings.brush.height <= 50 && (this.that.ToolController.addBrushData(this.that.settings.brush.image.src),
        this.that.ToolController.loadCustomBrushes(),
        this.that.ToolController.selectTool(a("#brush-tool"), "Brush")),
        void (this.that.debug && console.log(this.that.settings.brush.image.src)))
    }
    ,
    O.prototype.pasteSelection = function(a, b, c, d, e, f, g) {
        var h = this.that.mouse.x_1
          ...
          , k = g ? g : this.copyData;
        if (this.that.online.status && this.that.LayerController.layers[this.that.LayerController.currentLayer].name != this.that.online.layer_id)
            return void this.that.showAlert(this.that.getResponse("res-online-alert"));
        if (!this.that.popup.open && (k && "Select" != this.that.tool && this.that.useSelectTool(!0, !0),
        k && "Select" == this.that.tool)) {
            this.transform = !1,
            this.currentDeg = 0,
            this.showAcceptButton(),
            this.that.ToolController.restore(),
            this.that.ToolController.tool.currentImage = !1,
            this.that.canvas.rendering.canvas.width = k.width,
            this.that.canvas.rendering.canvas.height = k.height;
            ...
            (this.that.mouse["in"] || this.isApp) && (l = h - 4 - k.width / 2,
            m = i - 4 - k.height / 2),
            (!this.that.mouse["in"] || this.that.isApp) && j > this.that.zoom["default"] && (l = this.that.NavigationController.scroll_x - k.width / 2,
            m = this.that.NavigationController.scroll_y - k.height / 2),
            l = Math.floor(l),
            m = Math.floor(m),
            (a || e) && (l = a),
            (b || e) && (m = b),
            k.width > this.that.width && (l = 0),
            k.height > this.that.height && (m = 0),
            this.that.canvas.rendering.putSimple(k.image, 0, 0);
            var n = this.that.ToolController.tool;
            n.selectCanvasLocation && (n.selectCanvasLocation.default_x = c ? c : -99999999,
            n.selectCanvasLocation.default_y = d ? d : -99999999),
            e && (n.selectCanvasLocation.default_x = c,
            n.selectCanvasLocation.default_y = d),
            n.selectCanvasLocation.x = l,
            n.selectCanvasLocation.y = m,
            this.start_drag_x = l,
            this.start_drag_y = m,
            this.end_drag_x = l + k.width,
            this.end_drag_y = m + k.height,
            n.selectCanvasLocation.width = k.width,
            n.selectCanvasLocation.height = k.height,
            this.status = !0,
            n.selectCanvasLocation.active = !0,
            n.currentImage = this.that.canvas.layer.image(),
            n.renderSelectedArea(),
            this.status = !0,
            n.selectCanvasLocation.image = this.that.canvas.rendering.image(),
            this.secondaryCopyData = this.copyDataFormat(n.selectCanvasLocation.image, k.width, k.height),
            this.that.canvas.layer.putSimple(this.that.canvas.rendering.canvas, l, m),
            this.that.render(),
            this.setCordinates(k.width, k.height),
            this.showStampButton(),
            this.drag_width = k.width,
            this.drag_height = k.height,
            this.that.ToolController.renderChange = !0,
            f || this.that.HistoryController.create()
        }
    }
    ,
    ...
    O.prototype.flipTop = function() {
        if (this.status) {
            ...
            a.onload = function() {
                ...
                c.width;
                b.that.canvas.rendering.clear(),
                b.that.canvas.rendering.ctx.save(),
                b.that.canvas.rendering.ctx.scale(1, -1),
                b.that.canvas.rendering.ctx.drawImage(a, 0, -d),
                b.that.canvas.rendering.ctx.restore(),
                b.currentSizeImageLoaded = !1,
                b.currentSizeImage = !1,
                b.currentSelectImage = !1,
                b.that.ToolController.tool.selectCanvasLocation.active = !0,
                b.that.ToolController.tool.updateSelection(),
                b.that.render()
            }
        }
    ...
    O.prototype.flipRight = function() {
        if ("Select" == this.that.tool && this.status) {
            ...
            a.onload = function() {
                ...
                b.that.canvas.rendering.ctx.save(),
                b.that.canvas.rendering.ctx.scale(-1, 1),
                b.that.canvas.rendering.ctx.drawImage(this, -c, 0),
                b.that.canvas.rendering.ctx.restore(),
                b.currentSizeImageLoaded = !1,
                b.currentSizeImage = !1,
                b.currentSelectImage = !1,
        ...
        if ("Select" == this.that.tool && this.status) {
            ...
            b.onload = function() {
                var b = c.that.canvas.rendering.canvas.height
                  ...
                  , e = [];
                c.that.canvas.rendering.clear(),
                c.that.canvas.rendering.ctx.translate(d, 0),
                c.that.canvas.rendering.ctx.scale(-1, 1),
                c.that.canvas.rendering.ctx.drawImage(this, 0, 0);
                for (var f = c.that.canvas.rendering.ctx.getImageData(0, 0, this.width, this.height), g = 0, h = 0, i = 0; i < f.data.length; i += 4) {
                    ...
                    f.data[i + 3] > 0 && m && (j[0] = rgbaColor.r,
                    j[1] = rgbaColor.g,
                    j[2] = rgbaColor.b);
                    var k = {
                        x: g,
                ...
                if (c.that.canvas.rendering.clear(),
                c.that.canvas.rendering.canvas.height = d,
                c.that.canvas.rendering.canvas.width = b,
                "left" == a)
                ...
                c.that.ToolController.tool.selectCanvasLocation.active = !0,
                c.that.ToolController.tool.updateSelection(),
                c.that.ToolController.tool.updateSelectCanvasArea(c.that.canvas.rendering.canvas.width, c.that.canvas.rendering.canvas.height),
                c.that.render(),
                c.transform = !0,
                c.currentSizeImage = c.that.canvas.rendering.image()
            }
        }
    }
    ,
    ...
    P.prototype.listeners = function() {
        ...
        a(document).keydown(function(a) {
            !b.that.settings.disableKeybinds && b.that.canKey && (b.that.preventShortcut || a.preventDefault(),
            a.shiftKey && (b.that.keys.shift = !0),
            (a.ctrlKey || a.metaKey) && (b.that.keys.ctrl = !0),
            b.that.keyEvent = a,
            (a.ctrlKey || a.metaKey) && 90 == a.keyCode && b.that.HistoryController.doUndo(),
            (a.ctrlKey || a.metaKey) && 89 == a.keyCode && b.that.HistoryController.doRedo(),
            (a.ctrlKey || a.metaKey) && a.shiftKey && 83 == a.keyCode && b.that.ExportImportController["export"](),
            (a.ctrlKey || a.metaKey) && 79 == a.keyCode && b.that.ExportImportController.open())
        }),
    ...
    var Q = function(b) {
        this.that = b,
        this.status = !1,
        this.customTextName = "ptx",
        this.customTextSettingsName = "ptxs",
        this.customTextData = {},
        this.canAssignLetter = !1,
        this.tabletStart = 0,
        this.fontsSelectionCache = a("#fonts-selection"),
        this.customTextSettings = {
            height: 10,
            spacing: 2
        },
        this.loadedFonts = !1,
        this.fontSelectionOpen = !1,
        this.imagePreviews = {},
        this.popupHtmlData = !1,
        this.customFont = !1,
    ...
    Q.prototype.init = function() {
        this.listeners(),
        this.loadCustomTextInfo(),
        this.popupHtmlData = a(".custom-text-information").html(),
        a(".custom-text-information").remove(),
        this.popupTextHtmlData = a(".select-text-information").html(),
        a(".select-text-information").remove(),
        this.loadCustomData()
    }
    ,
    Q.prototype.loadCustom = function() {
        this.loadCustomData(),
        this.that.textData.custom = this.customFont
    }
    ,
    Q.prototype.showPopup = function(a, b) {
        this.that.showPopup(a, b),
        this.loadPopupData()
    }
    ,
    Q.prototype.getImageFromCanvas = function() {
        var a = this.that.canvas.rendering.image();
        this.currentImageData.image = a.src,
        this.currentImageData.height = a.height,
        this.currentImageData.spacing = parseInt(a.width) + 1
    }
    ,
    Q.prototype.listeners = function() {
        var b = this;
        a(document, "#tablet-text-keyboard").on("keydown", function(a) {
            "Text" == b.that.tool && (32 == a.keyCode && a.target == document.body && a.preventDefault(),
            8 === a.which && a.preventDefault(),
            b.that.ToolController["do"]("use", a))
        }),
        a(".show-font-settings").click(function() {
            b.showPopup("custom-text", b.popupHtmlData)
        }),
        a(".save-text-selection").click(function() {
            return !!b.that.SelectController.hasSelection() && (b.canAssignLetter = !0,
            b.showPopup("new-letter", b.popupTextHtmlData),
            void b.getImageFromCanvas())
        }),
        ...
        a("#tool-option-appended, #extra-panel-content").on("pointerdown", ".preview-font", function() {
            ...
            a("#text-selection-images .preview-font, #fonts-toolbar-options .preview-font").removeClass("active"),
            a(".font-" + d).addClass("active"),
            b.selection(c.attr("data-option")),
            b.checkFontSelectionOpen(!1, !0)
        }),
        a("#tool-option-appended").on("click", "#fonts-toolbar-options", function(c) {
            var d = a(this);
            d.hasClass("active") || (d.addClass("active"),
            b.fontSelectionOpen = !0)
        })
    }
    ,
    Q.prototype.checkFontSelectionOpen = function(b, c) {
        (c || this.fontSelectionOpen && !a(b.target).parents("#fonts-toolbar-options").length) && (a("#fonts-toolbar-options").removeClass("active"),
        this.fontSelectionOpen = !1)
    }
    ,
        ...
        if (b) {
            ...
            var e = function() {
                if (!(a.tabletStart > b.length - 1)) {
                    ...
                    c.test(f) && (g = "s" + g),
                    a.that.ToolController.tool.use(!1, g, function() {
                        a.tabletStart++,
                        e()
                    })
                }
    ...
    Q.prototype.selection = function(a) {
        this.that.textData.current = a,
        this.that.ToolController.tool.on()
    }
    ,
    Q.prototype.appendPreviews = function(b) {
        var c = this;
        a("#text-selection-images").html(""),
        a.each(this.that.textData, function(b, d) {
            var e = "";
            if (d.preview) {
    ...
    ,
    Q.prototype.loadFonts = function() {}
    ,
    Q.prototype.loadPopupData = function() {
        var b = this;
        a(".text-settings-height").val(this.customTextSettings.height),
        a(".text-settings-spacing").val(this.customTextSettings.spacing);
        var c = "";
    ...
    Q.prototype.fetchKeys = function() {
        this.loadKeys() || (this.customTextData = this.createKeys(),
        this.that.putStorage(this.customTextName, this.customTextData))
    }
    ,
    Q.prototype.loadKeys = function() {
        var a = this.that.getStorage(this.customTextName);
        return !(!a || "" == a.trim()) && (a = this.that.replaceAll(a, "--.--", ";"),
        this.customTextData = JSON.parse(a),
        !0)
    }
    ,
    Q.prototype.loadSettings = function() {
        var a = this.that.getStorage(this.customTextSettingsName);
        a ? (a = this.that.replaceAll(a, "--.--", ";"),
        this.customTextSettings = JSON.parse(a)) : this.that.putStorage(this.customTextSettingsName, this.customTextSettings)
    }
    ,
    Q.prototype.updateSettings = function() {
        this.customTextSettings.height = a(".text-settings-height").val(),
        this.customTextSettings.spacing = a(".text-settings-spacing").val(),
        this.that.textData.custom.height = this.customTextSettings.height,
        this.that.putStorage(this.customTextSettingsName, this.customTextSettings)
    }
    ,
    Q.prototype.updateKey = function(b) {
        this.canAssignLetter && (this.saveKey(b, this.currentImageData),
        a(".kimg-" + b).html(this.getImage(this.currentImageData.image)))
    }
    ,
    Q.prototype.saveKey = function(a, b) {
        this.that.fileDrawing || ("undefined" == typeof this.that.textData.custom[a] && this.loadCustomData(),
        this.that.textData.custom[a].image = b.image,
        this.that.textData.custom[a].spacing = b.spacing,
        this.customTextData[a].image = b.image,
        this.customTextData[a].spacing = b.spacing,
        this.that.putStorage(this.customTextName, this.customTextData))
    }
    ,
    ...
    Q.prototype.loadCustomData = function(b) {
        var c = (this.customTextData,
        this.customTextSettings.height)
        ...
        this.customFont = f,
        this.that.textData.custom = this.customFont,
        this.that.textData.custom.preview = e,
        b)
            return f
    }
    ,
    ...
    var R = function(a) {
        ...
        this.loaded = !1,
        this.html = "",
        this.cookieName = this.that.settings.name,
        this.maxDownloadSize = 100,
        this.iconSets = {
            "default": {
                name: "Default",
    ...
    R.prototype.init = function() {
        this.listeners(),
        this.createIconSelects(),
        this.html = a(".settings-information").html(),
        a(".settings-information").remove()
    }
    ,
    ...
    ,
    R.prototype.checkCurrentSettings = function() {}
    ,
    R.prototype.loadIconSet = function() {
        var b = this.iconSets[this.that.settings.theme.icons];
        b && (a(".icon-tool").css("background-image", "url(" + b.src + ")"),
        a(".icon-set").removeClass("s").removeClass("ml"),
        32 == b.size && a(".icon-set").addClass("s"),
        24 == b.size && a(".icon-set").addClass("ml"))
    }
    ,
    ...
    R.prototype.changeIconSet = function(a) {
        this.that.settings.theme.icons = a,
        this.loadIconSet(),
        this.that.updateSettings()
    }
    ,
    R.prototype.load = function() {
        this.that.isApp && a(".ons-switch").removeAttr("checked"),
        a(".grid-sect").show(),
        this.that.grid.show || a(".grid-sect").hide(),
        this.that.backgroundImage.init && (a(".background-size-switch").removeClass("d-none"),
        a(".background-size-switch").val(this.that.backgroundImage.size)),
        this.that.grid.status && (a(".grid-sect").show(),
        a("#grid-toggle").prop("checked", !0),
        ...
        this.that.rainbow.status && (a("#rainbow-toggle").prop("checked", !0),
        ...
        this.that.settings.mouseIcons && a("#mouse-icons-toggle").prop("checked", !0),
        ...
        this.that.settings.disableKeybinds && a("#disable-keybinds-toggle").prop("checked", !0),
    ...
    R.prototype.listeners = function() {
        ...
        a("#rounded-toggle").change(function() {
            b.that.settings.roundedPixel = !b.that.settings.roundedPixel,
            b.that.updateSettings()
        }),
        a(".s-a-lt").click(function(c) {
            c.preventDefault(),
            b.changeAdLayout(a(this).attr("data-type"))
        }),
        ...
        a("#popup-container").on("click", ".background-toggle", function() {
            b.loaded && (b.that.backgroundImage.status = !1,
            a(this).is(":checked") ? (b.that.backgroundImage.status = !0,
            b.that.tracing(),
            a(".background-toggle").prop("checked", !0)) : (b.that.tracing(),
            a(".background-toggle").prop("checked", !1).removeAttr("checked")))
        }),
        a("#popup-container").on("click", ".checker-toggle", function() {
            b.loaded && (b.that.checker.status = !1,
            a(this).is(":checked") || a(this).find(".switch__input").is(":checked") ? (b.that.checker.status = !0,
            a(".checker-toggle").prop("checked", !0)) : a(".checker-toggle").prop("checked", !1).removeAttr("checked"),
            b.that.render())
        }),
        a("#grid-icon-toggle").click(function() {
            b.that.grid.status = !b.that.grid.status,
            b.that.toggleGridIcon()
        })),
        a(".download-toggle").click(function(c) {
            c.preventDefault(),
            b.that.showPopup("download", a("#download-information").html()),
            b.that.PopupController.updateElements(),
            b.load()
        }),
        ...
        a("#popup-container").on("click", ".grid-toggle", function() {
            (b.loaded || b.that.isApp) && (b.that.grid.status = !1,
            a(this).is(":checked") || a(this).find(".switch__input").is(":checked") ? (b.that.grid.status = !0,
            a(".grid-toggle").prop("checked", !0)) : a(".grid-toggle").prop("checked", !1).removeAttr("checked"),
            b.that.toggleGridIcon(),
            b.that.render(!0))
        }),
        a("#popup-container").on("click", ".autosave-toggle", function() {
            b.loaded && !b.that.fileDrawing && (b.that.autosave.status = !1,
            a(this).is(":checked") ? (b.that.autosave.status = !0,
            a(".autosave-toggle").prop("checked", !0),
            b.that.startAutoSave()) : (a(".autosave-toggle").prop("checked", !1).removeAttr("checked"),
            b.that.stopAutoSave()))
        }),
        a("#popup-container").on("click", ".onion-toggle", function() {
            b.loaded && (b.that.onionSkin.status = !1,
            a(this).is(":checked") ? (b.that.onionSkin.status = !0,
            a(".onion-toggle").prop("checked", !0)) : a(".onion-toggle").prop("checked", !1).removeAttr("checked"),
            b.that.render())
        }),
        a("#popup-container").on("click", ".onion-toggle-top", function() {
            b.loaded && (b.that.onionSkin.top_status = !1,
            a(this).is(":checked") ? (b.that.onionSkin.top_status = !0,
            a(".onion-toggle-top").prop("checked", !0)) : a(".onion-toggle-top").prop("checked", !1).removeAttr("checked"),
            b.that.render())
        }),
        a("#popup-container, #right-sidebar").on("click", ".perfect-toggle", function() {
            (b.loaded || a(this).attr("data-force")) && (b.that.pixelPerfect.status = !1,
            a(this).is(":checked") || a(this).find(".switch__input").is(":checked") ? (b.that.pixelPerfect.status = !0,
            a(".perfect-toggle, #op-perfect").prop("checked", !0)) : a(".perfect-toggle, #op-perfect").prop("checked", !1).removeAttr("checked"),
            b.that.render())
        }),
        a("#popup-container, #right-sidebar").on("click", ".random-color-toggle", function() {
            (b.loaded || a(this).attr("data-force")) && (b.that.randomColor.status = !1,
            a(".random-toggle-option").removeClass("active"),
            a(this).is(":checked") || a(this).find(".switch__input").is(":checked") ? (b.that.randomColor.status = !0,
            a(".random-color-toggle").prop("checked", !0),
        ...
        a("#popup-container").on("click", ".canvas-zoom-toggle", function() {
            (b.loaded || a(this).attr("data-force")) && (b.that.settings.canvasZoomDefault = !1,
            a(this).is(":checked") ? (b.that.settings.canvasZoomDefault = !0,
            a(".canvas-zoom-toggle").prop("checked", !0)) : a(".canvas-zoom-toggle").prop("checked", !1).removeAttr("checked"),
            b.toggleCanvasZoom())
        }),
        a("#popup-container, #right-sidebar").on("click", ".rainbow-toggle", function() {
            (b.loaded || a(this).attr("data-force")) && (b.that.rainbow.status = !1,
            a(".rainbow-toggle-option").removeClass("active"),
            a(this).is(":checked") || a(this).find(".switch__input").is(":checked") ? (b.that.rainbow.status = !0,
            a(".rainbow-toggle").prop("checked", !0),
            a(".rainbow-toggle-option").addClass("active")) : a(".rainbow-toggle").prop("checked", !1).removeAttr("checked"))
        }),
        ...
        a("#popup-container, #right-sidebar").on("click", ".dithering-toggle", function() {
            (b.loaded || a(this).attr("data-force")) && (b.that.settings.dithering = !1,
            a(".dithering-toggle-option").removeClass("active"),
            a(this).is(":checked") ? (b.that.settings.dithering = !0,
            a(".dithering-toggle").prop("checked", !0),
            a(".dithering-toggle-option").addClass("active")) : a(".dithering-toggle").prop("checked", !1).removeAttr("checked"))
        }),
        a("#popup-container").on("click", "#download-submit-toggle", function() {
            b.that.settings.disableDownloadSubmit = !1,
            a(this).is(":checked") ? b.that.settings.disableDownloadSubmit = !0 : a("#download-submit-toggle").prop("checked", !1).removeAttr("checked"),
            b.that.updateSettings()
        }),
        a("#popup-container").on("click", "#mouse-icons-toggle", function() {
            b.that.settings.mouseIcons = !1,
            a(this).is(":checked") ? b.that.settings.mouseIcons = !0 : a("#mouse-icons-toggle").prop("checked", !1).removeAttr("checked"),
            b.toggleMouseIcons(),
            b.that.updateSettings()
        }),
        a("#popup-container").on("click", "#disable-keybinds-toggle", function() {
            b.that.settings.disableKeybinds = !1,
            a(this).is(":checked") ? b.that.settings.disableKeybinds = !0 : a("#disable-keybinds-toggle").prop("checked", !1).removeAttr("checked"),
            b.toggleKeybinds()
        }),
        a("#popup-container").on("click", "#disable-scroll-zoom-toggle", function() {
            b.that.settings.disableScrollZoom = !1,
            a(this).is(":checked") ? b.that.settings.disableScrollZoom = !0 : a("#disable-scroll-zoom-toggle").prop("checked", !1).removeAttr("checked"),
            b.that.updateSettings()
        }),
        a("#right-sidebar").on("click", ".iso-lines-toggle", function() {
            b.that.settings.isoLines = !1,
            a(this).is(":checked") || a(this).find(".switch__input").is(":checked") ? (b.that.settings.isoLines = !0,
            a(".iso-lines-toggle, #op-iso").prop("checked", !0)) : a(".iso-lines-toggle, #op-iso").prop("checked", !1).removeAttr("checked")
        }),
        a("#popup-container, #frames-placement").on("click", "#frames-lock-toggle", function() {
            b.that.settings.lockFrames = !1,
            a(this).is(":checked") ? (b.that.settings.lockFrames = !0,
            a("#frames-lock-toggle").prop("checked", !0)) : a("#frames-lock-toggle").prop("checked", !1).removeAttr("checked"),
            b.toggleLockedFrames()
        }),
        a("#popup-container").on("click", "#lighter-toggle", function() {
            a(this).is(":checked") ? a("#lighter-toggle").prop("checked", !0) : a("#lighter-toggle").prop("checked", !1).removeAttr("checked"),
            b.toggleLighterTheme()
        }),
        a("#zoom-out-toggle").click(function() {
            b.that.settings.zoomUnlock = !b.that.settings.zoomUnlock,
            b.toggleZoomLock(!0)
        }),
        a("#popup-container").on("input", "#download-range, .ratio-download", function() {
            var c = a(this).val();
            c <= 0 && (c = 1),
            b.changeRation(a(this).attr("data-alt"), c)
        }),
    ...
    R.prototype.closePanel = function(b, c) {
        ...
        this.that.isApp || (a("." + d).removeClass("dragable").removeClass("fixed"),
        a("." + d).css({
            position: "static",
            width: "100%"
        }),
        a("." + d + "-tab").show(),
        a("." + d + "-content").removeClass("force"))
    }
    ,
    R.prototype.expandPanel = function(b, c) {
        if (c)
            ...
            var d = b.attr("data-for");
        if (!this.that.isApp) {
            if (a("." + d).hasClass("dragable"))
                return this.closePanel(!1, d);
            a("." + d).addClass("dragable fixed"),
            a("." + d).css({
                position: "fixed"
            }),
            a("." + d + "-tab").hide(),
            ...
            var e = a("." + d).position();
            e.left < 0 || e.top < 50,
            a("." + d + "-content").addClass("force"),
            b && !b.attr("data-ig") && a(".sidebar-preview-tab")[0].click()
        }
    }
    ,
    ...
    R.prototype.loadCssGrid = function(b, c) {
        ...
        e.show(),
        this.that.ZoomController.zoom = this.that.round(this.that.ZoomController.zoom, .5, "up");
        this.that.pixel_size * this.that.ZoomController.zoom;
        this.that.settings.grid = this.that.grid.status,
        this.that.grid.status ? this.that.createGrid("grid", function() {
            d.that.ZoomController.end()
        }) : e.hide(),
        c && this.that.updateSettings()
    }
    ,
    R.prototype.changeAdLayout = function(a) {
        this.that.settings.ad.placement = a,
        this.that.ads.placement = a,
        this.that.initFreestar(),
        this.that.updateSettings()
    }
    ,
    R.prototype.togglePersLayers = function(b) {
        this.that.settings.persLayers && (this.that.settings.persLayers = b),
        this.that.settings.persLayers ? a("#layer-lepard").show() : (a("#pers-toggle, #pers-toggle-def").prop("checked", !1),
        a("#layer-lepard").hide(),
        localStorage.setItem("new_draw_per", this.that.settings.persLayers))
    }
    ,
    R.prototype.toggleZoomLock = function(b) {
        this.that.settings.zoomUnlock ? a("#zoom-out-toggle").addClass("dis") : (a("#zoom-out-toggle").removeClass("dis"),
        this.that.ZoomController.zoom < this.that.ZoomController.minZoom && this.that.ZoomController.reset(!0)),
        b && this.that.updateSettings()
    }
    ,
    ...
    R.prototype.toggleLockedFrames = function(b) {
        ...
        if (this.that.settings.lockFrames) {
            c = 25,
            a("#frames-placement").addClass("locked");
            var e = a("#frames-placement").height();
            d && (e += d);
            var f = "calc(100% - " + e + "px)";
            a("#drawing-canvas-conatiner").height(f),
            a("body").addClass("frame-locked")
        } else
            a("#frames-placement").removeClass("locked"),
            a("#drawing-canvas-conatiner").removeAttr("style"),
            a("#frames-container").hide(),
            a("body").removeClass("frame-locked");
        this.that.repositionScreen(c),
        this.that.updateSettings()
    }
    ,
    R.prototype.toggleCanvasZoom = function() {
        this.that.createCookie("pixil-canvas-zoom", this.that.settings.canvasZoomDefault),
        location.reload()
    }
    ,
    R.prototype.toggleLighterTheme = function() {
        this.that.settings.theme.lighter = !this.that.settings.theme.lighter,
        this.that.changeTheme(),
        this.that.updateSettings()
    }
    ,
    ...
    R.prototype.toggleDithering = function(b) {
        this.that.settings.dithering ? (this.that.settings.dithering = !1,
        a(".dithering-toggle").prop("checked", !1).removeAttr("checked")) : (this.that.settings.dithering = !0,
        a(".dithering-toggle").prop("checked", !0))
    }
    ,
    R.prototype.promptPattern = function() {
        var a = prompt("Background Generator", "");
        a && (this.that.runGenerator(a),
        this.that.HistoryController.create())
    }
    ,
    R.prototype.loadDownloadSelect = function() {
        ...
        this.maxDownloadSize = Math.floor(c / d),
        a("#download-range").attr("max", this.maxDownloadSize),
        this.maxDownloadSize < this.that.downloadSizes.frame && b.changeRation(!1, 1)
    }
    ,
    R.prototype.loadSelectOnInput = function(a) {}
    ,
    R.prototype.downloadSizeLimit = function(a) {
        return parseInt(a)
    }
    ,
    R.prototype.changeRation = function(b, c) {
        this.that.downloadSizes.frame = this.downloadSizeLimit(c),
        this.that.downloadSizes.layer = this.downloadSizeLimit(c),
        this.that.downloadSizes.gif = this.downloadSizeLimit(c),
        c = parseInt(c),
        c > this.maxDownloadSize && (c = this.maxDownloadSize);
        var d = this.that.width * parseInt(c)
          , e = this.that.height * parseInt(c);
        d = Math.round(d),
        e = Math.round(e),
        a(".download-width").text(d),
        a(".download-height").text(e),
        a(".ratio-download").val(c),
        a("#download-range").val(c)
    }
    ,
    ...
    R.prototype.showPopup = function(a) {
        this.that.showPopup(a, this.html),
        this.that.PopupController.updateElements(),
        this.that.online.status && this.that.OnlineController.removeElements()
    }
    ,
    R.prototype.showBackround = function(b) {
        this.that.backgroundImage.init = !0,
        a(".background-size-switch").removeClass("d-none"),
        this.that.tracing()
    }
    ,
            ...
            d.onload = function(c) {
                b.that.loadImage(c.target.result, function(c) {
                    ...
                    b.that.createCanvas("extended", e.width, e.height, function() {
                        b.that.canvas.extended.putSimple(d, 0, 0, e.width, e.height),
                        b.that.backgroundImage.image = b.that.canvas.extended.dataURL(),
                        b.showBackround(a),
                        b.that.canvas.extended.destroy()
                    })
                })
    ...
    S.prototype.active = function(b) {
        return this.that.LayerController.checkPreConditions() ? void (this.canRestore = !1) : (this.canRestore = !0,
        this.currentImage || (this.currentImage = this.that.canvas.layer.image(),
        this.imageData = this.that.canvas.layer.ctx.getImageData(0, 0, this.that.width, this.that.height),
    ...
    S.prototype.changeColor = function(a) {
        for (var b, c, d, e, f, g = new Uint8ClampedArray(this.imageData.data), h = g, i = h.length, j = 0; j < i; j += 4) {
            ...
            c = h[j + 1],
            d = h[j + 2],
            e = this.that.RGBtoHSV(b, c, d);
            var k = 360 * e.h;
            k = parseInt(k) + parseInt(a),
            parseInt(k) > 360 && (k -= 360),
            parseInt(k) < 0 && (k = Math.abs(k)),
            e.h = k / 360,
            f = this.that.HSVtoRGB(e.h, e.s, e.v),
            h[j] = f.r,
            h[j + 1] = f.g,
            h[j + 2] = f.b
        }
        this.imageDataClone.data.set(g),
        this.that.canvas.layer.ctx.putImageData(this.imageDataClone, 0, 0),
        this.that.render(),
        g = null,
        h = null
    }
    ...
    S.prototype.restore = function(b) {
        ...
        this.currentImage = !1,
        this.imageData = !1,
        this.canRestore && (this.that.LayerController.updateLayer(),
        this.that.LayerController.updateLayer(!1, function() {
            c.that.FrameController.updateFramePreview(),
            c.that.HistoryController.create(),
            c.that.ToolController.restore(),
            c.that.OnlineController.writeLayer()
        }))
    }
    ;
    var T = function(a) {
        ...
        this.html = "",
        this.start = !1,
        this.filters = ["popular", "new", "yours", "emojis", "badges", "approve", "favorite", "private"],
        this.filter = "new",
        this.page = 1,
        this.search = "",
        this.processingNewStamp = !1,
        this.processingFetchStamp = !1
    };
    T.prototype.init = function() {
        this.that.isApp || (this.listerners(),
        this.html = a(".save-stamp").html(),
        a(".save-stamp").remove())
    }
    ,
    ...
    T.prototype.scrollHide = function() {
        var b = a(".stamps-preview-wrapper").height()
          ...
          , e = c + b;
        a(".stamp-pre").addClass("hide-img"),
        a(".stamp-pre").each(function() {
            var b = a(this)
              , f = b.position()
              , g = f.top - d
              , h = (f.top - d,
    ...
    T.prototype.renderData = function(a, b) {
        this.that.canvas.rendering.canvas.width = a.width,
        this.that.canvas.rendering.canvas.height = a.height,
        this.that.canvas.rendering.putSimple(a);
    ...
    T.prototype.appendCopyData = function(a, b) {
        var c = this;
        this.that.stamps.data = a,
        this.that.SelectController.currentSelectImage = !1,
        b ? (this.that.SelectController.copySection(a),
        this.that.SelectController.cut_width = 0,
        this.that.SelectController.cut_height = 0,
        this.that.useSelectTool(this.that.isApp)) : a.onload = function() {
            c.that.SelectController.copySection(this),
            c.that.SelectController.cut_width = 0,
            c.that.SelectController.cut_height = 0,
            c.that.useSelectTool()
        }
    }
    ,
    T.prototype.useSelectTool = function() {}
    ,
    T.prototype.preRenderData = function(b, c) {
        if (this.that.online.status && this.that.LayerController.layers[this.that.LayerController.currentLayer].name != this.that.online.layer_id)
            return void this.that.showAlert(this.that.messages("online_layer"));
        if (this.that.LayerController.layers[this.that.LayerController.currentLayer].options.locked)
            return void this.that.showAlert(this.that.messages("layer_locked"));
        ...
        this.debug && (g = ""),
        e ? (d = e,
        this.that.loadImage(d, function(a) {
            f.renderData(a, b)
        }),
    ...
    T.prototype.selectFilter = function(b) {
        ...
        this.filters.indexOf(c) !== -1) {
            if (a(".stamp-filter-btn").removeClass("active"),
            b.addClass("active"),
            "favorite" == c && !this.that.isAuth || "yours" == c && !this.that.isAuth)
                return this.clearStampWrapper(),
                a(".stamp-show-more").hide(),
                a(".append-stamps-preview").html("<div style='color:white;text-align:center' class='mgbtm'>You need to be logged in.</div>");
            a(".stamp-show-more").show(),
            this.filter = c,
            this.page = 1,
            this.clearStampWrapper(),
            this.getStamps()
        }
    }
    ,
    ...
    T.prototype.updateButtons = function() {
        a(".stamp-btn-next").show(),
        a(".stamp-btn-back-container").hide(),
        this.page >= 2 && a(".stamp-btn-back-container").show()
    }
    ,
    ...
    T.prototype.putRenderingCanvasData = function(b) {
        ...
        if (this.that.isWindowsIE) {
            ...
            this.that.getDrawnPixels(function(d, e, f, g, h, i, j) {
                if (!(e <= 1 || f <= 1)) {
                    c.that.canvas.data.clear(),
                    c.that.canvas.data.canvas.width = e,
                    c.that.canvas.data.canvas.height = f,
                    c.that.canvas.data.ctx.putImageData(d, -g, -h),
                    b && c.that.showPopup("stamp", c.html);
                    var k = c.that.canvas.data.image();
                    k.onload = function() {
                        if (a("#popup-container .stamp-data-preview").attr("src", k.src),
                        a("#popup-container .hidden-base-image").val(k.src),
                        b)
                            return b()
                    }
                }
    ...
    T.prototype.showError = function(b) {
        a("#error-stamp").show(),
        a("#error-stamp .error-message-stamp").text(b)
    }
    ,
    T.prototype.hideError = function() {
        a("#error-stamp").hide(),
        a("#error-stamp .error-message-stamp").text("")
    }
    ,
    T.prototype.favoriteStamp = function(b) {
        var c = b.attr("data-id")
          , d = this;
        if (b.hasClass("active") ? b.removeClass("active") : b.addClass("active"),
        !this.favoriteStampRequest) {
    ...
    T.prototype.getStamps = function(b) {
        "back" == b ? this.page-- : "next" == b && this.page++,
        ...
        var c = a(".append-stamps-preview .selectable-stamp:last .stamp-pre-image").attr("data-id")
          ...
          , f = this;
        if (a(".append-stamps-preview").addClass("loading"),
        !this.processingFetchStamp)
            return this.processingFetchStamp = !0,
            this.showAppendLoader(),
            this.hideShowMoreStampsButton(),
            a.ajax({
                type: "GET",
                url: "/stamp",
                data: e,
                ...
                contentType: !1,
                success: function(b) {
                    a(".append-stamps-preview").removeClass("loading"),
                    f.appendStamps(b.data, b.permission),
                    f.hideAppendLoader(),
                    b.data.length >= 1 && f.updateButtons(),
                    (!b.data.length || b.data.length < 30) && f.hideNextButton()
                },
                fail: function() {
                    a(".append-stamps-preview").removeClass("loading"),
                    a(".loading-container").html(f.that.getResponse("res-stamps-error"))
                },
                error: function() {
                    a(".append-stamps-preview").removeClass("loading"),
                    a(".loading-container").html(f.that.getResponse("res-stamps-error"))
    ...
    T.prototype.newStamp = function(b) {
        ...
        return d.append("fname", "stamp.txt"),
        d.append("is_new", "1"),
        d.append("file", f),
        this.that.fileDrawing ? (this.that.FileController.showFileAlert(),
        !1) : this.that.validateImageData(e) && d && !this.processingNewStamp ? (this.hideError(),
        this.disableSubmit(),
        this.processingNewStamp = !0,
        a.ajax({
            type: "POST",
            url: "/stamp",
            data: d,
            ...
            fail: function(a) {
                c.finishNewStamp(),
                c.showError(a.responseJSON.message)
            },
            error: function(a) {
                c.finishNewStamp(),
                c.showError(a.responseJSON.message)
    ...
    ,
    U.prototype.tab = function(a, b) {}
    ,
    U.prototype.updateElements = function() {
        var b = this;
    ...
    ,
    V.prototype.finishedLoad = function() {
        this.that.canvas.rendering["default"](),
        this.callback ? (this.callback(),
        this.callback = !1) : this.that.ready()
    }
    ,
    V.prototype.load = function(b, c) {
        ...
        d.load(function() {
            var a = d.get_current_frame(0).data
              , b = [];
            e.that.canvas.rendering.canvas.width = a.width,
            e.that.canvas.rendering.canvas.height = a.height,
            e.that.FrameController.frames = [];
            for (var c = 0; c < d.get_length(); c++)
                b.push(d.get_current_frame(c)),
                d.get_length() == b.length && e.processData(b)
        })
    }
    ,
    ...
    V.prototype.processData = function(a, b) {
        for (var c = this, d = 100, e = null, f = !1, g = !0, h = [], i = 0; i < a.length; i++) {
            ...
            "object" != typeof e)
                return;
            b ? (c.that.canvas.rendering.clear(),
            c.that.canvas.rendering.putImageData(e)) : c.that.canvas.rendering.ctx.putImageData(e, 0, 0, 0, 0, e.width, e.height),
            f = {
            ...
            c.that.resizeImage(f, c.that.edit.resize, function(b, d) {
                ...
                b.onload = function() {
                    h.push(i),
                    g ? (c.that.FrameController["new"](!0, this.speed, b, !0, !0),
                    g = !1) : c.that.FrameController["new"](!0, this.speed, b, !0),
                    c.that.canvas.layer.putSimple(b),
                    a.length == h.length && c.finishedLoad()
                }
            })
        }
    }
                ...
                var f = 0
                  , g = function() {
                    ...
                    i.onload = function() {
                        ...
                        b.length !== a.length || e ? (f++,
                        g()) : d.that.arrangeImages(b, function(a) {
                            d.useGif(a, c)
                        })
                    }
                    ,
        ...
        this.that.FrameController.flattenAll(a, 1, function(a) {
            var f = d.that.width * b
              ...
              , i = function() {
                ...
                j.data_id = b.data_id,
                j.onload = function() {
                    return d.that.canvas.data.clear(),
                    d.that.canvas.data.canvas.width = f,
                    d.that.canvas.data.canvas.height = g,
                    d.that.canvas.data.setSmoothing(),
                    d.that.canvas.data.clear(),
                    d.that.canvas.data.putSimple(this, 0, 0, f, g),
                    e.push({
                        src: d.that.canvas.data.dataURL(),
                        speed: this.speed,
                        data_id: this.data_id
                    }),
                    e.length == a.length ? c(e) : (h++,
                    void i())
                }
                ,
                j.src = b.src
    ...
    ,
    V.prototype.useGif = function(b, c) {
        var d = "/js/dist/gif.worker.js";
        a(".gif-loader").show(),
        this.that.isApp && (d = "/static/js/gif.worker.js");
        var e = new GIF({
            workers: 2,
            quality: 10,
            workerScript: d
        ...
        e.on("progress", function(b) {
            ...
            a("#popup-container .download-btn").prop("disabled", !0)
        }),
        e.on("finished", function(b) {
            return a("#popup-container .download-btn").prop("disabled", !1),
            a(".gif-loader").hide(),
            c(b)
        }),
        e.render()
    ...
    var W = function(a) {
        ...
        this.importing = !1,
        this.resizeImport = !1,
        this.importExportSecretString = "p98kjasdnasd983/24kasdjasd",
        this.importExportrandomStringPlacement = "/sfR5H8Fkddasdmnacvx/",
        this.importExportIsPhotoUpload = "/8745jkhasdASD945kjknhj/"
    };
    ...
    W.prototype.listeners = function() {
        ...
        a("#drawing-wrapper").on("click", "#import-gallery .a-base-thumb", function(c) {
            ...
            return b.importing = !0,
            b.fromGallery = !0,
            d ? void b.fromURL(d) : void console.log("No file found")
        }),
    ...
    W.prototype["export"] = function(a, b, c) {
        this.that.fileDrawing;
        var d = (this.that.FrameController.frames.length,
        this.that.FrameController.currentFrame)
          , e = this.that.width
          , f = this.that.height
        ...
        if (this.that.isApp && !c) {
            if (!(e < 175))
                return this.that.resizeImagetoWidth(this.that.canvas.display.dataURL(), 175, function(c, d, e) {
                    h["export"](a, b, c)
                });
        ...
        this.that.startHistory(function(i) {
            ...
            if (j.length > 120) {
                ...
                j = l + h.importExportrandomStringPlacement,
                h.that.isExternal && (j += h.importExportIsPhotoUpload),
                j += m
            }
            h.that.isApp && (k = c);
            var n = {
            ...
            if (h.that.settings.persLayers && (n.persLayers = !0),
            h.that.app.edit_id && (n.app_edit_id = h.that.app.edit_id),
            h.that.isExternal && (n.isExternal = !0),
            h.that.id && (n.id = h.that.id),
            h.that.edit.status && (n.edit = {
                status: !0,
            ...
            if (a)
                return o;
            if (o = h.that.replaceAll(o, ";", h.importExportSecretString),
            b)
                return b(o);
            var p = prompt("Filename", "");
            p = p ? p : "pixilart",
            null != p && (h.that.downloadFile(p + ".pixil", o),
            h.that.clearAutoSave())
        })
    }
    ,
    ...
    W.prototype.fromURL = function(b, c, d) {
        ...
        a.ajax({
            ...
            fail: function() {
                e.importing = !1,
                d && (e.that.getEditImage(),
                e.that.showTipStepperOrAds())
            },
            error: function() {
                e.importing = !1,
                d && (e.that.getEditImage(),
    ...
    W.prototype["import"] = function(b, c, d, e) {
        var f = this
          , g = !1
          , h = !1;
        if (this.resizeImport = !1,
        c || this.onNew || this.importing || (g = confirm(f.that.getResponse("res-export-confirm"))),
        g || c || this.onNew || this.importing) {
            var i = b;
            if (b = this.that.replaceAll(b, this.importExportSecretString, ";"),
            b = this.that.replaceAll(b, this.importExportrandomStringPlacement, ""),
            i.indexOf(this.importExportIsPhotoUpload) > -1 && (this.that.FileController.hideFileElements(),
            b = this.that.replaceAll(b, this.importExportIsPhotoUpload, ""),
            h = !0,
            this.importing && !this.that.isExternal && (g = confirm(f.that.getResponse("res-export-confirm")),
            this.importing = !1,
            !g)))
                return;
            ...
            if ((!j.version || j.version && parseFloat(j.version) < 2.7 || !j.persLayers) && (this.that.settings.persLayers = !1),
            j.version < 1.9 && d && d.getFullYear() < 2020 || j.version >= 1.8 && i.indexOf(this.importExportSecretString) == -1 || j.version >= 2.1 && i.indexOf(this.importExportrandomStringPlacement) == -1)
                return alert(f.that.getResponse("res-export-tainted"));
            if (j.persLayers && (this.that.settings.persLayers = !0,
            this.that.SettingsController.togglePersLayers(!0)),
            this.importing && (this.that.settings.persLayers = !1),
            this.that.isExternal && this.that.SelectController.clearCopy(),
            h || this.that.FileController.showFileElements(),
            "object" == typeof j && "pixil" == j.application) {
                if (this.that.clickCount = !0,
                j.edit && j.edit.status && (this.that.edit.status = !0,
                this.that.edit.unqid = j.edit.unqid),
                this.importing || (this.that.width = j.width,
                this.that.height = j.height,
                this.that.getPixelRatio()),
                this.importing && this.that.width < j.width || this.importing && this.that.height < j.height) {
                    var l = confirm("Import is larger than current canvas size, resize canvas?");
                    l && (this.that.width = j.width,
                    this.that.height = j.height,
                    this.that.getPixelRatio(),
                    this.resizeImport = !0)
                }
                j.palette_id && (this.that.palette_id = j.palette_id),
                this.that.resizeCanvases(),
                this.that.createChecker();
                var m = this.that.zoom.type;
                this.that.zoom_ratio = 1,
                this.that.zoom_step = 1,
                this.that.zoom = {
                    type: m,
                    left: 0,
                ...
                this.that.getPixelRatio(),
                a("#canvas_grid_image").removeAttr("style"),
                this.that.createGrid(),
                this.that.ZoomController.reset(!0),
                this.that.TileController.reset(),
                this.that.mouse.resetLast();
                var n = [];
                a.each(this.that.ColorController.colorPresets, function(a, b) {
                    n.push(a)
                });
                var o = "default";
                this.importing || (this.that.ColorController.colorPresets = j.colors,
                j.colorSelected && (this.that.ColorController.currentSelection = j.colorSelected,
                o = j.colorSelected),
                this.that.ColorController.updateOptions()),
                a.each(j.colors, function(a, b) {
                    n.indexOf(a) == -1 && "default" == o && (o = a)
                }),
                this.importing || (this.that.ColorController.updateColors(o),
                this.that.HistoryController.undo = [],
                this.that.HistoryController.redo = [],
                this.that.LayerController.currentLayer = 0,
                this.that.FrameController.currentFrame = 0),
                this.that.loadHistoryData(j, function(a) {
                    f.loadFrames(a),
                    f.importing = !1
                }),
                this.that.FileController.updateDimensions(),
                this.fromGallery && this.that.hidePopup(),
                this.fromGallery = !1,
                e || this.that.FileController.clearEdit(),
                setTimeout(function() {
    ...
    W.prototype.loadFrames = function(a) {
        if (this.importing) {
            if (this.resizeImport && this.that.FrameController.resizeFrames(),
            a.length > 1) {
                var b = this.that.FrameController.frames;
                a = b.concat(a),
                this.that.FrameController.frames = a
            } else
                this.that.FrameController.frames[this.that.FrameController.currentFrame] = a[0];
            return this.that.FrameController.updateList(),
            this.that.FrameController.select(this.that.FrameController.currentFrame),
            this.that.HistoryController.create(),
            void this.that.showAlert("Import complete", !1, "success")
        }
        this.that.FrameController.frames = a,
        this.that.FrameController.updateList(),
        this.that.canvas.rendering.clear(),
        this.that.updateDisplayCanvas(this.that.LayerController.layers, 0),
        this.that.render(),
        this.importing || (this.that.HistoryController.newCanvas(),
        this.that.FrameController.select(0)),
        this.that.app.isLoaded = !0,
        this.that.isApp && this.that.app.isGif && (this.that.canvas.rendering.clear(),
        this.that.canvas.display.clear(),
        this.that.FrameController.select(this.that.FrameController.frames.length - 1))
    }
    ;
    var X = function(a) {
        this.that = a,
        this.html = !1,
        this.ratioLimit = 12,
        this.importingPhoto = !1,
        this.newPerLayersDefault = !0,
        this["new"] = {
            width: 256,
            height: 144,
            default_width: 256,
    ...
    X.prototype.init = function() {
        this.listeners(),
        this.updateNew(this["new"].width, this["new"].height),
        this.html = a("#new-menu").html(),
        this.resizeHtml = a("#resize-menu").html(),
        a("#new-menu").remove(),
        a("#resize-menu").remove()
    }
    ,
    X.prototype.listeners = function() {
        ...
        a(document).on("click", ".preset-select", function() {
            return a(".preset-select").removeClass("active"),
            a(this).addClass("active"),
            "#" == a(this).attr("data-width") || "#" == a(this).attr("data-height") ? b.randomSize() : (b.updateNew(a(this).attr("data-width"), a(this).attr("data-height")),
            void b.newer())
        }),
        ...
        a(document).on("blur", ".new-width", function(c) {
            c.preventDefault(),
            b.updateNew(a(this).val(), b["new"].height)
        }),
        a(document).on("blur", ".new-height", function(c) {
            c.preventDefault(),
            b.updateNew(b["new"].width, a(this).val())
        }),
        a(document).on("click", ".new-drawing-a", function(c) {
            b.newPerLayersDefault = a("#pers-toggle-def").is(":checked"),
            b.newer()
        }),
    ...
    X.prototype.importPhotoFromUrl = function(a) {
        var b = this;
        this.that.PreviewController.showLoading(),
        this.that.loadImage(a, function(c) {
            b.loadFile(c, a)
        })
    }
    ,
    X.prototype.readFile = function(a, b, c) {
        var d = this
          , e = new FileReader;
        c = c ? c : a.target.files[0],
        e.onload = function(a) {
            d.that.loadImage(a.target.result, function(a) {
                d.that.settings.persLayers = !1,
                b ? d.importPhoto(a) : d.loadFile(a, c.name)
            })
        }
        ,
        e.readAsDataURL(c)
    ...
    X.prototype.resizeFile = function(a, b, c, d, e, f) {
        var g = a
          , h = b;
        if (c = c ? c : this.that.maxWidth,
        d = d ? d : this.that.maxHeight,
        g > c || h > d)
    ...
    X.prototype.importPhoto = function(a) {
        if (this.that.isExternal) {
            ...
            this.that.canvas.data.clear(),
            this.that.canvas.data.ctx.drawImage(a, f, g, d, e);
            var h = this.that.canvas.data.dataURL();
            this.that.loadImage(h, function(a) {
                b.that.LayerController["import"](a),
                b.that.loading = !1
            })
        }
    }
    ...
    X.prototype.loadFile = function(a, b) {
        ...
        this["new"].height = d[1],
        this.that.getPixelRatio(),
        this.newer() && (this.that.settings.persLayers = !1,
        this.that.loading = !0,
        this.hideFileElements(),
        "gif" == this.that.fileExtension(b) ? (this.that.edit.resize = 1,
        this.that.PreviewController.showLoading(),
        this.that.GifController.load(a.src, function() {
            c.that.PreviewController.hideLoading(),
            c.loadFileData(a),
            c.that.settings.persLayers = !0
        })) : this.loadFileData(a))
    }
    ,
    X.prototype.loadFileData = function(b) {
        this.that.ToolController.tool.currentImage = !1,
        this.that.canvas.layer.putSimple(b, 0, 0, this["new"].width, this["new"].height),
        this.that.canvas.rendering.putSimple(b, 0, 0, this["new"].width, this["new"].height),
        this.that.updateDisplayCanvas(this.that.LayerController.layers, 0),
        this.that.PreviewController.close(),
        this.that.FrameController.updateFramePreview(0),
        this.that.HistoryController.newCanvas(),
        this.that.render(),
        this.that.loading = !1,
        this.that.ToolController.selectTool(a("#pencil-tool"), "Pencil", !0)
    }
    ,
    ...
    X.prototype.hideFileElements = function() {
        this.that.debug,
        this.that.fileDrawing = !0,
        this.that.autosave.status = !1,
        this.that.isExternal = !0,
        this.that.SubmitController.hideSubmit(),
        this.that.SelectController.clearCopy(),
        a("#import-image-toggle").removeClass("d-none")
    }
    ,
    X.prototype.showFileElements = function() {
        this.that.fileDrawing = !1,
        this.that.isExternal = !1,
        this.that.SubmitController.showSubmit(),
        a("#import-image-toggle").addClass("d-none")
    }
    ,
    X.prototype.restoreNoFile = function() {
        a("#save, #open-pix").show(),
        this.that.SubmitController.showSubmit()
    }
    ,
    ...
    X.prototype.checkResize = function(b, c) {
        this["new"].width = b ? b : a(".new-width").val(),
        this["new"].height = c ? c : a(".new-height").val(),
        this.resize(!0, this["new"].width, this["new"].height, !1)
    }
    ,
    X.prototype.resize = function(a, b, c, d) {
        var e = this;
        return b == this.that.width && c == this.that.height ? this.hidePopup() : (this.that.loading = !0,
        b = b ? b : this["new"].width,
        c = c ? c : this["new"].height,
        void this.that.cropResize(b, c, function() {
            if (e.that.width = b,
            e.that.height = c,
            e.that.getPixelRatio(),
            e.that.resizeCanvases(!1, !1, !0),
            e.that.checker.data = !1,
            e.that.createGrid(),
            e.that.showChecker(!0),
            e.that.ZoomController.reset(!0),
            e.that.TileController.reset(),
            e.that.mouse.resetLast(),
            e.that.PreviewController.reset(),
            e.updateDimensions(),
            a) {
                for (var f = e.that.FrameController.frames, g = 0; g < f.length; g++) {
                    var h = f[g];
                    h.width = e.that.width,
                    h.height = e.that.height
                }
                e.that.HistoryController.create(),
                console.log("history created")
            }
            if (e.that.FrameController.select(e.that.FrameController.currentFrame),
            e.that.render(),
            e.hidePopup(),
            e.that.loading = !0,
            d)
    ...
    X.prototype.updateNew = function(b, c) {
        a(".preset-select").removeClass("active"),
        b = parseInt(b),
        c = parseInt(c),
        (c <= 0 || c > this.that.maxHeight) && (c = this.that.height),
        (b <= 0 || b > this.that.maxWidth) && (b = this.that.height),
        this["new"].width = b,
        this["new"].height = c,
        a(".new-width").val(this["new"].width),
        a(".new-height").val(this["new"].height)
    }
    ,
    X.prototype.showPopup = function(b, c) {
        ...
        b = b ? b : "new",
        this.clearError(),
        this.that.showPopup(b, c),
        this.updateNew(this.that.width, this.that.height),
        this.changeAnchor(this.that.settings.crop.anchor),
        this.that.settings.crop.resize && (a(".crop-resize-toggle").prop("checked", !0),
        a("#anchor-crop").addClass("disabled"))
    }
    ,
    X.prototype.changeCropResize = function(b) {
        this.that.settings.crop.resize = !this.that.settings.crop.resize,
        (b || b === !1) && (this.that.settings.crop.resize = b),
        this.that.settings.crop.resize ? a("#anchor-crop").addClass("disabled") : a("#anchor-crop").removeClass("disabled")
    }
    ,
    X.prototype.changeAnchor = function(b, c) {
        this.that.settings.crop.resize || (a("#anchor-crop .anchor-sets").removeClass("active"),
        a("#anchor-crop .anchor-" + b).addClass("active"),
        c && (this.that.settings.crop.anchor = b))
    }
    ,
    ...
    X.prototype.checkRatio = function(a, b, c) {
        var d = 0;
        a = a ? a : this["new"].width,
        b = b ? b : this["new"].height;
        var e = c ? c : this.ratioLimit;
        return d = a > b ? b / a : a / b,
        d = 100 * d,
        d < e
    }
    ,
    X.prototype.error = function(b) {
        a("#error-new").slideDown(250),
        a("#error-resizing").slideDown(250),
        b && a(".error-message-file").text(b)
    }
    ,
    X.prototype.clearError = function() {
        a("#error-new").hide(),
        a("#error-resizing").hide()
    }
    ,
    X.prototype.appClear = function(a) {
        ...
        this.that.ons.notification.confirm("Are you sure?").then(function(c) {
            c && (b.newer(!0, !0),
            b.that.newDrawing(a),
            b.that.updateAppFrames())
        })
    }
    ,
    X.prototype.clearEdit = function() {
        this.that.edit.title = "",
        this.that.edit.description = ""
    }
    ,
    X.prototype.newer = function(b, d) {
        ...
        if (this.clearError(),
        e || this.that.newShow || d) {
            this.that.newShow = !1,
            b && (this["new"].width = this.that.width,
            this["new"].height = this.that.height),
            this.checkRatio() && !this.that.isApp,
            this.that.isExternal && this.that.SelectController.clearCopy(),
            this.that.FileController.showFileElements(),
            this.that.edit.unqid = !1,
            this.that.edit.status = !1,
            this.that.SubmitController.defaultSubmitForm(),
            this.that.width = this["new"].width,
            this.that.height = this["new"].height,
            this.that.getPixelRatio(),
            this.that.resizeCanvases(),
            this.that.checker.data = !1,
            this.that.grid.data = !1,
            this.that.grid.status = !1,
            this.that.toggleGridIcon(),
            this.that.createGrid(),
            this.that.showChecker(!0),
            this.that.LayerController.currentLayer = 0,
            this.that.FrameController.currentFrame = 0,
            this.that.LayerController.layers = [],
            this.that.FrameController.frames = [];
            ...
            f.init(),
            this.that.FrameController["new"](!0),
            this.that.LayerController.frame = this.that.FrameController.frame(),
            this.that.LayerController.layers = this.that.LayerController.frame.layers,
            this.that.LayerController.addLayer(f),
            this.that.HistoryController.undo = [],
            this.that.HistoryController.redo = [],
            this.that.FrameController.select(0),
            this.that.FrameController.updateList(),
            this.that.HistoryController.newCanvas();
            this.that.zoom.type;
            if (this.that.progress.images = [],
            this.that.ZoomController.reset(!0),
            this.that.TileController.reset(),
            this.that.mouse.resetLast(),
            this.that.settings.persLayers = this.newPerLayersDefault,
            this.that.PreviewController.reset(),
            this.updateDimensions(),
            this.that.render(),
            this.clearEdit(),
            a(".has-colors").length) {
                var g = a(".has-colors").find(".use-palette");
                g && (this.that.isMobile && a("#colors-bar-mobile").html(""),
                this.that.ColorController.usePalette(g, !0))
            }
            return this.hidePopup(),
            this.that.isApp && this.that.updateData(),
            !0
        }
        return !1
    }
    ...
    X.prototype.updateText = function() {
        a("#canvas-width").text(Math.round(this.that.width)),
        a("#canvas-height").text(Math.round(this.that.height))
    }
    ,
    X.prototype.updateDimensions = function() {
        ...
        d.top + c)
          ...
          , h = 1;
        this.that.isIpad && (h = 0),
        a("#canvas-size-details").css({
            position: "absolute",
            bottom: f,
            left: g,
            zIndex: h
    ...
    var Y = function(a) {
        ...
        this.submitted = !1,
        this.saveImage = !1,
        this.defaultUploadButtonText = '<i class="fa fa-star fa-small fa-fw" aria-hidden="true"></i> Save Drawing',
        this.defaultUpdateButtonText = '<i class="fa fa-floppy-o fa-small fa-fw" aria-hidden="true"></i> Update',
        this.defaultNewButtonText = '<i class="fa fa-star fa-small fa-fw" aria-hidden="true"></i> New',
        this.loadingText = "Loading..",
        this.url = "",
        this.errorTimer,
        this.doTimeout = !0,
        this.timeoutTimer = 3e5,
        this.gifRatio = 1,
        this.photo_blob = !1,
        this.pixilFile = !1
    };
    Y.prototype.init = function() {
        this.listerners(),
        this.htmlSmall = a("#submit-small"),
        a("#submit-small").remove(),
        this.htmlLoading = a("#submit-loading"),
        a("#submit-loading").remove()
    }
    ,
    ...
    Y.prototype.hideArtOptions = function() {
        a(".art-options-submit").addClass("d-none"),
        a(".photos-info").removeClass("d-none"),
        a(".submit-details").addClass("full")
    }
    ,
    ...
    Y.prototype.defaultSubmitForm = function() {
        a(".art-unqid-set").length >= 1 && a(".art-unqid-set").remove(),
        a(".save-edit-btn").length >= 1 && a(".save-edit-btn").remove(),
        this.that.edit.title = "",
        this.that.edit.description = "",
        a(".submit-new-drawing").removeClass("upload-edit-btn"),
        a(".title-drawing").val(""),
        a(".desc-art").val("")
    }
    ,
    Y.prototype.listerners = function() {
        ...
        a(document).on("click", ".submit-drawing", function() {
            b.that.fileDrawing,
            b.validateSize() && b.checkFileSize(function() {
                "Text" == b.that.tool && b.that.ToolController.selectTool(a("#pencil-tool"), "Pencil", !0),
                b.that.ToolController.restore(),
                a("#submit_title").val(b.that.edit.title),
                a("#submit_description").val(b.that.edit.description),
                b.that.showPopup("submit", a("#submit-drawing").html()),
                b.setInputValue(),
                b.enableUploadReplay()
            })
        }),
    ...
    Y.prototype.enableUploadReplay = function() {
        var b = this.that.readCookie("pixil-replay")
          , c = !1;
        (this.that.isTablet || this.that.isIpad || !this.that.isAuth) && a("#upload-replay-toggle").hide(),
        "string" == typeof b && "true" == b && 1 == this.that.FrameController.frames.length && (c = !0),
        a("#progress-check").prop("checked", c)
    }
    ,
    Y.prototype.validateSize = function() {
        return !(this.that.width < this.that.minWidth || this.that.height < this.that.minHeight) || (this.that.showPopup("download", " " + a("#download-information").html()),
        this.that.PopupController.updateElements(),
        !1)
    }
    ,
    Y.prototype.processSubmit = function(b, c) {
        ...
        if (this.that.FileController.checkRatio() && !this.that.isApp)
            return void this.error(this.that.getResponse("res-submit-error"));
        this.disableSubmit(),
        this.that.mouse.closeHook = !1;
        var f = {};
        a.each(b.serializeArray(), function(a, b) {
            f[b.name] = b.value
        });
        var g = 1 == f.upload_progress;
        return this.that.isExternal && !c ? (e = 1,
        this.that.FrameController.download(0, !1, e, !0, function(a) {
            d.photo_blob = a,
            d.processSubmit(b, !0)
        })) : (this.that.isAuth || (g = !1),
        void this.that.downloadProgressGif(!1, !1, function(c) {
            d.that.isExternal && (e = 1),
            d.that.FrameController.frames.length > 1 ? (d.is_gif = !0,
            a(".submit-drawing-butn").html(d.loadingText + " " + d.that.getResponse("res-submit-animation-creating") + ' <span class="gif-loading-percent"></span>'),
            d.that.GifController.download(e, e, function(c) {
                a(".submit-drawing-butn").text(d.loadingText + " " + d.that.getResponse("res-submit-animation-uploading")),
                d.submitDrawing(b, c, !1)
    ...
    Y.prototype.checkFileSize = function(b) {
        var c = this;
        return !this.that.isExternal && this.that.isAuth && (this.that.LayerController.layers.length > 1 || this.that.FrameController.frames.length > 1) && (this.pixilFile = !1,
        this.that.ExportImportController["export"](!1, function(d) {
            c.that.getBinarySize(d, !0, 1);
            return c.that.getBinarySize(d) < 15521440 ? c.pixilFile = d : a("#file-size-too-large").removeClass("d-none"),
            b()
        })),
        b()
    }
    ...
    Y.prototype.submitDrawing = function(b, c, d) {
        if (!this.that.isApp) {
            var e = this
              ...
              , i = "/draw/new";
            if (g.append("app_set", "true"),
            this.that.palette_id && g.append("palette_id", this.that.palette_id),
            this.pixilFile && g.append("px_f", this.pixilFile),
            !a("#submit-art-unqid").length && this.that.edit.status && g.append("unqid", this.that.edit.unqid),
            this.hideError(),
            this.that.clickCount || e.enableSubmit(),
            d && this.that.isAuth && (g.append("has_progress", "true"),
            g.append("progress_name", "pixil-progress.gif"),
            g.append("progress_blob", d)),
            c) {
                if (g.append("is_gif", "true"),
                g.append("fname", "pixil-image.gif"),
                g.append("gif_blob", c),
                c.size > 4e7)
                    return e.enableSubmit(),
                    void e.showError(e.that.getResponse("res-submit-large-error"));
                e.is_gif = !0
            }
            if (this.saveImage && g.append("save_image", "true"),
            "" != h.trim() && h.toLowerCase().match(/\.(jpg|png|gif|bmp)/g) && g.append("is_traced", "true"),
            a("#challenge-id").length && g.append("challenge_id", a("#challenge-id").attr("data-value")),
            a("#drawing-wrapper").attr("data-rid") && g.append("r_f", a("#drawing-wrapper").attr("data-rid")),
            a(".submit-drawing-butn").html(e.that.getResponse("res-submit-uploading")),
            this.that.isExternal && this.that.isAuth && (i = "/draw/photo",
            g.append("post_comment", a("#submit_title").val()),
            g.append("post_desc", a("#submit_description").val()),
            c ? (g.append("is_gif", 1),
            g.append("photo", c)) : (g.append("base_image", 1),
            g.append("base_src", this.photo_blob))),
            !this.submitted && g) {
                if (this.submitted = !0,
                this.hideError(),
                this.that.validateImageData(a(".frame-0").val()))
                    return a.ajax({
                        type: "POST",
                        url: i,
                        data: g,
                        ...
                        success: function(b) {
                            if ("object" == typeof b && b.url) {
                                if (a(window).unbind("beforeunload"),
                                !e.that.isAuth) {
                                    var c = e.that.getCookie("anon_ids");
                                    c.length || (c = []),
                                    c.push(b.art_id),
                                    e.that.createCookie("anon_ids", c, 7, !0)
                                }
                                e.that.clearAutoSave(),
                                e.showLink(b.url, b);
                                try {
                                    e.download()
                                } catch (d) {
                        ...
                        error: function(a, b, c) {
                            if (e.error(e.that.getResponse("res-submit-error-error")),
                            "timeout" === a.statusText)
                                e.error(e.that.getResponse("res-submit-error-timeout"));
                            else {
    ...
    Y.prototype.updateBtns = function() {
        a(".submit-new").html(this.defaultUploadButtonText),
        a(".submit-new-btn").html(this.defaultNewButtonText),
        a(".submit-update-btn").html(this.defaultUpdateButtonText)
    }
    ,
    Y.prototype.showLink = function(b, c) {
        this.that.ads.status || (window.location.href = b),
        this.that.hidePopup(),
        this.that.showPopup("getting-link", this.htmlLoading, !0, !0, !0),
        this.url = b;
        ...
        setTimeout(function() {
            a("#pre-getting-text").hide(),
            a("#go-to-image-btn").addClass("active")
        }, 3500)
    }
    ,
    ...
    Y.prototype.shopAd = function(b, c, d) {
        ...
        a("#da-text").addClass("product hide-mobile"),
        a("#da-text").html(""),
        a("#da-link-append").html(g),
        this.loadPixilShop(d)
    }
    ,
    Y.prototype.loadPixilShop = function(b) {
        ...
        a(".image-popup-image").each(function() {
            ...
            e.push(b),
            e.length == a(".image-popup-image").length && c()
        });
        var f = 0
          , g = 0
          , h = 0
          , i = function() {
            ...
            var b = new Image;
            b.onload = function() {
                a(".rotate-slide-wrapper").width(a(".slide-slot").width()).height(a(".slide-slot").height()),
                g = a(".slide-slot").width(),
                j()
            }
            ,
          ...
          , k = function() {
            ...
            h++,
            h == f && (h = 0),
            a(".rotate-slide-wrapper").animate({
                scrollLeft: b
            }, 50)
        };
        i()
    ...
    Y.prototype.showError = function(b) {
        this.hideError(),
        a("#error-submitting").show(),
        a("#error-submitting .error-message-submit").text(b)
    }
    ,
    Y.prototype.hideError = function() {
        a("#error-submitting").hide(),
        a("#error-submitting .error-message-submit").text("")
    }
    ,
    Y.prototype.disableSubmit = function() {
        a(".save-edit-btn").length >= 1 && a(".save-edit-btn").hide(),
        a("#popup-container .submit-drawing-butn").text(this.loadingText).prop("disabled", !0)
    }
    ,
    Y.prototype.enableSubmit = function() {
        this.submitted = !1,
        a(".save-edit-btn").length >= 1 && a(".save-edit-btn").show(),
        this.updateBtns(),
        a(".submit-drawing-butn").removeAttr("disabled")
    }
    ,
    Y.prototype.getTitle = function(b) {
        var c = a(".drawing-title-submit").val();
        return c = c.replace(/\s+/g, "-").toLowerCase(),
        c = "" == c.trim() ? "pixilart-drawing." + b : c + "-pixilart." + b
    }
    ,
    Y.prototype.download = function() {
        if (!(this.that.settings.disableDownloadSubmit || this.that.isMobile || this.that.isIpad)) {
            var b = this.that.FrameController.frames;
            if (this.that.downloadSizes.frame = 1,
            this.that.downloadSizes.gif = 1,
            b.length > 1) {
                var c = this.getTitle("gif");
                this.that.GifController.download(1, 1, function(b) {
                    var d = URL.createObjectURL(b);
                    a("#dowmnload-a").attr("href", d),
                    a("#dowmnload-a").attr("download", c),
                    a("#dowmnload-a")[0].click()
                })
            } else {
    ...
    Y.prototype.getColorTree = function(a) {
        this.that.canvas.data.clear();
        var b = (new Image,
        "{image:true,data:set,method:upload,token:__this}");
        return b
    }
    ,
    ...
    Z.prototype.init = function() {
        this.listeners(),
        this.html = a("#info-container").html(),
        a("#info-container").remove(),
        this.html_about = a("#about-information").html(),
        a("#about-information").remove(),
        this.html_mobile = a("#mobile-information").html(),
        a("#mobile-information").remove()
    }
    ,
    Z.prototype.listeners = function() {
        ...
        a(".show-information").click(function() {
            ...
            b.that.ShortcutController.appendKeys()
        }),
    ...
    var $ = function(b) {
        this.that = b,
        this.event = !1,
        this.storageName = "custom_keys",
        this.stroageKeys = this.that.getStorage(this.storageName),
        this.keys = this.defaultKeys(),
        this.stroageKeys && a.extend(this.keys, JSON.parse(this.stroageKeys)),
        this.current_key = !1,
        this.setting_key = !1,
        this.setting_ctrl_key = !1,
        this.setting_shift_key = !1,
        this.handShortActive = !1
    };
    ...
    $.prototype.listeners = function() {
        ...
        a("#popup-container").on("mouseup", ".toggle-set", function() {
            var c = a(this).attr("data-key");
            a(".toggle-set").removeClass("active"),
            a(this).addClass("active"),
            b.setting_key = c
        })
    }
    ...
    $.prototype.updateKeys = function(b) {
        ...
        f = f.toLowerCase(),
        "" != e && " " != e || (e = "space"),
        this.setting_shift_key && (d = "s" + d,
        e = "shift + " + e),
        this.setting_ctrl_key && (d = "c" + d,
        e = "ctrl + " + e),
        this.setting_alt_key && (d = "a" + d,
        e = "alt + " + e),
        ["shift", "control", "alt"].indexOf(f) > -1 || (this.keys[this.setting_key].code = d,
        this.keys[this.setting_key].key = e,
        a.each(this.keys, function(a, b) {
            b.code == d && a != c.setting_key && (c.keys[a].code = 0,
            c.keys[a].key = "??")
        }),
        this.updateStorage(),
        this.doneUpdatingKeys())
    }
    ,
    ...
    $.prototype.use = function(b) {
        var c = b
          , d = this;
        parseInt(this.that.FrameController.currentFrame),
        parseInt(this.that.LayerController.currentLayer);
        if ("Move" == this.that.tool && [37, 40, 39, 38].indexOf(b) > -1)
            return void this.that.ToolController.tool.key(b);
        if (!this.that.settings.disableKeybinds) {
            if (this.setting_key)
                return (this.that.keyEvent.ctrlKey || this.that.keyEvent.metaKey) && (this.setting_ctrl_key = !0),
                this.that.keyEvent.shiftKey && (this.setting_shift_key = !0),
                this.that.keyEvent.altKey && (this.setting_alt_key = !0),
                void this.updateKeys(b);
            if ("Text" == this.that.tool || (this.that.keyEvent.ctrlKey || this.that.keyEvent.metaKey) && "pencil" == this.that.tool && !this.that.keyEvent.shiftKey || this.that.preventShortcut || this.that.developer)
                return void (this.that.mouse.active = !1);
            this.that.keyEvent.shiftKey && (c = "s" + c),
            (this.that.keyEvent.ctrlKey || this.that.keyEvent.metaKey) && (c = "c" + c),
            this.that.keyEvent.altKey && (c = "a" + c),
            a.each(this.keys, function(b, e) {
            ...
            !this.that.keyEvent.ctrlKey && !this.that.keyEvent.shiftKey,
            this.that.keyEvent.shiftKey && this.that.ToolController.shift(!0),
            (this.that.keyEvent.ctrlKey || this.that.keyEvent.metaKey) && this.that.ToolController.ctrl(!0),
            this.that.keyEvent.altKey && this.that.ToolController.alt(!0)
        }
    }
    ,
    ...
    $.prototype.handShortcut = function() {
        this.handShortActive || (this.handShortActive = this.that.tool,
        this.that.mouse.setHandTemp())
    }
    ,
    $.prototype.end = function(a) {
        16 == a.keyCode && this.that.ToolController.shift(!1),
        17 == a.keyCode && this.that.ToolController.ctrl(!1),
        18 == a.keyCode && this.that.ToolController.alt(!1),
        this.handShortActive && (this.that.mouse.resetHandTemp(this.handShortActive),
        this.handShortActive = !1)
    }
    ,
    ...
    var _ = function(a) {
        this.that = a,
        this.ratio = 1,
        this.ratioContainer = 1,
        this.dragging = !1,
        this.scrolling = !1,
        this.active = !1,
        this.ignoreZoomLastClicks = !0
    };
    ...
    _.prototype.set = function() {
        if (!this.that.settings.navigation || this.that.isApp)
            return !1;
        var b = this.that.width
          , c = this.that.height
          ...
          , e = 125
          , f = 1;
        b >= c ? this.that.width < d ? (f = parseInt(d) / this.that.width,
        b *= f,
        c *= f) : (f = this.that.width / parseInt(d),
        b /= f,
        c /= f) : this.that.height < e ? (f = e / this.that.height,
        b *= f,
        c *= f) : (f = this.that.height / e,
        b /= f,
        c /= f),
        b = Math.floor(b),
        c = Math.floor(c),
        c > e ? (b = e / c * b,
        a("#navigation-scroller").height(e),
        a("#nav-canvas-img").height(e).width(b)) : (c = this.width / b * c,
        a("#navigation-scroller").height(c),
        a("#nav-canvas-img").height(c).width(b))
    }
    ,
    _.prototype.listeners = function() {
        ...
        if (!this.that.isApp) {
            ...
            a("#drawing-canvas-conatiner").on("scroll", function() {
                b.dragging || b.that.ZoomController.loading || (b.scrolling = !0,
                b.placement())
            }),
    ...
    _.prototype.clickPosition = function(b, c) {
        ...
        b < 0 && (b = 0),
        c < 0 && (c = 0),
        h > e.width() && (b = e.width() - f),
        i > e.height() && (c = e.height() - g),
        d.css({
            top: c,
            left: b
        }),
    ...
    _.prototype.updatePlacement = function() {
        if (!this.that.isApp) {
            var b = a("#drawing-canvas-conatiner")
              ...
              , j = Math.abs(d.height());
            d.width(i).height(j);
            var k = (c.width() / this.that.ZoomController.zoom,
            c.height() / this.that.ZoomController.zoom,
            g / this.that.ZoomController.zoom)
              , l = h / this.that.ZoomController.zoom
              , m = c.width() / b.width()
              , n = c.height() / b.height();
            k = (Math.ceil(k) + m / 2) / this.that.pixel_size,
            l = (Math.ceil(l) + n / 2) / this.that.pixel_size,
            this.that.ZoomController.last_x = k,
            this.that.ZoomController.last_y = l,
            b.scrollLeft(g).scrollTop(h),
            this.that.TileController.updatePlacement()
        }
    }
    ,
    _.prototype.placement = function() {
        if (!this.that.isApp) {
            ...
            g > h ? (this.ratio = g / j,
            this.ratioContainer = g / d) : (this.ratio = h / k,
            this.ratioContainer = h / e);
            var l = d / this.ratio
              , m = e / this.ratio
              , n = c.scrollLeft()
              , o = c.scrollTop()
              , p = n / this.ratio
              , q = o / this.ratio;
            this.that.ZoomController.zoom >= 1 && (l -= 3,
            m -= 3),
            a("#nav-placement").show().css({
                top: q,
                left: p
            }).width(l).height(m),
            l + 3 >= j && m + 3 >= k && a("#nav-placement").hide(),
            this.that.TileController.updatePlacement()
        }
    }
    ,
    ...
    _.prototype.clickLocation = function() {
        var b = a("#drawing-canvas-conatiner")
          ...
          , e = b.scrollLeft() / d
          , f = b.scrollTop() / d;
        this.scroll_x = e + b.width() / 2 / d,
        this.scroll_y = f + b.height() / 2 / d,
        this.that.isApp && (this.scroll_x = Math.round((b.width() / 2 - c.left) / d),
        this.scroll_y = Math.round((b.height() / 2 - c.top) / d))
    }
    ,
    _.prototype.updateLastClicks = function() {
        this.that.ZoomController.zoom <= 0 || (this.clickLocation(),
        this.that.mouse.last_x = this.scroll_x,
        this.that.mouse.last_y = this.scroll_y,
        this.that.ZoomController.previousZoomX = this.scroll_x,
        this.that.ZoomController.previousZoomY = this.scroll_y,
        this.ignoreZoomLastClicks || (this.that.ZoomController.last_x = this.scroll_x,
        this.that.ZoomController.last_y = this.scroll_y,
        this.that.ZoomController.setLastZoom()),
        this.that.isApp && (this.that.ZoomController.last_x = this.scroll_x,
        this.that.ZoomController.last_y = this.scroll_y,
        this.that.mouse.app_x_last = this.scroll_x,
        this.that.mouse.app_y_last = this.scroll_y),
        this.ignoreZoomLastClicks = !1)
    }
    ;
    var aa = function(a) {
        this.that = a
    ...
    ba.prototype.listeners = function() {
        ...
        a("#tiles-toggle").click(function() {
            b.that.settings.tile.status = !b.that.settings.tile.status,
            b.updateStatus(),
            b.that.updateSettings()
        }),
        ...
        a(".tiles-border-toggle").click(function() {
            b.that.settings.tile.border = !b.that.settings.tile.border,
            b.that.updateBorder(),
            b.that.updateSettings()
        })
    }
    ...
    ba.prototype.reset = function() {
        this.that.settings.tile.status && (this.that.createTileCanvases(),
        this.that.getPixelRatio())
    }
    ,
    ba.prototype.updateStatus = function(a, b) {
        this.that.settings.tile.status ? this.that.createTileCanvases(a, b) : this.that.removeTileCanvases(),
        this.that.getPixelRatio(),
        this.that.ZoomController.reset(!0)
    }
    ,
    ba.prototype.toggleOff = function() {
        this.that.settings.tile.status = !1,
        this.that.removeTileCanvases(),
        this.that.getPixelRatio(),
        this.that.ZoomController.reset(!0),
        a("#tiles-toggle").prop("checked", !1)
    }
    ,
    ba.prototype.updateOpacity = function(a) {
        this.that.settings.tile.opacity = a,
        this.that.updateTileCanvases()
    }
    ,
    ba.prototype.updateBorders = function() {}
    ,
    ba.prototype.updatePlacement = function() {
    ...
    ca.prototype.open = function(b) {
        ...
        "");
        this.that.settings.outline.layer_id = b,
        a.each(this.that.LayerController.layers, function(a, d) {
            c = c + '<option value="' + a + '"',
            a == b && (c += ' selected="selected"'),
            c = c + ">" + d.name + "</option>"
        }),
        a("#outline-layers").html(""),
        a("#outline-layers").append(c)
    }
    ,
    ca.prototype.changeAlpha = function(b) {
        this.that.settings.outline.alpha = b.val(),
        a("#outline-alpha-change").text(this.that.settings.outline.alpha)
    }
    ,
    ...
    ca.prototype.updateAnchor = function(a) {
        ...
        this.that.settings.outline.points[b] = !this.that.settings.outline.points[b],
        this.updateAnchors()
    }
    ,
    ...
    da.prototype.load = function(b) {
        this.that.readFile(b, function(b) {
            a("#tab-reference-preview").removeClass("d-none"),
            a("#tab-reference-preview").html(b)
        })
    }
    ;
    var ea = function(a) {
    ...
    ea.prototype.init = function() {
        if (this.that.online) {
            ...
            this.that.repositionScreen(!1),
            this.that.settings.persLayers = !1,
            a(document).on("click", ".online-layer-block", function() {
                var c = a(this)
                  , d = c.attr("data-user")
                  , e = 1;
                c.hasClass("off") && (e = 0),
    ...
    ea.prototype.updateWhosOnline = function() {
        ...
        a(".online-users-append").html(""),
        a.each(this.users, function(c, d) {
    ...
    ,
    ea.prototype.updateOnlineStatus = function() {}
    ,
    ea.prototype.addLayerTemplate = function(b) {
    ...
    ea.prototype.activate = function() {
        this.removeElements(),
        this.that.autosave.status = !1,
        a("#drawing-canvas-conatiner").addClass("full")
    }
    ,
    ea.prototype.removeElements = function() {
        a("#frames-placement").remove(),
        a("#delete-layer, #duplicate-layer, #move-layer.merge, #add-layer, #rename-layer, .online-remove").remove(),
        a(".online-hidden").addClass("hidden")
    }
    ,
    ea.prototype.listenLayer = function() {
        ...
        a.on("child_changed", function(a) {
            a.val().blockWrite && (_this.that.showAlert("Connection has been lost. You can continue to draw but your session has expired", 1e4),
            _this.canWrite = !1),
            a.val().blockRead && (_this.canRead = !1)
        })
    }
    ,
    ea.prototype.initalCalls = function() {
        ...
        this.database.ref(this.that.online.database + "/layers/" + this.that.online.layer_id).once("value").then(function(b) {
            return b.hasChildren() ? b.val().removed ? (a.removed = !0,
            void a.that.showAlert("You are not allowed to draw in this room", 3e4)) : void a.added() : a.writeLayer()
        })
    }
    ,
    ...
    ea.prototype.added = function() {
        function a(a, c) {
            if (!a.val().removed && (b.that.loadImage(a.val().src, function(d) {
                var e = {
                    online_name: a.val().name,
                    user: a.val().user,
                    image: a.val().user_image
                };
                b.that.LayerController.addLayer(!1, a.val().name, d, a.val().opacity, e),
                b.that.LayerController.select(),
                f.push("null"),
                c && (b.that.LayerController.currentLayer = f.length,
                b.that.LayerController.select()),
                b.that.FrameController.updateFramePreview(),
                b.addLayerTemplate(a.val().name)
            }),
            a.val().user)) {
                var d = {
                    username: a.val().name,
        ...
        var b = this
          ...
          , f = [];
        this.addedCalled = !0,
        this.removed || (e.on("child_added", function(d) {
            return b.that.online.layer_id != d.val().name || c ? void a(d) : void (c = d)
        }),
        c && d && (a(c, !0),
        d = !1))
    }
    ...
    ea.prototype.changed = function() {
        ...
        function c(b, c) {
            return d.that.loadImage(c.val().src, function(a) {
                ...
                e.src = a,
                e.opacity = parseFloat(c.val().opacity),
                d.that.updateDisplayCanvas(d.that.LayerController.layers, d.that.LayerController.currentLayer),
                d.that.LayerController.updateCurrentLayerSrc(b),
                d.that.render()
            }),
        ...
        e.on("child_changed", function(e) {
            return d.that.online.layer_id == e.val().name && e.val().removed ? (d.removed = !0,
            void d.that.showAlert("Connection has been lost. Please save as a .pixil or download now.", 3e4)) : void (e.val().name == d.that.online.layer_id || d.removed || a.each(d.that.LayerController.layers, function(a, d) {
    ...
    ea.prototype.writeLayer = function() {
        if (this.that.online.status && !this.removed) {
            var a = this.that.canvas.layer.dataURL()
              ...
              , c = (this.database.ref(b),
            this.that.LayerController.layers[this.that.LayerController.currentLayer])
              , d = {
                name: this.that.online.layer_id,
                src: a,
                opacity: c.opacity
            };
            this.that.online.user && (d.user = this.that.online.user,
            d.user_image = this.that.online.user_image,
    ...
    var ga = {
        ...
        init: function(d, e, f, g, h) {
            ...
            j.length >= 1 && (this.online.status = !0,
            this.online.database = j.attr("data-online-id"),
            this.online.layer_id = j.attr("data-layer-id"),
            this.online.maker_user_id = j.attr("data-maker-user-id"),
            j.attr("data-user") && (this.online.user = j.attr("data-user"),
            this.online.user_image = j.attr("data-user-image"),
            this.online.user_id = j.attr("data-user-id"))),
            a("body").attr("data-user") && (this.user.status = !0,
            this.user.username = a("body").attr("data-username")),
            g && (this.app.callback = g),
            a("#palette").length && a("#palette").attr("data-id") && (this.palette_id = a("#palette").attr("data-id")),
            a("#skip-new").length && (this.options.skipNew = !0),
            a("#bg-color").length && (this.options.bgColor = a("#bg-color").attr("data-value")),
            a("body").data("user") && (this.isAuth = !0),
            a("#check-mouse-icon").length && (this.checkMouseIcon = !0),
            a("#is-photo").length && (this.isPhotoEdit = a("#is-photo").attr("data-url")),
            h && (this.ons = h),
            this.FileController = new X(this),
            this.FileController.init();
            var m = new c(0,"Background");
            if (m.src = new Image,
            m.src.src = "",
            m.init(),
            l <= 690 && l >= 550 && k > 1360 && !d && (this.width = 32,
            this.height = 32),
            d && (this.width = parseInt(d)),
            e && (this.height = parseInt(e)),
            this.FileController.checkRatio(this.width, this.height) && (this.width = 32,
            this.height = 32),
            "object" == typeof f && ("string" == typeof f.image && ["gif", "png"].indexOf(this.fileExtension(f.image)) != -1 && (this.edit.status = !0,
            this.edit.unqid = f.unqid),
            "boolean" == typeof f.skipNew && (this.options.skipNew = !0),
            "string" == typeof f.title && (this.edit.title = f.title,
            this.edit.description = f.description),
            f.isApp && (this.app.ready = !1,
            this.customSize = !0,
            this.app.edit_id = !1,
            this.settings.persLayers = !0,
            f.drawWithMouse && (this.app.fingerToDraw = !1),
            f.id && (this.id = f.id),
            f.name && (this.drawingName = f.name),
            f.image && (this.edit.status = !0),
            f.isExternal ? this.isExternal = !0 : this.isExternal = !1,
            f.art_id && (this.app.edit_id = f.art_id),
            f.app_edit_id && (this.app.edit_id = f.app_edit_id),
            f.frames ? this.app.frames = f.frames : this.app.frames = !1,
            this.app.speed = f.speed ? f.speed : 50)),
            this.checkMobile(h),
            this.checkTablet(),
            this.checkTouchScreen(),
            this.checkUserAgent(),
            this.validateSize(this.width, this.height),
            this.isWindowsIE && !this.edit.status && (this.width = 32,
            this.height = 32),
            this.checkSettings(),
            this.controllersLoaded || (this.HistoryController = new G(this),
            this.HistoryController.init(),
            this.FrameController = new J(this),
            this.FrameController.init(),
            this.LayerController = new I(this),
            this.LayerController.init(m),
            this.ColorController = new K(this),
            this.ColorController.init(),
            this.SelectController = new O(this),
            this.SelectController.init(),
            this.ToolController = new E(this),
            this.ToolController.init(),
            this.PreviewController = new N(this),
            this.PreviewController.init(),
            this.KeyboardController = new P(this),
            this.KeyboardController.init(),
            this.TextController = new Q(this),
            this.TextController.init(),
            this.PopupController = new U(this),
            this.PopupController.init(),
            this.SettingsController = new R(this),
            this.SettingsController.init(),
            this.StampController = new T(this),
            this.StampController.init(),
            this.GifController = new V(this),
            this.GifController.init(),
            this.HueController = new S(this),
            this.HueController.init(),
            this.ExportImportController = new W(this),
            this.ExportImportController.init(),
            this.SubmitController = new Y(this),
            this.SubmitController.init(),
            this.InfoController = new Z(this),
            this.InfoController.init(),
            this.ShortcutController = new $(this),
            this.ShortcutController.init(),
            this.AlignController = new aa(this),
            this.AlignController.init(),
            this.AdController = new F(this),
            this.AdController.init(),
            this.TileController = new ba(this),
            this.TileController.init(),
            this.OutlineController = new ca(this),
            this.OutlineController.init(),
            this.DownloadController = new M(this),
            this.DownloadController.init(),
            this.ReferenceController = new da(this),
            this.ReferenceController.init()),
            this.getPixelRatio(),
            this.canvas.layer = new b(this.width,this.height,"layer",(!0),(!1),(!1),this),
            this.canvas.layer.ctx = this.canvas.layer.context(),
            this.canvas.layer.empty = this.canvas.layer.clear(!0),
            this.canvas.bottom = new b(this.width,this.height,"bottom",(!0),(!1),(!1),this),
            this.canvas.bottom.ctx = this.canvas.bottom.context(),
            this.canvas.bottom.empty = this.canvas.bottom.clear(!0),
            this.canvas.select = new b(1,1,"select",(!0),(!1),(!1),this),
            this.canvas.select.ctx = this.canvas.select.context(),
            this.canvas.select.empty = this.canvas.select.clear(!0),
            this.canvas.rendering = new b(this.width,this.height,"rendering",(!0),(!1),(!1),this),
            this.canvas.rendering.ctx = this.canvas.rendering.context(),
            this.canvas.rendering.empty = this.canvas.rendering.clear(!0),
            this.canvas.data = new b(this.width,this.height,"data",(!0),(!1),(!1),this),
            this.canvas.data.ctx = this.canvas.data.context(),
            this.canvas.data.empty = this.canvas.data.clear(!0),
            this.createCssDisplayGrid(),
            this.canvas.display = new b(this.width,this.height,"display",(!1),this.pixel_size,"canvas-layers-appened",this),
            this.canvas.display.ctx = this.canvas.display.context(),
            this.OnlineController = new ea(this),
            this.NavigationController = new _(this),
            this.NavigationController.init(),
            this.ZoomController = new L(this,this.canvas.display,this.zoom.type),
            this.ZoomController.init(),
            this.resizeCanvases(),
            this.element = document.getElementById("canvas-layers-appened"),
            this.mouse = new H(this),
            this.mouse.listeners(),
            this.begin(),
            ...
            "object" == typeof f && "string" == typeof f.image)
                ...
                this.edit.status)
                    if (this.newShow = !1,
                    this.edit.image_src = f.image,
                    f.resize && (this.edit.resize = f.resize),
                    f.file)
                        if (this.isApp && "object" == typeof f.file) {
                            var n = JSON.stringify(f.file);
                            n = this.decodeImage(n),
                            this.ExportImportController["import"](n, !0, !1, function() {
                                i.ready()
                            }, !0)
                        } else
                            this.ExportImportController.fromURL(f.file, function() {
                                i.ready(),
                                i.showTipStepperOrAds()
                            }, !0);
                    else
                        this.getEditImage(),
                        this.showTipStepperOrAds();
                else
                    this.ready(),
                    this.showTipStepperOrAds();
            else
            ...
            if (this.online.status) {
                var o = new tipStepper(toolTipCookie,function() {}
                ,"#forced-step",(!0));
                o.init()
            }
        },
        showTipStepperOrAds: function() {
            ...
            if (!this.isApp) {
                ...
                if (c || this.isMobile || this.isTablet)
                    this.startTipLoadAds(),
                    this.togglePassiveInput(!0);
                else {
                    this.hidePopup(),
                    this.isApp || (this.passiveSet = !0,
                    this.togglePassiveInput(!1));
                    var d = new tipStepper(b,function() {
                        a.newShow = !1,
                        a.startTipLoadAds(),
                        a.togglePassiveInput(!0),
                        a.clickCount || a.online.status || a.edit.status || a.FileController.showPopup()
                    }
                    );
                    d.init()
                }
        ...
        checkUserAgent: function() {
            if (!this.isApp) {
                ...
                b.indexOf("safari") == -1 || this.isMobile || this.isTablet || b.indexOf("chrome") > -1 || b.indexOf("opera") > -1 || b.indexOf("opr") > -1 || (this.filter.status = !1,
                a(".remove-safari").remove()),
                /MSIE 10/i.test(navigator.userAgent) && this.isIE(),
                (/MSIE 9/i.test(navigator.userAgent) || /rv:11.0/i.test(navigator.userAgent)) && (a("body").addClass("ie"),
                this.isIE()),
                /Edge\/\d./i.test(navigator.userAgent) && this.isIE()
            }
        },
        isIE: function() {
            this.isWindowsIE = !0,
            a("#resize-pix, .navigation-scroller").hide(),
            a(".sidebar-preview-tab span").html('<i class="fa fa-home f-nm"></i>'),
            a(".sidebar-layers-tab span").html('<i class="fa fa-file-o f-nm"></i>'),
            a(".sidebar-options-tab span").html('<i class="fa fa-sliders f-nm"></i>'),
            a(".sidebar-tools-tab span").html('<i class="fa fa-wrench f-nm"></i>'),
            a(".sidebar-online-tab span").html('<i class="fa fa-users f-nm"></i>')
        },
        checkScreenSize: function() {
            var b = a("#frames-placement").height();
            this.online.status && (b = 0);
            var c = a("#drawing-container").height() - b;
            this.screen.width = this.window.width(),
            this.screen.height = this.window.height(),
            this.screen.width > 1400 && (this.screen.is_large = !0),
            this.isMobileDevice || a("#left-sidebar .screen-sizer, #right-sidebar .screen-sizer").height(c)
        },
        begin: function() {
            !this.isApp,
            this.loadSettings(),
            a(".older-version-text").remove(),
            this.options.bgColor && (this.canvas.layer.ctx.fillStyle = this.options.bgColor,
            this.canvas.layer.ctx.fillRect(0, 0, this.width, this.height)),
            this.checkScreenSize(),
            this.checkSmoothing(),
            this.listerners(),
            this.showChecker(!0),
            this.showGrid(!0),
            this.controllersLoaded = !0,
            this.ToolController.showOptions()
        },
        ready: function() {
            this.finished = !0,
            this.finishLoading(),
            this.PreviewController.close(),
            this.isPhotoEdit && (this.FileController.importPhotoFromUrl(this.isPhotoEdit),
            this.edit.status = !0,
            this.isPhotoEdit = !1),
            a(".app-start-section").remove(),
            a(".after-app-ready-show").show();
            var b = this.getStorage("new_draw_per");
            return b && (this.settings.persLayers = "false" != b,
            this.settings.persLayers && a("#layer-lepard").show()),
            this.FrameController.updateFramePreview(!1, !0),
            this.HistoryController.newCanvas(),
            this.online.status && this.OnlineController.init(),
            this.checkConditions(),
            this.ToolController.loadOptions(),
            this.edit.status || this.isMobile || this.autosave.loaded || this.online.status || this.options.skipNew || this.FileController.showPopup(),
            a("#debug").length && this.enableDebug(),
            a("#no-ads").length && (this.ads.status = !1),
            this.FileController.updateDimensions(),
            this.loadAds(),
            this.LayerController.updateList(),
            this.ZoomController.reset(!0),
            this.doFinal(),
            this.app.callback ? this.app.callback(this) : void this.createWatermarkImage()
        },
        doFinal: function() {
            setTimeout(function() {
        ...
        enableDebug: function() {
            a(".hidden-canvas").removeClass("hidden-canvas"),
            this.debug = !0
        },
        ...
        getPixelRatio: function(b, c, d) {
            ...
            var l = 0
              , m = (k - g) / this.height;
            if ((this.width > this.height || k > j || this.settings.frames.tile) && (l = (j - g) / this.width),
            i = m,
            m > l && l > 0 && (i = l),
            this.settings.frames.tile && (i = l),
            !this.isMobile || this.isTablet || this.isApp || (i = k > a(window).width() || this.isApp && !c && k > a(window).width() ? parseInt(a(window).width() - h) / this.width : parseInt(k - h) / this.width,
            this.isApp || (this.pixelPerfect.status = !0)),
            i = i <= 0 ? 1 : i,
            this.isWindowsIE && (i = this.round(i, 1)),
            !this.isApp && !this.isWindowsIE) {
            ...
            return (this.settings.tile.status || this.settings.frames.tile) && (i /= 3),
            this.ratio_size = i - 1,
            this.zoom["default"] = i,
            i > this.grid.max_size && (this.zoom["default"] = this.round(i, .5, "down")),
            i < 1 ? (this.zoom.minZoom = i,
            a("#zoom-range").attr("min", i)) : a("#zoom-range").attr("min", 1),
            i = 1,
            this.previewSize = this.zoom["default"],
            this.pixel_size = i,
            i
        },
        render: function() {
            this.loading = !0,
            this.canvas.display.clear(),
            this.draw(),
            this.startData(),
        ...
        listerners: function() {
            function b() {
                c.settings.lockFrames || (a("#frames-container").stop().slideUp(500),
                d = !1)
            }
            var c = this
              , d = !1
            ...
            this.debug && a(".hidden-canvas").css({
                visibility: "visible"
            }),
            ...
            this.isMobile && !this.isTablet || (a(".panel-frames-header").on("pointerdown", function(e) {
                if (!c.settings.lockFrames && !a(".prevent-panel-up").has(e.target).length) {
                    var f = e.target.id;
                    null != f && "" != f.trim() && f || (f = e.target.parentNode.id),
                    ["preview", "preview-size-change"].indexOf(f) > -1 || (!d || ["duplicate-frame", "add-frame", "preview-size-change", "toggle-frame-panel"].indexOf(f) > -1 ? (a("#frames-container").stop().slideDown(500),
                    d = !0) : b())
                }
            }),
            ...
            a(".full-screen-toggle").click(function(b) {
                ...
                c.fullscreen.status = !0,
                a("#drawing-wrapper").addClass("fullscreen"),
                c.requestFullScreen(d, e),
                setTimeout(function() {
                    c.repositionScreen()
                }, 100)
            }),
            a(".toggle-sub").mouseup(function() {
                a("#toolbar").toggleClass("sub-open"),
                a(this).toggleClass("active")
            }),
            a(".toggle-sub").mouseover(function() {
                a("#toolbar").hasClass("sub-open") && (a(".toggle-sub").removeClass("active"),
                a(this).addClass("active"))
            }),
            ...
            a(document).bind("pointerdown", function(b) {
                var c = a("#right-sidebar")
                  ...
                  , g = e.is(b.target);
                (!c.is(b.target) && 0 === c.has(b.target).length && d.is(b.target) && 0 === d.has(b.target).length || f || g) && (a("#right-sidebar").removeClass("active"),
                a("#left-sidebar").removeClass("active"))
            }),
            a(document).bind("mousedown", function(b) {
                ...
                a("#drawing-canvas-conatiner"))
                  , f = e.has(b.target).length;
                a("#left-sidebar").removeClass("active"),
                (!c.is(b.target) && 0 === c.has(b.target).length && !d.is(b.target) && 0 === d.has(b.target).length || f) && a("#frames-placement").removeClass("active")
            }),
            ...
            (this.isMobile || this.isTablet || this.isIpad) && a(document).bind("touchstart", function(b) {
                var c = a(b.target);
                c.closest("#toolbar").length || (a("#toolbar").removeClass("sub-open"),
                a(".toggle-sub").removeClass("active"))
            })) : (a(document).mousedown(function(b) {
                var d = a(event.target);
                d.closest("#toolbar").length || (a("#toolbar").removeClass("sub-open"),
                a(".toggle-sub").removeClass("active")),
                c.ToolController.hideMulti()
            }),
        ...
        changeTheme: function() {
            this.settings.theme.lighter ? (a("#header-logo").attr("src", "/images/public/logo_pixilart_simple_black.png"),
            a("#drawing-wrapper").addClass("lighter")) : (a("#header-logo").attr("src", "/images/public/logo_pixilart_simple_white.png"),
            a("#drawing-wrapper").removeClass("lighter"))
        },
        ...
        setAppSettings: function() {
            this.app.hideMouse && a(".pixel-trace").addClass("hide-mouse"),
            this.app.fingerToDraw && a(".pixel-trace").hide()
        },
        setAppInit: function() {},
        ...
        layPixel: function(a, b, c, d, e, f, g, h) {
            c || (a = a ? a : this.mouse.x_0,
            b = b ? b : this.mouse.y_0);
            var i = this.pixelDrawingSize;
            return e = e ? e : "layer",
            d = d ? d : this.getDrawingcolor(),
            1 == this.pixelDrawingSize || f || (a -= this.pixelDrawingSize / 2,
            b -= this.pixelDrawingSize / 2),
            f && (i = f),
            !(this.settings.dithering && this.isOdd(a) && this.isOdd(b) || this.settings.dithering && !this.isOdd(a) && !this.isOdd(b)) && void this.drawPixel(e, a, b, d, i, g, h)
        },
        drawPixel: function(a, b, c, d, e, f, g) {
            if ("Brush" == this.tool && this.settings.brush.image && !f) {
                ...
                1 !== this.ToolController.tool.options.alpha.value && this.canvas[a].setAlpha(this.ToolController.tool.options.alpha.value),
                this.ToolController.tool.options.pattern.value && (j = this.settings.brush.black,
                this.canvas.data.putSimple(this.ToolController.backgroundPatternImage, 0, 0),
                this.canvas.data.ctx.globalCompositeOperation = "destination-in"),
                this.canvas[a].putSimple(j, h, i),
                this.ToolController.tool.options.pattern.value && (this.canvas.data.putSimple(this.canvas[a].canvas),
                this.canvas.data.ctx.globalCompositeOperation = "source-over"),
                1 !== this.ToolController.tool.options.alpha.value && this.canvas[a].restoreAlpha()
            } else if (this.settings.roundedPixel && this.mouse.roundImage && ["Pencil", "Line", "Square", "Circle"].indexOf(this.tool) > -1)
                this.canvas[a].putSimple(this.mouse.roundImage, b, c);
            else {
                var k = e
                  , l = e;
                g && (k = g.w,
                l = g.h),
                this.canvas[a].ctx.fillStyle = d,
                this.canvas[a].ctx.fillRect(b, c, k, l)
            }
        },
        getDrawingcolor: function() {
            var a = this.ColorController.color;
            return this.rainbow.status && (a = this.getRainbowColor()),
            this.randomColor.status && (a = this.getRandomColorPallet()),
            a
        },
        renderPixel: function(a, b, c, d, e, f, g) {
            ...
            b = b ? b : this.mouse.y_0),
            e = e ? e : "rendering",
            f = f ? f : this.pixelDrawingSize;
            var h = this.mouse.absPosition(a, b)
              , i = this.mouse.absPosition(this.pixelPerfect.last.x, this.pixelPerfect.last.y);
            if (d = d ? d : this.getDrawingcolor(),
            this.pixelPerfect.status && !g && 1 === f && (this.pixelPerfect.preHistory.indexOf(h) === -1 && this.pixelPerfect.history.indexOf(h) === -1 && this.pixelPerfect.preHistory.push(h),
            this.pixelPerfect.preHistory.length > 3)) {
                var j = this.pixelPerfect.preHistory[0];
                this.pixelPerfect.preHistory.shift(),
                this.pixelPerfect.history.indexOf(h) === -1 && this.pixelPerfect.history.push(j)
            }
            if (this.pixelPerfect.status && 1 == f && !g) {
                var k = this.pixelPerfect.direction;
                this.pixelPerfect.last.x,
                this.pixelPerfect.last.y;
                this.pixelPerfect.last.x == a && this.pixelPerfect.last.y == b || this.pixelPerfect.set++,
                (this.pixelPerfect.last.x == a && this.pixelPerfect.last.y != b && "left" == this.pixelPerfect.direction && this.pixelPerfect.set > 1 || this.pixelPerfect.last.x != a && this.pixelPerfect.last.y == b && "top" == this.pixelPerfect.direction && this.pixelPerfect.set > 1) && this.pixelPerfect.history.indexOf(i) === -1 && (this.canvas[e].ctx.clearRect(this.pixelPerfect.last.x, this.pixelPerfect.last.y, 1, 1),
                this.mirrorDrawing(!1, "rendering", !0, this.pixelPerfect.last.x, this.pixelPerfect.last.y),
                this.pixelPerfect.set = 0),
                this.pixelPerfect.last.x != a && this.pixelPerfect.last.y != b && (this.pixelPerfect.set = 0),
                this.pixelPerfect.last.x != a && (this.pixelPerfect.last.y == b && (k = "left"),
                this.pixelPerfect.last.x = a),
                this.pixelPerfect.last.y != b && (this.pixelPerfect.last.x == a && (k = "top"),
                this.pixelPerfect.last.y = b),
                k != this.pixelPerfect.direction && (this.pixelPerfect.set > 1 && (this.pixelPerfect.set = 0),
                this.pixelPerfect.direction = k)
            }
            if (1 != f && (a -= f / 2,
            b -= f / 2),
            this.settings.dithering && this.isOdd(a) && this.isOdd(b) || this.settings.dithering && !this.isOdd(a) && !this.isOdd(b))
                return !1;
            var l = this.pixelDrawingSize;
            ["Dithering"].indexOf(this.tool) > -1 && (l = 1),
            this.drawPixel(e, a, b, d, l)
        },
        ditheringLayPixel: function(a, b, c, d, e) {
            var a = a ? a : this.mouse.x_0
              ...
              , f = this.isOdd(a)
              , g = this.isOdd(b);
            (f && g && !e || !f && !g && !e || !f && g && e || f && !g && e) && (d && "rendering" == d ? this.renderPixel(a, b, !1, !1, !1, 1) : this.layPixel(a, b, !1, !1, !1, 1),
            this.lastDitheringX = a,
            this.lastDitheringY = b)
        },
        ...
        clearPixel: function(a, b, c, d, e) {
            ...
            e && (i = e.w,
            j = e.h),
            this.canvas.data.canvas.width == this.width && this.canvas.data.canvas.height == this.height || (this.canvas.data.canvas.width = this.width,
            this.canvas.data.canvas.height = this.height),
            "Eraser" == this.tool && this.ToolController.tool.options.strength.value < 1 && !this.settings.roundedPixel && (g = !0,
            this.canvas.data.ctx.clearRect(a, b, i, j),
            this.canvas.data.setAlpha(1 - this.ToolController.tool.options.strength.value),
            this.canvas.data.putSimple(this.canvas[d].canvas, 0, 0),
            this.canvas.data.setAlpha(1)),
            ("Eraser" == this.tool || "Pencil" == this.tool) && this.settings.roundedPixel && this.mouse.roundImage && (i += 1,
            j += 1,
            g = !0,
            h = this.ToolController.tools.EraserTool.options.strength.value ? this.ToolController.tools.EraserTool.options.strength.value : h,
            this.canvas.data.ctx.clearRect(a, b, i, j),
            this.canvas.data.putSimple(this.canvas[d].canvas, 0, 0),
            this.canvas.data.ctx.globalCompositeOperation = "destination-out",
            this.canvas.data.setAlpha(h),
            this.canvas.data.putSimple(this.mouse.roundImageMouse, a, b),
            this.canvas.data.setAlpha(1),
            this.canvas.data.ctx.globalCompositeOperation = "source-over"),
            this.canvas[d].ctx.clearRect(a, b, i, j),
            g && this.canvas[d].ctx.drawImage(this.canvas.data.canvas, a, b, i, j, a, b, i, j)
        },
        mouseDistance: function(a, b) {
            a && (this.mouse.x_0 = a),
            b && (this.mouse.y_0 = b);
            var c = 2 * this.mouse.err;
            return c > -this.mouse.dy && (this.mouse.err = this.mouse.err - this.mouse.dy,
            this.mouse.x_0 = this.mouse.x_0 + this.mouse.sx),
            c < this.mouse.dx && (this.mouse.err = this.mouse.err + this.mouse.dx,
            this.mouse.y_0 = this.mouse.y_0 + this.mouse.sy),
            this.mouse.x0 = this.mouse.x_0,
            this.mouse.x1 = this.mouse.x_0,
            [this.mouse.x_0, this.mouse.x_0]
        },
        mirrorDrawing: function(a, b, c, d, e) {
            if (this.mirror.tools.indexOf(this.tool) !== -1) {
                var f = !1
                  , g = !1
                  , h = !1;
                if (this.ToolController.tool.options && this.ToolController.tool.options.mirrorX && this.ToolController.tool.options.mirrorX.value && (g = !0),
                this.ToolController.tool.options && this.ToolController.tool.options.mirrorY && this.ToolController.tool.options.mirrorY.value && (h = !0),
                this.keyEvent && this.keyEvent.ctrlKey && ["Pencil"].indexOf(this.tool) !== -1 && (f = !0),
                this.mouse.active) {
                    d = d ? d : this.mouse.x_0,
                    e = e ? e : this.mouse.y_0;
                    var i = this.width - (d + 1)
                      , j = this.height - (e + 1);
                    (this.mirror.x || g) && (f ? this.ditheringLayPixel(i, this.mouse.y_0, a) : b && "rendering" == b ? c ? this.clearPixel(i, e, !1, "rendering") : this.renderPixel(i, this.mouse.y_0, !1, a, !1, !1, !0) : c ? this.clearPixel(i, this.mouse.y_0) : this.layPixel(i, this.mouse.y_0, !1, a)),
                    (this.mirror.y || h) && (f ? this.ditheringLayPixel(this.mouse.x_0, j, a) : b && "rendering" == b ? c ? this.clearPixel(d, j, !1, "rendering") : this.renderPixel(this.mouse.x_0, j, !1, a, !1, !1, !0) : c ? this.clearPixel(this.mouse.x_0, j) : this.layPixel(this.mouse.x_0, j, !1, a)),
                    (this.mirror.x && this.mirror.y || g && h) && (f ? this.ditheringLayPixel(i, j, a) : b && "rendering" == b ? c ? this.clearPixel(i, j, !1, "rendering") : this.renderPixel(i, j, !1, a, !1, !1, !0) : c ? this.clearPixel(i, j) : this.layPixel(i, j, !1, a))
                }
            }
        },
        rgbaToHex: function(a, b, c) {
            return (a > 255 || b > 255 || c > 255) && (a > 255 && (a = 255),
            b > 255 && (b = 255),
            c > 255 && (c = 255)),
            (a << 16 | b << 8 | c).toString(16)
        },
        trim: function(a) {
        ...
        numberToHex: function(a) {
            return a = parseInt(a).toString(16),
            (a + "000").substring(0, 2)
        },
        rgbToAbgr: function(a) {
            ...
            1 == c.length && (c = "0" + c),
            1 == b.length && (b = "0" + b),
            "0xFF" + (b + "000").substring(0, 2) + (c + "000").substring(0, 2) + (d + "000").substring(0, 2)
        },
        ...
        HSVtoRGB: function(a, b, c) {
            var d, e, f, g, h, i, j, k;
            switch (1 === arguments.length && (b = a.s,
            c = a.v,
            a = a.h),
            g = Math.floor(6 * a),
            h = 6 * a - g,
        ...
        RGBtoHSV: function(a, b, c) {
            1 === arguments.length && (b = a.g,
            c = a.b,
            a = a.r);
            var d, e = Math.max(a, b, c), f = Math.min(a, b, c), g = e - f, h = 0 === e ? 0 : g / e, i = e / 255;
            switch (e) {
            case f:
                d = 0;
                break;
        ...
        displayCanvasLocation: function() {
            ...
            "CSS" == this.zoom.type && (b = 1,
            c = this.mouse.x_1,
            d = this.mouse.y_1);
            var e = c * b
              , f = d * b
              , g = this.pixelDrawingSize;
            return ["BucketClear", "Bucket", "BucketColor", "Select", "Text", "Spray", "Hand", "Gradient", "ColorPicker", "Move", "Dithering", "Stamp", "LightenDarken", "Brush"].indexOf(this.tool) != -1 && (g = 1),
            1 != g && (b = g * b,
            e -= b / 2,
            f -= b / 2),
            {
        ...
        createGrid: function(b, c, d) {
            if (b = b ? b : "grid",
            "undefined" != typeof this.canvas.grid)
                if ("Canvas" != this.zoom.type && !this.isWindowsIE && this.grid.status) {
                    ...
                    Math.ceil(this.width * e),
                    Math.ceil(this.height * e);
                    if (a("#canvas_grid_image").removeAttr("style"),
                    !(e <= this.grid.max_size))
                        return e *= this.settings.gridSize,
                        "CSS" == this.zoom.type && (this.canvas.grid.canvas.width = e,
                        this.canvas.grid.canvas.height = e,
                        this.canvas.grid.setSmoothing(),
                        f.moveTo(0, 0),
                        f.lineTo(e, 0),
                        f.moveTo(0, 0),
                        f.lineTo(0, e),
                        ...
                        f.stroke(),
                        this.grid.data = this.canvas.grid.image(),
                        this.canvas.grid.canvas.width = 1,
                        this.canvas.grid.canvas.height = 1,
                        "CSS" == this.zoom.type && this.grid.status && a("#canvas_grid_image").show(),
                        "CSS" == this.zoom.type && (this.grid.data.width = e,
                        this.grid.data.height = e,
                        a("#canvas_grid_image").css({
                            "background-image": "url(" + this.grid.data.src + ")",
                            "background-size": e + "px"
                        })),
                        "grid" != b && this.canvas.grid.clear(),
                        c ? c(!0) : void 0;
                    if (c)
                        return c(!1)
                } else if (c)
        ...
        toggleGridIcon: function(b) {
            ...
            a("#canvas_grid_image").hide(),
            this.grid.status && (c.addClass("active"),
            "CSS" == this.zoom.type && this.SettingsController.loadCssGrid(this.grid.status)),
            this.grid.show || c.hide()
        },
        downloadAppCanvas: function(a) {
            if (this.isApp) {
                ...
                this.ons.platform.isAndroid() ? this.canvas[a].canvas.toBlob(function(c) {
                    b.ons.downloadAndroid(Date.now() + ".png", c),
                    b.canvas[a]["default"]()
        ...
        createCssDisplayGrid: function(a) {
            var c = this.width
              , d = this.height;
            this.canvas.grid = new b(c,d,"grid",(!1),"force","canvas-layers-appened",this),
            this.canvas.grid.ctx = this.canvas.grid.context(),
            this.canvas.grid.canvas.width = 1,
            this.canvas.grid.canvas.height = 1,
            this.grid.canvas = !0
        },
        createChecker: function() {
            for (var a = this.canvas.rendering.ctx, b = (this.width * this.pixel_size,
            this.height * this.pixel_size,
            0), c = 0, d = 0, e = 0; e <= this.width; e++)
                for (var f = 0; f <= this.height; f++)
                    d = e + f,
                    this.isOdd(d) || (b = e,
                    c = f,
                    a.fillRect(b, c, 1, 1));
            this.checker.data = this.canvas.rendering.image(),
            this.canvas.rendering.clear()
        },
        isEven: function(a) {
        ...
        offImageSmoothing: function(a) {
            this.canvas[a].ctx.imageSmoothingEnabled = !1,
            this.canvas[a].ctx.msImageSmoothingEnabled = !1,
            this.canvas[a].ctx.mozImageSmoothingEnabled = !1,
            this.canvas[a].ctx.webkitImageSmoothingEnabled = !1
        },
        compareImageData: function(a, b) {
            for (var c = 0; c < a.data.length; c += 4)
                a.data[c + 0] == b.data[c + 0] && a.data[c + 1] == b.data[c + 1] && a.data[c + 2] == b.data[c + 2] && a.data[c + 3] == b.data[c + 3] && (a.data[c + 0] = 0,
                a.data[c + 1] = 255,
                a.data[c + 2] = 0,
                a.data[c + 3] = 255);
            return a
        ...
        getColorDataFromImageData: function(a, b, c) {
            for (var d = 0; d < a.data.length; d += 4) {
                ...
                c.indexOf(e) == -1 && (b.push(a.data[d + 0]),
                b.push(a.data[d + 1]),
                b.push(a.data[d + 2]),
                c.push(e))
            }
        ...
        sizeUp: function(a, b, c) {
            ...
            a.onload = function() {
                var a = this.width * b
                  , e = this.height * b;
                d.canvas.data.clear(),
                d.canvas.data.canvas.width = a,
                d.canvas.data.canvas.height = e,
                d.offImageSmoothing("data"),
                d.canvas.data.ctx.drawImage(this, 0, 0, a, e),
                c(d.canvas.data.image())
            }
        },
        canvasToSolid: function(a, b, c, d, e) {
            var f = this
              , g = [];
            b = b ? b : this.ColorController.color,
            c = c ? c : 1,
            f.canvas.data.clear(),
            f.canvas.data.setSmoothing(),
            f.canvas.data.canvas.width = a.width,
            f.canvas.data.canvas.height = a.height;
            try {
            ...
            for (var k = 0; k <= g.length - 1; k += 1) {
                ...
                if (f.layPixel(p.x, p.y, !0, r, "data", !0, d),
                k == g.length - 1)
                    return e ? e(f.canvas.data.dataURL()) : f.canvas.data.image()
            }
        },
        ...
        resizeImage: function(a, b, c, d, e) {
            ...
            h.onload = function() {
                f.canvas.data.clear(),
                f.canvas.data.canvas.width = this.width,
                f.canvas.data.canvas.height = this.height,
                f.canvas.data.ctx.drawImage(this, 0, 0);
                ...
                for (var l = 0; l < a.data.length; l += 4 * b) {
                    ...
                    e && 255 == m[0] && 255 == m[1] && 255 === m[2] && (m[3] = 0),
                    a.data[l + 3] > 0 && d && (m[0] = j.r,
                    m[1] = j.g,
                    m[2] = j.b);
                    var n = {
                        d: m,
                ...
                f.canvas.data.canvas.width = this.width / b,
                f.canvas.data.canvas.height = this.height / b;
        ...
        fileExtension: function(a) {
            var b = a;
            return b.indexOf("?") >= 0 && (b = b.substr(0, b.indexOf("?"))),
            b.split(".").pop()
        },
        ...
        useSelectTool: function(b, c) {
            return "Stamp" == this.tool || b ? ("Select" != this.tool && this.ToolController.selectTool(a("#select-tool"), "Select", !0),
            void ((!b && !c || this.isApp && !c) && this.SelectController.pasteSelection())) : (this.ToolController.stampCallback(),
            void this.StampController.hideStampContainer())
        },
        downloadOptions: function() {
            a(".hide-gif, .show-gif").addClass("hide"),
            a(".show-gif").addClass("hide"),
            this.FrameController.frames.length > 1 ? a(".show-gif").removeClass("hide") : a(".hide-gif").removeClass("hide"),
            this.fileDrawing && a(".submit-drawing-hideable, .autosave-wrapper").hide()
        },
        ...
        hidePopup: function() {
            this.closePopup && (a(".popup-close-button").show(),
            a(".p-header").show(),
            a(".popup-wrapper").removeClass("autoWidth"),
            a(".popup-container").hide(),
            this.TextController.canAssignLetter = !1,
            this.preventShortcut = !1,
            this.progress.doPreview = !1,
            this.newShow = !1,
            this.popup.open = !1,
            this.hideAllModals())
        },
        ...
        validateImageData: function(a, b) {
            var c = "-px199113-";
            if ("string" != typeof a || "string" == typeof a && a.length > 15350462)
                return console.info("Image upload failed due to size restrictions. Please contact support for information. Data size: " + a.length),
                !1;
            if (b) {
        ...
        validateSize: function(a, b) {
            a > this.maxWidth && (this.width = 500),
            a <= 8 && (this.width = 8),
            b > this.maxHeight && (this.height = 500),
            b <= 8 && (this.height = 8)
        },
        detectIE: function() {
        ...
        requestFullScreen: function(a, b) {
            ...
            c ? (document.exitFullscreen ? document.exitFullscreen() : document.webkitExitFullscreen ? document.webkitExitFullscreen() : document.mozCancelFullScreen ? document.mozCancelFullScreen() : document.msExitFullscreen && document.msExitFullscreen(),
            b.text(this.fullscreen.text)) : (a.requestFullscreen ? a.requestFullscreen() : a.mozRequestFullScreen ? a.mozRequestFullScreen() : a.webkitRequestFullScreen ? a.webkitRequestFullScreen() : a.msRequestFullscreen && a.msRequestFullscreen(),
        ...
        repositionScreen: function(a) {
            this.ads.lastRefreshTime && Date.now() < this.ads.lastRefreshTime || (this.checkScreenSize(),
            this.getPixelRatio(a),
            this.ZoomController.reset(!0),
            this.zoom.left = 0,
            this.zoom.top = 0,
            this.zoom.pixel_size = 1,
            this.zoom.ratio = 1,
            this.zoom_step = 1,
            this.createGrid(),
            this.toggleGridIcon(),
        ...
        resizeCanvases: function(b, c, d) {
            var e = this
              , b = b ? b : this.width;
            c = c ? c : this.height,
            a.each(this.canvas, function(d, f) {
                var g = 1
                  , h = e.canvas[f.name];
                "grid" != f.name && ("display" == h.name && (g = e.pixel_size),
                "CSS" == e.zoom.type && (a("#canvas-layers-container").width(b * g),
                a("#canvas-layers-container").height(c * g),
                g = 1),
                h.canvas.width = b * g,
                h.canvas.height = c * g,
                h.setDefault(h.canvas.width, h.canvas.height),
                h.clear())
            }),
            "CSS" == this.zoom.type && this.NavigationController.set(),
            this.checkSmoothing()
        },
        ...
        putStorage: function(a, b, c) {
            ...
            this.isApp || (b = this.encodeImage(b));
            var d = new Blob([b]).size;
            if (d > 5e6)
                return this.showAlert(this.messages("autosave_failed"), 1e4);
            try {
        ...
        getRandomColor: function() {
            for (var a = "2523456789ABADEF", b = "#", c = 0; c < 6; c++)
        ...
        toRaingbow: function() {
            var a, b, c;
            return this.rainbow.color || (this.rainbow.color = this.ColorController.color),
            a = this.hexToRgb(this.rainbow.color),
            b = this.RGBtoHSV(a.r, a.g, a.b),
            b.h = 100 * b.h,
            b.h++,
            b.h = b.h / 100,
            c = this.HSVtoRGB(b.h, b.s, b.v),
            c = this.rgbaToHex(c.r, c.g, c.b),
            c = "000000" + c,
            c = c.slice(-6),
            this.rainbow.color = c,
            "#" + this.rainbow.color
        },
        getRainbowColor: function() {
            var a;
            this.rainbow.color || (this.rainbow.color = this.ColorController.color,
            a = this.hexToRgb(this.rainbow.color)),
            a = this.hexToRgb(this.rainbow.color),
            null != a && null != a.r || (a = this.hexToRgb(this.rainbow.color));
            var b = ["r", "g", "b"];
            "up" == this.rainbow.direction ? this.rainbow.current++ : this.rainbow.current--;
            var c = b[this.rainbow.current];
            this.rainbow.current > 2 ? this.rainbow.direction = "down" : this.rainbow.current <= 0 && (this.rainbow.direction = "up"),
            "up" == this.rainbow[c] ? a[c]++ : a[c]--,
            a.r <= -1 && (a.r = 0,
            this.rainbow.r = "up"),
            a.g <= -1 && (a.g = 0,
            this.rainbow.g = "up"),
            a.b <= -1 && (a.b = 0,
            this.rainbow.b = "up"),
            a.r > 255 && (this.rainbow.r = "down"),
            a.g > 255 && (this.rainbow.g = "down"),
            a.b > 255 && (this.rainbow.b = "down");
            var d = this.rgbaToHex(a.r, a.g, a.b);
            return d = "000000" + d,
            d = d.slice(-6),
            this.rainbow.color = d,
            "#" + this.rainbow.color
        },
        ...
        getDrawnPixels: function(a, b, c, d, e, f) {
            b = b ? b : "layer";
            var g = e ? e : this.width
              , h = f ? f : this.height;
            g > 2e3 && (g = 2e3),
            h > 2e3 && (h = 2e3);
            var i = this.canvas[b].ctx.getImageData(0, 0, g, h)
              , j = this.getBaseSize(this.canvas[b].dataURL());
            j > 15e3 && (c = !1,
            this.colorsRgbaArray = !1);
            var e = 0
              , f = 0
              , k = "0"
              , l = 0
            ...
            for (var r = "", s = !0, t = 0; t < i.data.length; t += 4)
                if (s = !0,
                o >= g && (o = 0,
                p++),
                i.data[t + 3] > 0 && (r = i.data[t] + "" + i.data[t + 1] + i.data[t + 2] + i.data[t + 3],
                c && (this.arraySearch(q, r) || (q.push(r),
                this.colorsRgbaArray.push(i.data[t]),
                this.colorsRgbaArray.push(i.data[t + 1]),
                this.colorsRgbaArray.push(i.data[t + 2]),
                this.colorsRgbaArray.push(i.data[t + 3]))),
                d && d.length && this.colorsRgbaArray.length && (this.arrayRgbaSearch(this.colorsRgbaArray, [i.data[t], i.data[t + 1], i.data[t + 2], i.data[t + 3]]) ? i.data[t + 3] = 255 : (i.data[t + 3] = 0,
                s = !1)),
                s && (o >= l && (l = o),
                p >= n && (n = p),
                ("0" === k || "0" !== k && o < k) && (k = o),
        ...
        arrayRgbaSearch: function(a, b) {
            for (var c = 3, d = 0; d < a.length; d += 4) {
                if (b[0] - c < a[d] && b[0] + c > a[d] && b[1] - c < a[d + 1] && b[1] + c > a[d + 1] && b[2] - c < a[d + 2] && b[2] + c > a[d + 2])
                    return !0;
                if (d === a.length)
                    return !1
            }
        ...
        showAlert: function(b, c, d) {
            ...
            a("#response-message .alert-response-wrapper").removeClass("success"),
            a("#response-message .alert-response").text(b),
            "success" == d && a("#response-message .alert-response-wrapper").addClass("success"),
            this.alert.s = setTimeout(function() {
                e.hideAlert()
            }, c)
        },
        hideAlert: function() {
        ...
        getScaleUpRatioDecimal: function(a) {
            var b = a ? a : 1400
              ...
              , f = g * this.height
              , g = Math.max(c, d);
            return (e >= this.maxRatioWidth || f >= this.maxRatioHeight) && (g = Math.min(c, d)),
            g
        },
        getScaleUpRatio: function(a) {
            ...
            var h = g * this.width
              , i = g * this.height;
            return (h >= this.maxRatioWidth || i >= this.maxRatioHeight) && (g = Math.min(e, f)),
            g
        },
        ...
        b64toBlob: function(a, b) {
            ...
            for (var c = 1024, d = atob(a), e = d.length, f = Math.ceil(e / c), g = new Array(f), h = 0; h < f; ++h) {
                for (var i = h * c, j = Math.min(i + c, e), k = new Array(j - i), l = i, m = 0; l < j; ++m,
                ++l)
                    k[m] = d[l].charCodeAt(0);
        ...
        customLog: function(b, c) {
            c = c ? c : "debug-log-container",
            a(".debug-log-container").prepend("<p>" + b + "</p>")
        },
        newDrawing: function(b, d, e) {
            ...
            this.FrameController.frames = [];
            var g = new c(0,"Background");
            g.init(),
            this.LayerController.currentLayer = 0,
            this.FrameController.currentFrame = 0,
            this.FrameController.init(b),
            this.LayerController.init(g),
            this.ColorController.initColors(),
            this.app.frames = !1,
            b || (a(document).off("click", ".select-frame"),
            a(".frame-delete").unbind("click"),
            a(".add-frame").unbind("click"),
            a(".duplicate-frame").unbind("click"),
            this.ColorController.listenersRedo(),
            this.FrameController.listeners(),
            this.ToolController.listeners(),
            this.HistoryController.listeners())
        },
        ...
        createCanvas: function(a, c, d, e) {
            ...
            d = d ? d : this.height,
            this.canvas[a] ? (this.canvas[a].canvas.width = c,
            this.canvas[a].canvas.height = d,
            e()) : (this.canvas[a] = new b(c,d,a,(!0),(!1),(!1),this),
            this.canvas[a].ctx = this.canvas[a].context(),
            e())
        },
                    ...
                    if ("dropshadow" != f && e[f])
                        if (f.indexOf("dropshadow_") > -1) {
                            ...
                            if ((g || h || i) && !d) {
                                ...
                                c += "drop-shadow(" + g + "px " + h + "px " + i + "px " + j + ") ",
                                d = !0
                            }
                        } else
                            c += f + "(" + e[f] + ") "
        ...
        filterContrast: function(a, b, c) {
            for (var d = parseInt(b) / 100, e = c ? c : new Uint8ClampedArray(this.filter.imageData.data), f = 0; f < e.length; f += 4)
                e[f] = 255 * ((e[f + 0] / 255 - .5) * d + .5),
                e[f + 1] = 255 * ((e[f + 1] / 255 - .5) * d + .5),
                e[f + 2] = 255 * ((e[f + 2] / 255 - .5) * d + .5);
            return c ? e : void this.filter.newImageData.data.set(e)
        },
        ...
        filterSepia: function(a, b, c) {
            for (var d = parseInt(b) / 100, e = c ? c : new Uint8ClampedArray(this.filter.imageData.data), f = 0; f < e.length; f += 4) {
                var g = e[f + 0]
                  , h = e[f + 1]
                  , i = e[f + 2];
                e[f + 0] = (.393 * g + .769 * h + .189 * i) * d + g * (1 - d),
                e[f + 1] = (.349 * g + .686 * h + .168 * i) * d + h * (1 - d),
                e[f + 2] = (.272 * g + .534 * h + .131 * i) * d + i * (1 - d)
            }
            return c ? e : void this.filter.newImageData.data.set(e)
        },
        filterInvert: function(a, b, c) {
            for (var d = parseInt(b) / 100, e = c ? c : new Uint8ClampedArray(this.filter.imageData.data), f = 0; f < e.length; f += 4)
                e[f + 0] = Math.abs(e[f + 0] - 255 * d),
                e[f + 1] = Math.abs(e[f + 1] - 255 * d),
                e[f + 2] = Math.abs(e[f + 2] - 255 * d);
            return c ? e : void this.filter.newImageData.data.set(e)
        },
        filterBlur: function(a, b, c, d, e, f) {
            var g = c ? c : this.filter.imageData.data
              ...
              , i = parseInt(b);
            f = f ? f : 3;
            for (var j, k, l, m, d = d ? d : this.width, e = e ? e : this.height, n = d - 1, o = e - 1, p = i + 1, q = (Math.ceil(n / 2),
            Math.ceil(n / 2),
            [1, 57, 41, 21, 203, 34, 97, 73, 227, 91, 149, 62, 105, 45, 39, 137, 241, 107, 3, 173, 39, 71, 65, 238, 219, 101, 187, 87, 81, 151, 141, 133, 249, 117, 221, 209, 197, 187, 177, 169, 5, 153, 73, 139, 133, 127, 243, 233, 223, 107, 103, 99, 191, 23, 177, 171, 165, 159, 77, 149, 9, 139, 135, 131, 253, 245, 119, 231, 224, 109, 211, 103, 25, 195, 189, 23, 45, 175, 171, 83, 81, 79, 155, 151, 147, 9, 141, 137, 67, 131, 129, 251, 123, 30, 235, 115, 113, 221, 217, 53, 13, 51, 50, 49, 193, 189, 185, 91, 179, 175, 43, 169, 83, 163, 5, 79, 155, 19, 75, 147, 145, 143, 35, 69, 17, 67, 33, 65, 255, 251, 247, 243, 239, 59, 29, 229, 113, 111, 219, 27, 213, 105, 207, 51, 201, 199, 49, 193, 191, 47, 93, 183, 181, 179, 11, 87, 43, 85, 167, 165, 163, 161, 159, 157, 155, 77, 19, 75, 37, 73, 145, 143, 141, 35, 138, 137, 135, 67, 33, 131, 129, 255, 63, 250, 247, 61, 121, 239, 237, 117, 29, 229, 227, 225, 111, 55, 109, 216, 213, 211, 209, 207, 205, 203, 201, 199, 197, 195, 193, 48, 190, 47, 93, 185, 183, 181, 179, 178, 176, 175, 173, 171, 85, 21, 167, 165, 41, 163, 161, 5, 79, 157, 78, 154, 153, 19, 75, 149, 74, 147, 73, 144, 143, 71, 141, 140, 139, 137, 17, 135, 134, 133, 66, 131, 65, 129, 1]), r = q[i], s = [0, 9, 10, 10, 14, 12, 14, 14, 16, 15, 16, 15, 16, 15, 15, 17, 18, 17, 12, 18, 16, 17, 17, 19, 19, 18, 19, 18, 18, 19, 19, 19, 20, 19, 20, 20, 20, 20, 20, 20, 15, 20, 19, 20, 20, 20, 21, 21, 21, 20, 20, 20, 21, 18, 21, 21, 21, 21, 20, 21, 17, 21, 21, 21, 22, 22, 21, 22, 22, 21, 22, 21, 19, 22, 22, 19, 20, 22, 22, 21, 21, 21, 22, 22, 22, 18, 22, 22, 21, 22, 22, 23, 22, 20, 23, 22, 22, 23, 23, 21, 19, 21, 21, 21, 23, 23, 23, 22, 23, 23, 21, 23, 22, 23, 18, 22, 23, 20, 22, 23, 23, 23, 21, 22, 20, 22, 21, 22, 24, 24, 24, 24, 24, 22, 21, 24, 23, 23, 24, 21, 24, 23, 24, 22, 24, 24, 22, 24, 24, 22, 23, 24, 24, 24, 20, 23, 22, 23, 24, 24, 24, 24, 24, 24, 24, 23, 21, 23, 22, 23, 24, 24, 24, 22, 24, 24, 24, 23, 22, 24, 24, 25, 23, 25, 25, 23, 24, 25, 25, 24, 22, 25, 25, 25, 24, 23, 24, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 23, 25, 23, 24, 25, 25, 25, 25, 25, 25, 25, 25, 25, 24, 22, 25, 25, 23, 25, 25, 20, 24, 25, 24, 25, 25, 22, 24, 25, 24, 25, 24, 25, 25, 24, 25, 25, 25, 25, 22, 25, 25, 25, 24, 25, 24, 25, 18], t = s[i], u = [], v = [], w = [], x = [], y = [], z = [], A = f; A-- > 0; ) {
                for (var B = 0, C = 0, D = 0; D < e; D++) {
                    for (var E = h[B] * p, F = h[B + 1] * p, G = h[B + 2] * p, H = h[B + 3] * p, I = 1; I <= i; I++)
                        j = B + ((I > n ? n : I) << 2),
                        E += h[j++],
                        F += h[j++],
                        G += h[j++],
                ...
                for (var J = 0; J < d; J++) {
                    for (var K = J, E = u[K] * p, F = v[K] * p, G = w[K] * p, H = x[K] * p, I = 1; I <= i; I++)
                        K += I > o ? 0 : d,
                        E += u[K],
                        F += v[K],
                        G += w[K],
                    ...
                    for (var D = 0; D < e; D++)
                        ...
                        h[C] = (E * r >>> t) * m,
                        h[C + 1] = (F * r >>> t) * m,
                        h[C + 2] = (G * r >>> t) * m) : h[C] = h[C + 1] = h[C + 2] = 0,
                        0 === J && (y[D] = ((j = D + p) < o ? j : o) * d,
                        z[D] = (j = D - i) > 0 ? j * d : 0),
                        k = J + y[D],
                        l = J + z[D],
                        E += u[k] - u[l],
        ...
        showPopup: function(b, c, d, e, f) {
            var g = ".p-body";
            this.hideAllModals(),
            "new" == b ? (a("#new-modal").show(),
            a("#new-modal .new-width").val(this.width),
            a("#new-modal .new-height").val(this.height)) : "import" == b ? (a("#importing-modal").show(),
            a("#start-import-fetch")[0].click()) : a("#popup-container, #popup-container .p-content-sidebar-head").show(),
            a("#popup-container .error-submitting").hide(),
            a("#popup-container .p-content").removeClass("mobile"),
            a(g).removeClass("blueBackground"),
            a(g + ", .p-content-sidebar-head").removeClass("g"),
            a("#popup-container .popup-wrapper").removeClass("stampWidth"),
            a("#popup-container .popup-wrapper").removeClass("autoWidth");
            var h = ""
              , i = !1
              , j = !1
              , k = !1
            ...
            switch (b) {
            case "settings":
                h = '<i class="fa fa-cogs" aria-hidden="true"></i> ' + this.getResponse("res-modal-settings"),
                j = !0,
                k = !0;
                break;
            case "download":
                h = '<i class="fa fa-download" aria-hidden="true"></i> ' + this.getResponse("res-modal-download"),
                j = !0,
                l = !0;
                break;
            case "palettes":
                h = '<i class="fa fa-eyedropper" aria-hidden="true"></i> ' + this.getResponse("res-modal-palette"),
                j = !0,
                l = !0;
                break;
            case "stamp":
                h = '<i class="fa fa-puzzle-piece" aria-hidden="true"></i> ' + this.getResponse("res-modal-new-stamp"),
                m = !0;
                break;
            case "new":
                h = '<i class="fa fa-file-image-o" aria-hidden="true"></i> ' + this.getResponse("res-modal-new-drawing"),
                i = !0;
                break;
            case "resize":
                ...
                break;
            case "submit":
                h = '<i class="fa fa-flag" aria-hidden="true"></i> ' + this.getResponse("res-modal-save-drawing"),
                j = !0;
                break;
            case "info":
                h = '<i class="fa fa-keyboard-o" aria-hidden="true"></i> ' + this.getResponse("res-modal-keys"),
                j = !0;
                break;
            case "about":
                h = '<i class="fa fa-info-circle" aria-hidden="true"></i> ' + this.getResponse("res-modal-about"),
                j = !0;
                break;
            ...
            case "select-information":
                ...
                break;
            case "custom-text":
                h = '<i class="fa fa-font" aria-hidden="true"></i> ' + this.getResponse("res-modal-font"),
                m = !0;
                break;
            case "brushes":
                h = '<i class="fa fa-brush" aria-hidden="true"></i> ' + this.getResponse("res-modal-brushes"),
                m = !0;
                break;
            case "colors":
                ...
                break;
            case "getting-link":
                h = '<i class="fa fa-flag" aria-hidden="true"></i> ' + this.getResponse("res-modal-getting"),
                n = !0,
                o = !0;
                break;
            case "new-letter":
                h = '<i class="fa fa-font" aria-hidden="true"></i> ' + this.getResponse("res-modal-assign"),
                m = !0,
                n = !0;
                break;
            case "progress":
                h = '<i class="fa fa-film" aria-hidden="true"></i> ' + this.getResponse("res-modal-current"),
                j = !0;
                break;
            case "mobile":
                h = '<i class="fa fa-mobile" aria-hidden="true"></i> ' + this.getResponse("res-modal-mobile"),
                j = !0,
                p = !0;
                break;
            case "layer":
                h = '<i class="fa fa-sticky-note-o" aria-hidden="true"></i> Layer Properties',
                j = !0;
                break;
            case "developer":
                h = "Developer";
            ...
            a("#popup-container .p-content-btn").removeClass("active"),
            a("#popup-container .p-" + b).addClass("active"),
            a(g).html(c),
            this.preventShortcut = !0,
            f && (this.closePopup = !1),
            (k || l) && this.downloadOptions(),
            "submit" == b && (this.FrameController.frames.length > 1 && a("#popup-container .upload-replay-toggle").remove(),
            a("#submit_title").val(this.edit.title),
            a("#submit_description").val(this.edit.description),
            this.isExternal && this.SubmitController.hideArtOptions()),
            e && a("#popup-container .popup-wrapper").addClass("autoWidth"),
            d ? a("#popup-container .popup-close-button").hide() : a("#popup-container .popup-close-button").show(),
            h ? a("#live-header").show().html(h) : a("#live-header").hide(),
            p && a("#popup-container .p-content").addClass("mobile"),
            m && a(g + ", #popup-container .p-content-sidebar-head").addClass("g"),
            n && a("#popup-container .p-content-sidebar-head").hide(),
            o && a("#popup-container .popup-wrapper").width(410),
            "download" == b && this.SettingsController.changeRation(!1, this.downloadSizes.frame),
            this.popup.open = !0,
            this.toggleNewFileElements(b)
        },
        startData: function(a) {
            var b = this;
            if (this.showChecker(),
            this.showOnionSkin(),
            this.useSeperateBottomLayers)
                for (var c = 0; c < this.bottomLayers.length; c++) {
                    var d = this.bottomLayers[c];
                    this.canvas.display.ctx.filter = this.layerOptionsFilter(d),
                    "source-atop" == d.options.blend && d.active && this.bottomLayers[c - 1] && this.bottomLayers[c - 1].active ? this.clipRender(d, this.bottomLayers[c - 1], function(a) {
                        b.canvas.display.putImageData(a, 1, b.zoom)
                    }) : (this.canvas.display.ctx.globalCompositeOperation = d.options.blend,
                    this.canvas.display.putImageData(d.src, d.opacity, this.zoom))
                }
            else
                this.hasBottomLayers && this.canvas.display.putImageData(this.canvas.bottom.canvas, 1, this.zoom);
            this.canvas.display.ctx.globalCompositeOperation = "source-over",
            this.canvas.display.ctx.filter = "none"
        },
        endData: function() {
            var a = this;
            if (this.useSeperateTopLayers)
                for (var b = 0; b < this.topLayers.length; b++) {
                    ...
                    if (this.canvas.display.ctx.filter = this.layerOptionsFilter(c),
                    "source-atop" == c.options.blend) {
                        var d = this.topLayers[b - 1]
                          , e = !1;
                        d || (d = this.LayerController.layers[this.LayerController.currentLayer],
                        e = this.canvas.layer.canvas),
                        d && d.active && c.id - 1 == d.id && this.clipRender(c, d, function(b) {
                            a.canvas.display.putImageData(b, 1, a.zoom)
                        }, !1, e)
                    } else
                        this.canvas.display.ctx.globalCompositeOperation = c.options.blend,
                        this.canvas.display.putImageData(c.src, c.opacity, this.zoom)
                }
            else
                this.hasTopLayers && this.canvas.display.putImageData(this.canvas.top.canvas, 1, this.zoom);
            if (this.canvas.display.ctx.globalCompositeOperation = "source-over",
            this.canvas.display.ctx.filter = "none",
            this.renderAfter.length)
            ...
            this.renderAfter = [],
            this.showTopOnion(),
            this.updateTileCanvases()
        },
        clipRender: function(a, b, c, d, e, f) {
            var f = f ? f : "extended"
              , g = this;
            if (!this.canvas[f])
                return this.createCanvas(f, !1, !1, function() {
                    g.clipRender(a, b, c, d, e, f)
                });
            if (this.canvas[f].canvas.width == this.width && this.canvas[f].canvas.height == this.height || (this.canvas[f].canvas.width = this.width,
            this.canvas[f].canvas.height = this.height),
            this.canvas[f].clear(),
            b.active) {
                var h = e ? e : b.src;
                this.canvas[f].ctx.globalCompositeOperation = b.options.blend,
                this.canvas[f].putImageData(h, b.opacity)
            }
            if (a.active) {
                var i = d ? d : a.src;
                this.canvas[f].ctx.globalCompositeOperation = a.options.blend,
                this.canvas[f].putImageData(i, a.opacity)
            }
            return this.canvas[f].ctx.globalCompositeOperation = "source-over",
            c(this.canvas[f].canvas)
        },
        setOnionSkin: function(a) {
            var b = this;
            if (this.onionSkin.top_image = !1,
            this.FrameController.frames.length >= 1) {
                ...
                if (0 != c) {
                    ...
                    this.LayerController.flatten(d.layers, !1, e, function(a) {
                        if (c + 1 <= b.FrameController.frames.length - 1) {
                            ...
                            var g = new Image;
                            g.src = b.LayerController.flatten(d.layers, !1, e),
                            b.onionSkin.top_image = g
                        }
                        f.src = a,
                        b.onionSkin.image = f
                    })
            ...
            if (this.FrameController.frames.length > 1 && this.onionSkin.status && 0 != this.FrameController.currentFrame)
                if (a && this.onionSkin.image) {
                    ...
                    this.onionSkin.image.onload = function() {
                        c.canvas.display.putImageData(this, c.onionSkin.opacity, c.zoom),
                        c.render()
                    }
                } else
                    this.onionSkin.image && this.canvas.display.putImageData(this.onionSkin.image, this.onionSkin.opacity, this.zoom)
        },
        ...
        showGrid: function(a) {
            if (this.grid.status) {
                if ("CSS" == this.zoom.type && a && this.resetGrid(),
                "CSS" == this.zoom.type || "Canvas" == this.zoom.type)
                    return;
                if (a) {
                    var b = this;
                    ...
                    this.canvas.display.putImageData(this.grid.data, this.grid.opacity, this.zoom)
            }
        },
        resetGrid: function() {
        ...
        showChecker: function(a, b) {
            if (this.checker.data && !b || this.createChecker(),
            this.checker.status)
                if (a) {
                    var c = this;
                    this.checker.data.onload = function() {
                        c.canvas.display.putImageData(this, c.checker.opacity, c.zoom),
                        c.render()
                    }
                } else
                    this.canvas.display.putImageData(this.checker.data, this.checker.opacity, this.zoom)
        },
        tracing: function() {
        ...
        getEditImage: function() {
            var a = this;
            if ("gif" == this.fileExtension(this.edit.image_src))
                return this.GifController.load(this.edit.image_src);
            if (this.app.frames)
                return this.GifController.loadAppDrawing();
            var b = new Image;
        ...
        putEditImage: function(a) {
            var b = this;
            a.onload = function() {
                b.canvas.layer.putSimple(this),
                b.ToolController.tool.currentImage = this,
                b.ready(),
                b.render(),
                b.ToolController.tool.restore()
            }
        },
        ...
        updateDisplayCanvas: function(a, b) {
            this.finished && (this.layerAboveCache = !1,
            this.layerBelowCache = !1,
            this.renderLocationLayers(a, b))
        },
        canvasAddTop: function(a, b) {
            var c = this;
            return this.canvas.top ? (this.canvas.top.ctx.filter = this.layerOptionsFilter(b),
            void this.canvas.top.putImageData(a, b.opacity)) : this.createCanvas("top", !1, !1, function() {
                c.canvasAddTop(a, b)
            })
        },
        canvasAddBottom: function(a, b) {
            var c = this;
            return this.canvas.bottom ? (this.canvas.bottom.ctx.filter = this.layerOptionsFilter(b),
            void this.canvas.bottom.putImageData(a, b.opacity)) : this.createCanvas("bottom", !1, !1, function() {
                c.canvasAddBottom(a, b)
            })
        },
        renderLocationLayers: function(a, b) {
            this.canvas.top && this.canvas.top["default"](),
            this.canvas.bottom && this.canvas.bottom["default"]();
            a[this.LayerController.currentLayer];
            this.topLayers = [],
            this.bottomLayers = [],
            this.useSeperateTopLayers = !1,
            this.useSeperateBottomLayers = !1,
            this.hasTopLayers = !1,
            this.hasBottomLayers = !0;
            for (var c = 0; c < a.length; c++) {
                var d = a[c];
                if (c != b && d.active && 0 !== d.opacity) {
                    var e = d.src;
                    c > b ? (this.hasTopLayers = !0,
                    this.topLayers.push(d),
                    this.canvasAddTop(e, d),
                    "source-over" != d.options.blend && (this.useSeperateTopLayers = !0)) : (this.hasBottomLayers = !0,
                    this.bottomLayers.push(d),
                    this.canvasAddBottom(e, d),
                    "source-over" != d.options.blend && (this.useSeperateBottomLayers = !0))
                }
            }
        },
        stampsTemplate: function(a, b) {
            return a.resize = "1",
            a.stamp_favorites_id = a.stamp_favorites_id ? a.stamp_favorites_id : "false",
            '<div class="stamp-pre selectable-stamp smp-' + a.id + '"><div class="stamp-data">' + this.addDeleteStampButton(b, a) + this.addApproveStampButton(b, a) + this.favoriteIcon(a) + '<div class="stamp-pre-image" style="background-image:url(' + a.imageData + ')"  data-id="' + a.id + '" data-resize="' + a.is_old + '" data-image="' + a.imageData + '-px199113-"></div><div class="stamp-pre-title">' + this.lockIcon(a.is_private) + a.title + "</div></div></div>"
        },
        addDeleteStampButton: function(a, b) {
            if (a && "object" == typeof a)
                return a.user || a.admin ? '<span class="delete-stamp-btn" data-id="' + b.id + '" title="Delete Stamp"><i class="fa fa-trash fa-fw" aria-hidden="true"></i></span>' : ""
        },
        lockIcon: function(a) {
        ...
        addApproveStampButton: function(a, b) {
            if (a && "object" == typeof a)
                return a.admin && !b.is_approved ? '<span class="approve-stamp-btn" data-id="' + b.id + '" title="Approve Stamp"><i class="fa fa-check fa-fw" aria-hidden="true"></i></span>' : ""
        },
        ...
        createAutoSaveData: function(a) {
            ...
            this.startHistory(function(c) {
                ...
                return b.settings.persLayers ? (d.version = b.version,
                d.persLayers = !0) : d.persLayers = !1,
                b.edit.status && (d.edit = {
                    status: !0,
                    unqid: b.edit.unqid
                }),
                a(d)
        ...
        startAutoSave: function() {
            this.timerAutoSave(),
            this.createCookie("pixil-asc", !0, 31)
        },
        stopAutoSave: function() {
            this.putStorage(this.autosave.cookieName, ""),
            this.databaseDeletePixil("autosave"),
            this.databaseDeletePixil("backup"),
            this.createCookie("pixil-asc", !1, 31),
        ...
        beginAutoSave: function() {
            ...
            if (c && "" != c && " " != c.trim() && (this.autosave.status = c),
            "false" == this.autosave.status)
                ...
                if (!this.edit.status) {
                    ...
                    d && "" != d.trim() || this.databaseGetPixil("autosave", function(a) {
                        a && b.autoSaveLoadObject(a),
                        a || b.databaseGetPixil("backup", function(a) {
                            console.log("Loading from backup"),
                            b.autoSaveLoadObject(a)
                        })
                    })
                }
                this.preAutoSave()
        ...
        autoSaveLoadObject: function(b) {
            ...
            c = this.replaceAll(c, "--.--", ";"),
            this.loadAutoSave(c),
            this.showPopup("auto-save-loaded", a("#auto-save-loaded").html())
        },
        ...
        loadAutoSave: function(a) {
            ...
            this.getPixelRatio(),
            a.persLayers && (this.settings.persLayers = !0),
            a.version && a.persLayers !== !1 || (this.settings.persLayers = !1),
            a.edit && a.edit.status && (this.edit.status = !0,
            this.edit.unqid = a.edit.unqid),
            this.resizeCanvases(a.width, a.height),
            "CSS" == this.zoom.type && (this.ZoomController.align(),
            this.ZoomController.reset(),
            this.mouse.resetLast()),
            this.createGrid(),
            this.createChecker(),
            this.FileController.updateDimensions(),
            this.loadHistoryData(a, function(c) {
                b.HistoryController.loadFrames(c, a.currentFrame),
                b.HistoryController.undo = [],
                b.HistoryController.redo = [],
                b.HistoryController.create(),
                setTimeout(function() {
                    b.LayerController.updateList(),
                    b.ZoomController.fit()
                }, 1)
            })
        },
        loadAds: function() {
            ...
            return c = !!c && c.content,
            this.ads.placement = this.settings.ad.placement,
            "auto" == this.ads.placement && this.window.height() > 940 && (this.ads.placement = "footer"),
            c && (this.ads.type = c),
            a("#disable-ads").length || !this.ads.status || this.isApp ? (a("#ad-sidebar-modal, #append-mobile-ad-pos").remove(),
            void (this.ads.status = !1)) : (this.checkAdsWidthWindow(),
            void (this.adStartTimer = setTimeout(function() {
                b.appendScripts()
            }, 12e4)))
        },
        removeFooterAdPlacement: function() {
            a("body").removeClass("b-top"),
            this.repositionScreen()
        },
        setAdsPlacementLayout: function() {
            this.window.width() < 1440 && a("#footer-ad-2").remove(),
            a("body").addClass("b-top"),
            this.repositionScreen()
        },
        startTipLoadAds: function() {
            var a = this;
            clearTimeout(this.adStartTimer),
            setTimeout(function() {
                a.appendScripts()
            }, 500)
        },
        ...
        startAdScripts: function() {
            ...
            return "freestar" == this.ads.type ? setTimeout(function() {
                ...
                b.loadNitropay()
            }, c) : a("#ads-google").length ? (this.adsBy = "google",
            setTimeout(function() {
                b.loadGTP()
            }, c)) : void 0
        },
        ...
        startPlaywireLeaderBoardAds: function(a) {
            ...
            if (!(this.ads.attempts > this.ads.maxAttempts)) {
                if ("undefined" == typeof ramp.onReady)
                    return setTimeout(function() {
                        b.ads.attempts++,
                        b.startPlaywireLeaderBoardAds()
                    }, 250);
                var c = [{
                ...
                ramp.setPath("728x90"),
                this.loadPlayWireAds(c),
                this.refreshPlaywire()
            }
        },
        ...
        loadPlayWireAds: function(a) {
            console.log("lodaing ads", a),
            ramp.addUnits(a).then(function() {
                ramp.displayUnits()
            })
        },
        refreshPlaywire: function() {
            var b = this;
            this.isMobileDevice || (this.ads.bottomPlacement = b.ads.bottomPlacement ? b.ads.bottomPlacement : a("#frames-placement .panel-header").height(),
            a("#simple-ad").addClass("show").css({
                bottom: b.ads.bottomPlacement
            })),
            this.ads.timer = setTimeout(function() {
                b.refreshLeaderBoardAds(),
                b.ads.lastRefreshTime = Date.now() + 3e3,
                setTimeout(function() {
        ...
        loadNitropay: function() {
            this.setupMobileAdPosition(),
            a(window).width() >= 1600 && a(window).height() >= 900 && (this.ads.large = !0),
            a(window).height() > 675 && this.loadNitropayAd("ad-modal-footer", [[300, 250]]),
            this.loadNitropayLeaderboards()
        },
        loadNitropayLeaderboards: function() {
            if (this.isMobileDevice)
                this.loadNitropayAd("append-mobile-ad", [[300, 50]]);
            else {
                var b = [[728, 90]]
                  , c = [[970, 250]];
                a("#ad-leaderboard-one").html(""),
                a("#ad-leaderboard-two").html(""),
                a("#ad-leaderboard-large").html(""),
                this.ads.large ? this.loadNitropayAd("ad-leaderboard-large", c) : (this.loadNitropayAd("ad-leaderboard-one", b),
                this.loadNitropayAd("ad-leaderboard-two", b))
            }
        ...
        showNitropaySubmitAd: function() {
            this.loadNitropayAd("da-link-append", [[300, 250]])
        },
        ...
        loadFreestar: function() {
            this.setupMobileAdPosition(),
            this.showFreestarSidebarAd(),
            this.initFreestar()
        },
        initFreestar: function() {
            clearTimeout(this.ads.timer),
            "footer" == this.ads.placement ? (this.setAdsPlacementLayout(),
            a("#simple-ad").removeClass("show"),
            a("#ad-leaderboard-one, #ad-leaderboard-two").html("")) : (this.removeFooterAdPlacement(),
            a("#footer-ad-1, #footer-ad-2").html("")),
            this.showFreestar()
        },
        ...
        showFreestar: function() {
            if (this.isMobileDevice)
                ...
                "footer" == this.ads.placement && (b = "footer-ad-1",
                c = "footer-ad-2"),
                freestar.config.enabled_slots.push({
                    placementName: "pixilart_draw_leaderboard_1",
                    slotId: b
                }),
                a("#" + b).attr("data-freestar-ad", "__728x90").attr("align", "center"),
                ("footer" != this.ads.placement || this.window.width() > 1440 && "footer" == this.ads.placement) && (freestar.config.enabled_slots.push({
        ...
        refreshFreestar: function() {
            var b = this;
            this.isMobileDevice || "footer" == this.ads.placement || (this.ads.bottomPlacement = b.ads.bottomPlacement ? b.ads.bottomPlacement : a("#frames-placement .panel-header").height(),
            a("#simple-ad").addClass("show").css({
                bottom: b.ads.bottomPlacement
            })),
            this.ads.timer = setTimeout(function() {
                "footer" != b.ads.placement && (b.ads.lastRefreshTime = Date.now() + 2e4,
                setTimeout(function() {
                    b.loadAdsWrapperOpen()
                }, 1250)),
                b.showFreestar()
        ...
        loadGTP: function() {
            ...
            this.isMobileDevice ? googletag.cmd.push(function() {
                b = googletag.defineSlot("/21875033406/drawing_mobile_1", [[320, 50]], "append-mobile-ad").addService(googletag.pubads()),
                ...
                googletag.defineSlot("/21875033406/drawing_mobile_1", [[300, 250]], "ad-modal-footer").addService(googletag.pubads()),
                googletag.pubads().enableSingleRequest(),
                googletag.enableServices(),
                setTimeout(function() {
                    googletag.cmd.push(function() {
            ...
            googletag.cmd.push(function() {
                c.ads.units.leaderOne = googletag.defineSlot("/21875033406/drawing_leader_1", [[728, 90]], "ad-leaderboard-one").addService(googletag.pubads()),
                googletag.pubads().enableSingleRequest(),
                googletag.enableServices(),
                setTimeout(function() {
                    googletag.cmd.push(function() {
            ...
            googletag.cmd.push(function() {
                c.ads.units.leaderTwo = googletag.defineSlot("/21875033406/drawing_leader_2", [[728, 90]], "ad-leaderboard-two").addService(googletag.pubads()),
                googletag.pubads().enableSingleRequest(),
                googletag.enableServices(),
                setTimeout(function() {
                    googletag.cmd.push(function() {
        ...
        loadGptSubmitAd: function() {
            googletag.cmd.push(function() {
                googletag.defineSlot("/21875033406/drawing_loading_1", [[300, 250]], "ad-submit-rect").addService(googletag.pubads()),
                googletag.pubads().enableSingleRequest(),
                googletag.enableServices(),
                setTimeout(function() {
                    googletag.cmd.push(function() {
        ...
        reloadGptAds: function() {
            var b = this;
            this.ads.bottomPlacement = b.ads.bottomPlacement ? b.ads.bottomPlacement : a("#frames-placement .panel-header").height(),
            a("#simple-ad").addClass("show").css({
                bottom: b.ads.bottomPlacement
            }),
            this.ads.timer = setTimeout(function() {
                googletag.pubads().refresh([b.ads.units.leaderOne]),
                googletag.pubads().refresh([b.ads.units.leaderTwo]),
                b.loadAdsWrapperOpen(),
                b.reloadGptAds()
            }, this.ads.autloadTime)
        },
        ...
        loadData: function() {
            ...
            "google" == this.adsBy && (this.isMobileDevice || this.loadAdsWrapperOpen(),
            this.getAdSense())
        },
        ...
        loadAdsWrapperClose: function() {
            this.ads.show = !1,
            this.ads.adElementWidth = this.ads.adElementWidth ? this.ads.adElementWidth : a("#simple-ad").width() + 20;
        ...
        loadAdsWrapperOpen: function() {
            this.isMobileDevice || (this.ads.show = !0,
            a("#simple-ad").removeClass("hidden-ad").css({
                right: 0
            }),
        ...
        autoLoadMoreAds: function() {
            var b = this;
            clearTimeout(this.ads.timer),
            a("#simple-ad").addClass("show"),
            this.ads.timer = setTimeout(function() {
                b.getNewLeaderboardAd(),
                b.loadData()
            }, this.ads.autloadTime)
        },
        linkLoadingAd: function() {
            if ("freestar" == this.ads.type)
                return this.showFreestarSubmitAd();
            if ("nitropay" == this.ads.type)
                return this.showNitropaySubmitAd();
            if ("playwire" == this.ads.type)
                return this.showPlaywireSubmitAd();
        ...
        getAdSense: function() {
            if (this.ads.bottomPlacement = this.ads.bottomPlacement ? this.ads.bottomPlacement : a("#frames-placement .panel-header").height(),
            this.isMobileDevice) {
                if (a("#simple-ad").remove(),
                this.isTablet)
                    var b = '<ins class="adsbygoogle" style="display:inline-block;width:728px;height:90px" data-ad-client="ca-pub-3237025594850465" data-ad-slot="7613531756"></ins>';
                else
                    var b = '<ins class="adsbygoogle" style="display:inline-block;width:320px;height:50px" data-ad-client="ca-pub-3237025594850465" data-ad-slot="9677570505"></ins>';
        ...
        outline: function(a, b, c) {
            this.canvas[b]["default"](),
            this.canvas[b].putSimple(a.src),
            "Select" != this.tool && c && this.ToolController.restore();
            for (var d = this.canvas[b].ctx.getImageData(0, 0, this.width, this.height), e = 0, f = 0, g = [], h = this.hexToRgb(this.ColorController.color), i = "rgba(" + h.r + "," + h.g + "," + h.b + "," + this.settings.outline.alpha + ")", j = 0; j < d.data.length; j += 4) {
                ...
                if (0 != k[3]) {
                    var m = j + 7
                      ...
                      , s = p - 4
                      , t = p + 4;
                    0 == d.data[n] && this.settings.outline.points.cl && this.layPixel(e - l, f, !0, i, !1, 1),
                    0 == d.data[q] && this.settings.outline.points.tl && 0 == d.data[n] && 0 == d.data[o] && this.layPixel(e - l, f - l, !0, i, !1, 1),
                    0 == d.data[r] && this.settings.outline.points.tr && 0 == d.data[m] && 0 == d.data[o] && this.layPixel(e + l, f - l, !0, i, !1, 1),
                    0 == d.data[s] && this.settings.outline.points.bl && 0 == d.data[n] && 0 == d.data[p] && this.layPixel(e - l, f + l, !0, i, !1, 1),
                    0 == d.data[t] && this.settings.outline.points.br && 0 == d.data[m] && 0 == d.data[p] && this.layPixel(e + l, f + l, !0, i, !1, 1),
                    0 == d.data[m] && g.indexOf(m) == -1 && this.settings.outline.points.cr && (g.push(m),
                    this.layPixel(e + l, f, !0, i, !1, 1)),
                    0 == d.data[o] && this.settings.outline.points.tc && this.layPixel(e, f - l, !0, i, !1, 1),
                    0 == d.data[p] && g.indexOf(p) == -1 && this.settings.outline.points.bc && (g.push(p),
                    this.layPixel(e, f + l, !0, i, !1, 1))
                }
                e++
            }
            return !c || c()
        ...
        flipCanvas: function(a, b, c) {
            ...
            c.ctx.save(),
            "x" == a ? (c.ctx.scale(-1, 1),
            c.ctx.drawImage(b, -c.canvas.width, 0)) : (c.ctx.scale(1, -1),
            c.ctx.drawImage(b, 0, -c.canvas.height)),
            c.ctx.restore(),
            c.dataURL()
        },
        cropResize: function(a, b, c) {
            var d = this
              ...
              , f = 0
              , g = this.canvas.data;
            g.canvas.width = parseInt(a),
            g.canvas.height = parseInt(b);
            var h = 0
              , i = 0
              , j = (a - this.width) / 2
              , k = (b - this.height) / 2
            ...
            var n = function() {
                ...
                if (!j || "undefined" == typeof j)
                    return c();
                var k = j.layers
                  , l = k[f];
                g.canvas.width = parseInt(a),
                g.canvas.height = parseInt(b),
                d.settings.crop.resize ? (g.setSmoothing(),
                g.ctx.drawImage(l.src, 0, 0, a, b)) : g.putSimple(l.src, h, i),
        ...
        createTileCanvases: function(c, d) {
            if (this.settings.tile.status && !this.isWindowsIE) {
                this.removeTileCanvases(),
                this.turnOffFrameTile(),
                c = c ? c : this.width,
                d = d ? d : this.height;
                for (var e = 0; e <= this.settings.tile.count - 1; e++) {
                    ...
                    f.ctx = f.context(),
                    f.empty = f.clear(!0),
                    this.settings.tile.canvases.push(f)
                }
                this.updateTileCanvases(),
                this.ZoomController.reset(),
                a("#sidebar-tiles-tab").removeClass("hidden"),
                a("#canvas-layers-appened").addClass("has-tiles")
            }
        },
        removeTileCanvases: function() {
            if (this.settings.tile.canvases.length)
                for (var b = 0; b <= this.settings.tile.canvases.length - 1; b++)
                    delete this.settings.tile.canvases[b].canvas;
            this.settings.tile.canvases = [],
            a("#sidebar-tiles-tab").addClass("hidden"),
            a("#canvas-layers-appened .canvas_tile").remove(),
            a("#canvas-layers-appened").removeClass("has-tiles")
        },
        updateTileCanvases: function() {
            if (this.settings.tile.status && !this.isWindowsIE)
                for (var a = 0; a <= this.settings.tile.canvases.length - 1; a++)
                    this.settings.tile.canvases[a].clear(),
                    this.settings.tile.canvases[a].ctx.globalAlpha = this.settings.tile.opacity,
                    this.settings.tile.canvases[a].putSimple(this.canvas.display.canvas, 0, 0, 0, 0)
        },
        updateTileOpacity: function(b) {
            a("#tiles-alpha-change").text(b),
            a("#tiles-alpha").val(b),
            this.settings.tile.opacity = b,
            this.updateTileCanvases()
        },
        ...
        toggleFrameTile: function() {
            this.settings.frames.tile = !this.settings.frames.tile,
            this.settings.tile.status && this.TileController.toggleOff();
            this.getPixelRatio();
            this.ZoomController.reset(!0),
            this.FrameController.updateFrameTiles(),
            this.settings.frames.tile ? this.turnOnFrameTile() : this.turnOffFrameTile(),
            this.updateSettings()
        },
        ...
        turnOffFrameTile: function() {
            this.settings.frames.tile = !1,
            a("#frame-tiles").removeAttr("style"),
            a("#frames-tile-toggle").prop("checked", !1),
            a("#canvas-layers-container .frame-tile").remove()
        },
        checkMobile: function(b) {
            (1 == a("#is-app").length || b) && (this.isApp = !0),
            (a(window).width() <= 768 || b) && this.setMobile(),
            a(window).height() < 450 && a("#resize-pix").hide()
        },
        setMobile: function() {
            var b = a(window).width();
            if (this.isMobile = !0,
            ...
            !("object" == typeof la && this.width == this.height || "object" == typeof la && this.width < 50 || "object" == typeof la && this.height < 50 || this.online.status && this.width == this.height))
                if (b <= 768 && (this.isMobileDevice = !0),
                768 != b || this.isApp) {
                    if (this.isApp) {
                        if (this.customSize)
                            return;
                        ...
                        this.formatScreen(),
                        this.setLayerTools();
                    a(window).height() < 600 && (a("#append-mobile-ad").remove(),
                    this.ads.status = !1)
                } else
                    this.width = 100,
                    this.height = 100
        ...
        checkTablet: function() {
            var b = navigator.userAgent
              , c = a(window).width();
            this.isApp || (b.indexOf("iPad") > -1 && (this.isIpad = !0,
            this.filter.status = !1,
            a(".remove-safari").remove()),
            (1080 == c && b.match(/Mac OS X/i) || 810 == c && b.match(/Mac OS X/i) || c > 768 && b.match(/Android|BlackBerry|iPhone|iPad|iPod|Opera Mini|IEMobile/i)) && this.setTablet())
        },
        setLayerTools: function() {
            a(window).width() <= 768 && (a("#sidebar-tool-content").show(),
            a("#sidebar-tool-content .sidebar-tools").removeClass("hide-mobile"))
        },
        setTablet: function() {
            this.isApp || (this.isMobile = !0,
            this.isTablet = !0,
            this.edit.status || 768 == a(window).width() || (this.width = 100,
            this.height = 100),
            this.settings.disableDownloadSubmit = !0,
            this.pixelPerfect.status = !0,
            a(".perfect-toggle").prop("checked", !0),
            this.settings.extras = !1,
            this.setLayerTools())
        },
        setApp: function() {
            if ("" == a("#added-styles").html().trim() || this.app.resizeOnNew) {
                ...
                if (c >= 30) {
                    ...
                    var f = 4 + Math.abs(c)
                      ...
                      , e = b.height() + f;
                    g < 0 && (g = 5,
                    this.app.resizeOnNew = !0),
                    this.app.resizeOnNew && (this.getPixelRatio(!1, !0),
                    this.ZoomController.reset(!0)),
                    this.ZoomController.align(!1, !1, !1, e - 1)
                }
                this.mouse.render()
            }
        },
        layersNewAllFrames: function(a, b, c) {
            if (this.settings.persLayers && 1 != this.FrameController.frames.length) {
                ...
                for (var e = 0; e < d.length; e += 1)
                    e != this.FrameController.currentFrame && (d[e].layers.push(a),
                    d[e].layers.splice(c, 0, d[e].layers.splice(b, 1)[0]))
            }
        },
        layersMergeAllFrames: function(a, b, c, d, e, f, g) {
            if (!this.settings.persLayers || 1 == this.FrameController.frames.length)
                return void (g && g());
            for (var h = this.FrameController.frames, i = this, j = [], k = 0; k < h.length; k += 1)
                k != this.FrameController.currentFrame && this.LayerController.mergeLayer(a, b, h[k], !0, function(a, b) {
                    b.layers.splice(c, 1),
                    b.layers.splice(d, 1),
                    b.layers.push(a),
                    b.layers.splice(parseInt(b.layers.length) - 1, 0, b.layers.splice(f, 1)[0]),
                    i.loading = !1,
                    i.updateData(),
                    j.push(1),
                    j.length == h.length - 1 && g()
                })
        },
        layerCloneToAllFramesCopy: function(a, b) {
            for (var c = this.FrameController.frames, d = 0, e = 0; e < c.length; e += 1)
                if (d++,
                e != this.FrameController.currentFrame && (a = jQuery.extend(!0, {}, a),
                c[e].layers.push(a),
                d >= c[e].length && b))
                    return b()
        },
        layerCloneToAllFrames: function(a, b, c) {
            if (1 != this.FrameController.frames.length) {
                if (!this.settings.persLayers)
                    return this.layerCloneToAllFramesCopy(b, c);
                for (var d = this.FrameController.frames, e = 0, f = 0; f < d.length; f += 1)
                    if (e++,
                    f != this.FrameController.currentFrame && !d[f].layers[a].options.locked && (b = jQuery.extend(!0, {}, b),
                    d[f].layers[a] = b,
                    e >= d[f].length && c))
                        return c()
            }
        ...
        layersCopyAllFrames: function() {
            if (this.settings.persLayers && 1 != this.FrameController.frames.length)
                for (var a = this.FrameController.frames, b = 0; b < a.length; b += 1)
                    b != this.FrameController.currentFrame && a[b].layers.splice(id, 1)
        },
        layersDeleteAllFrames: function(a) {
            if (this.settings.persLayers && 1 != this.FrameController.frames.length)
                for (var b = this.FrameController.frames, c = 0; c < b.length; c += 1)
                    c != this.FrameController.currentFrame && b[c].layers.splice(a, 1)
        },
        layersMoveAllFrames: function(a, b) {
            if (this.settings.persLayers && 1 != this.FrameController.frames.length)
                for (var c = this.FrameController.frames, d = 0; d < c.length; d += 1)
                    d != this.FrameController.currentFrame && c[d].layers.splice(a, 0, c[d].layers.splice(b, 1)[0])
        },
        layersRenameAllFrames: function(a, b) {
            if (this.settings.persLayers && 1 != this.FrameController.frames.length)
                for (var c = this.FrameController.frames, d = 0; d < c.length; d += 1)
                    d != this.FrameController.currentFrame && (c[d].layers[a].name = b)
        },
        layersNewFrame: function(a, b) {
            if (this.settings.persLayers && 1 != this.FrameController.frames.length) {
                ...
                for (var d = 0; d < c.layers.length; d++) {
                    var e = c.layers[d]
                      , f = jQuery.extend(!0, {}, e);
                    f.src = this.LayerController.blankLayer(),
                    a.layers.push(f)
                }
        ...
        startHistory: function(a) {
            for (var b = this.FrameController.frames, c = [], d = 0; d < b.length; d++)
                this.loopHistoryFrames(d, function(d) {
                    if (c.push(d),
                    c.length == b.length)
                        return a(c)
                })
        ...
        loadHistoryData: function(a, b) {
            var c = a.frames
              , a = []
              , d = this;
            if ("undefined" != typeof c[0].width && c[0].width != this.width && !this.ExportImportController.importing || "undefined" != typeof c[0].height && c[0].height != this.height && !this.ExportImportController.importing)
                this.resizeHistoryCanvas(c[0].width, c[0].height, function() {
                    for (var e = 0; e < c.length; e++)
                        d.ExportImportController.importing && (c[e].old_width = c[e].width,
                        c[e].old_height = c[e].height,
                        c[e].width = d.width,
                        c[e].height = d.height),
                ...
                for (var e = 0; e < c.length; e++) {
                    if (this.ExportImportController.importing && (c[e].old_width = c[e].width,
                    c[e].old_height = c[e].height,
                    c[e].width = d.width,
                    c[e].height = d.height),
                    this.ExportImportController.importing && 0 === e && 1 == c.length) {
                        c[0].selectedLayer = this.LayerController.currentLayer;
                        this.loopFrameLayers(this.LayerController.layers, function(a) {
                            for (var b = 0; b < c[0].layers.length; b++)
                                a.push(c[0].layers[b]);
                            c[e].layers = a
                        })
                    }
        ...
        loopFrameResizeLayers: function(a, b) {
            var c = this
              ...
              , g = 0;
            if (this.width <= a.old_width || this.height <= a.old_height)
                return b(d);
            this.canvas.rendering["default"]();
            for (var h = 0; h < d.length; h++) {
                var i = d[h];
                this.canvas.rendering.clear(),
                i.src.width == this.width && i.src.height == this.height ? this.canvas.rendering.ctx.drawImage(i.src, 0, 0) : this.canvas.rendering.ctx.drawImage(i.src, 0, 0, i.src.width, i.src.height, e, f, i.src.width, i.src.height);
                var j = new Image;
                j.pos_x = h,
                j.details = d[h].details,
                j.options = d[h].options,
                j.onload = function() {
                    if (d[this.pos_x] = c.createHistoryLayer(this, d[this.pos_x]),
                    g++,
                    g == d.length)
                        return b(d)
                }
        ...
        createHistoryLayer: function(a, b) {
            ...
            return d.src = a,
            d.active = b.active,
            d.opacity = parseFloat(b.opacity),
            d.unqid = b.unqid,
            d.details = a.details,
            d.options = a.options,
            d.opacity = d.opacity.toString(),
            d
        },
        simpleListeners: function() {
            ...
            a(document).on("click", ".tab-item", function() {
                ...
                a(b + " .tab-content-selection").removeClass("active"),
                a(b).find(c).addClass("active"),
                a(this).parent().children(".tab-item").removeClass("active"),
                a(this).addClass("active")
            }),
        ...
        extraToolDropDown: function() {
            function b(b) {
                ...
                e = b,
                b.find(".selectable-switch-wrapper").toggleClass("active"),
                a(".activate-switch-wrapper").show(),
                b.find(".selectable-switch-wrapper").hasClass("active") && (d = b,
                a(".activate-switch-wrapper").hide(),
                b.find(".select-able-switch").each(function() {
            ...
            a(".sidebar-tabs").click(function(b) {
                ...
                a(".sidebar-content").removeClass("active"),
                a(".sidebar-tabs").removeClass("active"),
                a(this).find(".sidebar-tab-notification").removeClass("active"),
                a(this).hasClass("sidebar-tools-tab") && a(".sidebar-tab-notification").removeClass("active"),
                a(this).addClass("active"),
                a(c).addClass("active")
            }),
            a(".p-progress").mousedown(function(b) {
                c.stopProgress(),
                c.progress.doPreview = !0,
                c.showProgress(".progress-images"),
                c.showPopup("progress", a("#progress-content").html())
            }),
            a(".select-able-switch, .switch-change").click(function(b) {
                if (3 != b.which && e) {
                    ...
                    e.attr("title", d),
                    a(".activate-switch-wrapper").attr("data-current", c),
                    a(".switch-change").html(a(this).html()).attr("data-title", d).attr("data-selection", c).attr("title", d).attr("data-type", f),
                    a(".selectable-switch-wrapper").removeClass("active"),
                    a(".activate-switch-wrapper").show()
                }
            }),
            a(document).on("pointerdown", function(a) {
            ...
            a(document).mouseup(function(b) {
                if (d) {
                    var c = d;
                    c.is(b.target) || 0 !== c.has(b.target).length || (a(".selectable-switch-wrapper").removeClass("active"),
                    a(".activate-switch-wrapper").show(),
                    d = !1)
                }
            })
        ...
        runGenerator: function(a) {
            ...
            for (var b = a.replace(/[^a-zA-Z0-9 ]/g, ""), c = b.split(""), d = 0, e = 0, f = 0, g = this.width * this.height, h = 0; h < g; h++) {
                ...
                j = j ? "#" + j : "rgba(0,0,0,0.0)",
                this.layPixel(e, f, !0, j, !1, 1),
                d++,
                e++,
                h == g - 1 && (this.FrameController.updateFramePreview(),
                this.render(),
                this.loading = !1)
            }
        },
        ...
        generateCircle: function(a, b, c, d) {
            ...
            var g = Math.ceil(b / 2)
              ...
              , j = b + 1
              , k = b + 1;
            for (this.canvas[a].canvas.width = j,
            this.canvas[a].canvas.height = k; e >= f; ) {
                for (var l = g; l < e + g; l++)
                    this.drawPixel(a, l, f + h, c, 1, !0),
                    this.drawPixel(a, f + g, l, c, 1, !0),
                    this.drawPixel(a, l - e, f + h, c, 1, !0),
                    this.drawPixel(a, -f + g, l, c, 1, !0),
                    this.drawPixel(a, l - e, -f + h, c, 1, !0),
                    this.drawPixel(a, -f + g, l - e, c, 1, !0),
                    this.drawPixel(a, l, -f + h, c, 1, !0),
                    this.drawPixel(a, f + g, l - e, c, 1, !0);
                this.drawPixel(a, e + g, f + h, c, 1, !0),
                this.drawPixel(a, f + g, e + h, c, 1, !0),
                this.drawPixel(a, -e + g, f + h, c, 1, !0),
                this.drawPixel(a, -f + g, e + h, c, 1, !0),
                this.drawPixel(a, -e + g, -f + h, c, 1, !0),
                this.drawPixel(a, -f + g, -e + h, c, 1, !0),
        ...
        alignLeft: function() {
            if (!this.alignCheck()) {
                ...
                this.getDrawnPixels(function(b, c, d, e, f, g, h) {
                    ...
                    a.canvas.layer.ctx.putImageData(b, -e, 0),
                    a.render(),
                    a.alignRestore()
                })
            }
        ...
        alignRight: function() {
            if (!this.alignCheck()) {
                ...
                this.getDrawnPixels(function(b, c, d, e, f, g, h) {
                    a.canvas.layer.clear();
                    var i = a.width - 1 - g;
                    a.canvas.layer.ctx.putImageData(b, i, 0),
                    a.render(),
                    a.alignRestore()
                })
            }
        ...
        alignTop: function() {
            if (!this.alignCheck()) {
                ...
                this.getDrawnPixels(function(b, c, d, e, f, g, h) {
                    a.canvas.layer.clear(),
                    a.canvas.layer.ctx.putImageData(b, 0, -f),
                    a.render(),
                    a.alignRestore()
                })
            }
        ...
        alignBottom: function() {
            if (!this.alignCheck()) {
                ...
                this.getDrawnPixels(function(b, c, d, e, f, g, h) {
                    a.canvas.layer.clear();
                    var i = a.height - 1 - h;
                    a.canvas.layer.ctx.putImageData(b, 0, i),
                    a.render(),
                    a.alignRestore()
                })
            }
        ...
        alignCenter: function() {
            if (!this.alignCheck()) {
                ...
                this.getDrawnPixels(function(b, c, d, e, f, g, h) {
                    ...
                    j -= f,
                    j = Math.floor(j),
                    a.canvas.layer.ctx.putImageData(b, i, j),
                    a.render(),
                    a.alignRestore()
                })
            }
        ...
        alignRestore: function() {
            ...
            this.LayerController.updateLayer(!1, function() {
                a.LayerController.updateLayer(),
                a.FrameController.updateFramePreview(),
                a.HistoryController.create()
            }),
            this.online.status && this.OnlineController.writeLayer()
        },
        alignCheck: function() {
            var b = this.LayerController.currentLayer;
            return !(!this.online.status || this.LayerController.layers[b].name == this.online.layer_id) && (this.showAlert(a("#res-online-editing").text()),
            !0)
        },
        finishLoading: function() {
            this.setupAutoSave(),
            "Canvas" == this.zoom.type && a(".navigation-scroller").hide()
        },
        bucketCreate: function(a, b, c, d, e, f, g, h, i, j, k) {
            var l = d ? d : this.mouse.start_x
              , m = e ? e : this.mouse.start_y;
            if (f = f ? f : "layer",
            this.bucket.callback = a,
            this.bucket.width = g ? g : this.width,
            this.bucket.height = h ? h : this.height,
            this.bucket.clear = j,
            this.canvas.data.clear(),
            this.canvas.data.canvas.width = this.bucket.width,
            this.canvas.data.canvas.height = this.bucket.height,
            this.bucket.tolerance = k ? k : 0,
            this.bucket.canvasName = f,
            this.bucketReset(),
            this.bucket.currentRGB = this.mouse.getPixel(l, m, !1, !1, !0),
            this.bucket.imageDataRender = [],
            this.bucket.currentRGB[0] == this.bucket.color[0] && this.bucket.currentRGB[1] == this.bucket.color[1] && this.bucket.currentRGB[2] == this.bucket.color[2] && i)
                return a(!1);
            this.bucket.color = i ? i : [0, 0, 0],
            this.bucket.currentRGB[0] != this.bucket.color[0] || this.bucket.currentRGB[1] != this.bucket.color[1] || this.bucket.currentRGB[2] != this.bucket.color[2] || i || (this.bucket.color = [1, 0, 0]),
            this.bucket.imageData = this.canvas[this.bucket.canvasName].ctx.getImageData(0, 0, this.bucket.width, this.bucket.height),
            this.bucket.clearImageData = this.canvas.data.ctx.getImageData(0, 0, this.bucket.width, this.bucket.height),
            this.bucket.p32 = new Uint32Array(this.bucket.imageData.data.buffer),
            this.bucket.clearP32 = new Uint32Array(this.bucket.clearImageData.data.buffer);
            for (var n = 0; n < this.bucket.imageData.data.length; n += 4)
                this.bucket.imageDataRender.push([this.bucket.imageData.data[n], this.bucket.imageData.data[n + 1], this.bucket.imageData.data[n + 2], this.bucket.imageData.data[n + 3]]);
            b ? this.bucketAllColors("data") : this.bucketWhileLoop(l, m, "data")
        },
        bucketWhileLoop: function(a, b, c) {
            if (this.bucketCheck(a, b)) {
                var d, e, f, g, h = 1e4, i = 0, j = this.rgbToAbgr(this.bucket.color);
                ...
                for (this.bucket.clear && (j = j.replace("0xFF", "0x00")); m.length; ) {
                    ...
                    g = (o + 1) % k === 0; l[o] === n; ) {
                        l[o] = j,
                        this.bucket.clearP32[o] = j;
                        var p = this.getExactXYFromPosition(o);
                        (this.settings.dithering && this.isOdd(p[0]) && this.isOdd(p[1]) || this.settings.dithering && !this.isOdd(p[0]) && !this.isOdd(p[1])) && (this.bucket.clearP32[o] = "0x00000001"),
                        f || (l[o - 1] === n ? d || (d = !0,
                        m.push(o - 1)) : d && (d = !1)),
                        g || (l[o + 1] === n ? e || (e = !0,
                        m.push(o + 1)) : e && (e = !1)),
                ...
                this.canvas[c].ctx.putImageData(this.bucket.clearImageData, 0, 0),
                this.bucket.callback(this.bucket.clearImageData, this.bucket.imageData, this.canvas[c].dataURL())
            }
        },
        bucketReset: function() {
            this.bucket.color = !1,
            this.bucket.filled = [],
            this.bucket.renderImageData = [],
            this.bucket.positions = [],
            this.bucket.width = this.width,
            this.bucket.height = this.height,
            this.bucket.p32 = !1,
            this.bucket.clearP32 = !1,
            this.canvas.data.clear(),
            this.canvas.data.canvas.width = this.width,
            this.canvas.data.canvas.height = this.height
        },
        bucketAllColors: function(a) {
            ...
            if (this.bucketCheck(b, c)) {
                ...
                for (var g = 0; g < e.length; g += 1) {
                    ...
                    this.settings.dithering && this.isOdd(h[0]) && this.isOdd(h[1]) || this.settings.dithering && !this.isOdd(h[0]) && !this.isOdd(h[1]) || e[g] === f && (e[g] = d,
                    this.bucket.clearP32[g] = d)
                }
                this.canvas[a].ctx.putImageData(this.bucket.clearImageData, 0, 0),
                this.bucket.callback(this.bucket.clearImageData, this.bucket.imageData)
            }
        },
        ...
        bucketCheck: function(a, b) {
            ...
            b = parseInt(b);
            var e = c * b + a;
            return a <= c - 1 && a >= 0 && b <= d - 1 && b >= 0 && (this.bucket.filled.push(e),
            this.layPixel(a, b, !0, "#000000", "data", 1),
            !0)
        },
        ...
        setProgressImage: function(a) {
            this.isMobile || !this.progress.status || this.online.status || this.fileDrawing || this.FrameController.frames.length > 1 || !this.isAuth || ((this.width > 500 || this.height > 500) && (this.progress.max = 150),
            0 == this.progress.step && (this.progress.step = this.progress.startStep),
            (this.width > this.progress.max_width || this.height > this.progress.max_height) && (this.progress.max_width = this.width,
            this.progress.max_height = this.height),
            this.progress.images.length >= this.progress.max && (this.progress.lap > 20 && (this.progress.lap = 0),
            this.progress.current > this.progress.max && (this.progress.current = this.progress.startStep,
            this.progress.lap++),
            this.progress.images.splice(this.progress.current, 1),
            this.progress.current += this.progress.step + this.progress.lap),
            this.progress.images.push(a))
        },
        toggleProgressSetting: function(a) {
            a ? this.progress.status = !1 : (this.progress.status = !1,
            this.prgoress.images = [])
        },
        ...
        showProgress: function(b) {
            var c = 0
              ...
              , f = function() {
                return d.progress.doPreview ? (c >= e.length && (c = 0),
                a(b).attr("src", e[c]),
                c++,
                void (d.progress.timer = setTimeout(function() {
                    f()
        ...
        downloadProgressGif: function(b, c, d, e) {
            ...
            return !this.progress.status || this.FrameController.frames.length > 1 || !e || !this.progress.images.length ? d(!1) : (a(".submit-drawing-butn").html(f.getResponse("res-replay-creating") + ' <span class="gif-loading-percent"></span>'),
            a(".download-progress-preview").html(f.getResponse("res-replay-loading") + ' <span class="loading-percent-preview-gif"></span>'),
            this.downloadProgressGifPrepare(b, function(b) {
                if (f.SubmitController.updateBtns(),
                !c)
                    return d(b);
                var e = URL.createObjectURL(b);
                a("#dowmnload-a").attr("href", e),
                a("#dowmnload-a").attr("download", "pixil-progress-gif-drawing.gif"),
                a("#dowmnload-a")[0].click(),
                a(".download-progress-preview").html("Download")
            }),
            void 0)
        },
        renderProgressFrames: function(a) {
            ...
            if (!this.progress.images.length)
                return b;
            for (var c = Math.ceil(this.progress.images.length / this.progress.maxUploadFrames), d = 0; d < this.progress.images.length; d += c)
                b.push(this.progress.images[d]);
            return 1 != c && b.push(this.progress.images[this.progress.images.length - 1]),
            a && b.unshift(this.progress.images[this.progress.images.length - 1]),
            b
        },
        ...
        downloadProgressSize: function(b, c) {
            ...
            j.onload = function() {
                ...
                d.createCanvas("extended", !1, !1, function() {
                    d.canvas.extended.canvas.width = g,
                    d.canvas.extended.canvas.height = h,
                    d.canvas.extended.setSmoothing();
                    for (var l = 0; l < i.length; l++) {
                        ...
                        m.onload = function() {
                            var l = this.width * b
                              ...
                              , n = g - a
                              , o = h - j;
                            d.canvas.extended.ctx.drawImage(this, 0, 0, l, m),
                            d.canvas.extended.ctx.drawImage(k, n - 15, o - 15),
                            f[this.data_id] = d.canvas.extended.dataURL(),
                            d.canvas.extended.clear(),
                            e.push({
                                src: f[this.data_id],
                                data_id: this.data_id
                            }),
                            e.length == i.length && (d.canvas.extended.destroy(),
                            d.arrangeImages(e, function(a) {
                                c(a)
                            }))
                        }
                        ,
        ...
        createWatermarkImage: function(a, b) {
            ...
            var f = this.width - 50
              , g = this.height - 50;
            d["default"](),
            d.ctx.font = "bold 30px Arial",
            d.ctx.textAlign = "right",
            d.ctx.fillStyle = "black",
            d.ctx.globalAlpha = .05,
            d.ctx.fillText(e, f, g),
            d.ctx.fillStyle = "white",
            d.ctx.globalAlpha = .05,
            d.ctx.fillText(e, f, g),
            d.image().onload = function() {
                if (c.settings.watermark.image = this,
                b)
                    return b()
            }
        },
        checkSettings: function() {
            ...
            c && c.name && (this.eraseCookie(this.settings.name),
            this.settings = a.extend(!0, this.settings, c),
            this.updateSettings())
        },
        updateSettings: function() {
            var b = a.extend(!0, {}, this.settings);
            b.tile.canvases = [],
            this.putStorage(this.settings.name, b, !1, !0)
        },
        ...
        loadSettings: function() {
            ...
            c && (c = JSON.parse(c)),
            b && (b = JSON.parse(b),
            b = a.extend(!0, this.settings, b),
            b.dithering = !1,
            this.settings.isoLines = !1,
            b.mouseIcons && this.SettingsController.toggleMouseIcons(),
            b.palettes && b.palettes["default"] && !this.isApp && (this.ColorController.colorPresets = b.palettes),
            b.palette && !this.isApp && (this.ColorController.updateColors(b.palette, !0),
            this.ColorController.updateOptions()),
            b.zoomUnlock && this.SettingsController.toggleZoomLock(),
            b.roundedPixel && a("#rounded-toggle").prop("checked", !0),
            b.persLayers && !this.isApp,
            b.lockFrames && !this.online.status && (this.SettingsController.toggleLockedFrames(),
            a("#frames-lock-toggle").prop("checked", !0)),
            b.frames && b.frames.tile && !this.online.status && a("#frames-tile-toggle").prop("checked", !0),
            b.theme.lighter && this.changeTheme(),
            b.theme.icons && this.SettingsController.loadIconSet(),
            b.checker && this.isApp && (this.checker.status = !0,
            this.SettingsController.loadIconSet()),
            b.grid && this.isApp && (this.grid.status = !0,
            this.SettingsController.loadIconSet(),
            this.SettingsController.loadCssGrid()),
            b.tile.status && (c ? this.TileController.updateStatus(c.width, c.height) : this.TileController.updateStatus(),
            a("#tiles-toggle").prop("checked", !0)),
            b.tile.border && (this.updateBorder(),
            a("#tiles-border").prop("checked", !0)),
        ...
        databaseGetPixils: function() {
            ...
            c.openCursor(null, "prev").onsuccess = function(a) {
                var b = a.target.result;
                b && (this.dbPixils[b.value.id] = b.value,
                b["continue"]())
            }
        },
        ...
        databaseSavePixil: function(a, b) {
            ...
            d.put(a),
            (!this.backup || Date.now() > this.backup) && (a.id = "backup",
            d.put(a),
            this.backup = Date.now() + 3e5)
        },
    ...
    (a("#edit-description").length || a("#edit-title").length) && ("object" != typeof la && (la = {}),
    la.title = a("#edit-title").text(),
    la.description = a("#edit-description").text()),
    a("#sk").length >= 1 && ("object" != typeof la && (la = {}),
    la.skipNew = !0),
    ka && (la.file = ka),
    "boolean" == typeof window.pixilMobileApp ? ga : void ga.init(ha, ia, la)
}(jQuery);